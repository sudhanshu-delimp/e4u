                                ...
                                <div class="col-md-12 card-heading">
                                    <div class="card-top border-0 p-0 mb-0">
                                        ...
                                        <div class="card-heading">
                                            ...
                                            <p class="mt-0">Escorts4U has partnered with a leading supplier of
                                    ...
                                    <div class="card-top">
                                        <div class="card-icon">
                                            <svg fill="#ff3c5f" width="40px" height="40px" viewBox="0 0 512 512"
                                                ...
                                                xmlns:xlink="http://www.w3.org/1999/xlink" stroke="#ff3c5f"
                                                stroke-width="9.728">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                ...
                                <div class="col-md-12">
                                     <div class="inner-field-row">                                     
                                        ...
                                        <div class="form-group">
                                            <label for="email"><b>Your Name</b><span class="text-danger">*</span>
                                            </label>
                                            <input id="name" value="{{ old('first_name') }}"
                                                placeholder="Birth Name" name="first_name" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="mobile" value="{{ old('mobile') }}"
                                                placeholder="Mobile Number" name="mobile" type="number"
                                                class="form-control" required>
                                            @error('mobile')
                                                <div class="text-danger text-sm">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <div class="form-check form-check-inline ml-0">
                                                <input name="auth" class="form-check-input" type="checkbox"
                                                    id="auth">
                                                <label class="form-check-label" for="auth"> I authorise E4U to debit
                                                    my
                                        ...
                                        <div class="form-group">
                                            <div class="form-check form-check-inline ml-0">
                                                <input name="terms" class="form-check-input" type="checkbox"
                                                    id="pref_terms">
                                                <label class="form-check-label" for="pref_terms"> I have read and agree to
                                                    the
