...
<div class="tab-pane fade show active" id="aboutme" role="tabpanel" aria-labelledby="home-tab">
    ...
    <form id="update_business" action="{{ route('center.update-massage-profile') }}" method="POST"
        ...
        <div class="about_me_drop_down_info profile-sec p-4">
            ...
            <div class="business-info-field pt-4">
                <div class="form-group business-field">
                    ...
                    <input type="hidden" value="{{ $massage_default->profile_name }}" class="form-control"
                        id="profile_profile_name">
                    <input type="text" value="{{ $escort->profile_name }}" name="profile_name"
                        class="form-control update_profile_data" id="profile_name" placeholder="Enter Profile Name"
                        required data-tab="group_one">
                ...
                <div class="form-group business-field">
                    ...
                    <input type="text" value="{{ $escort->business_name }}" name="business_name"
                        class="form-control update_profile_data" id="business_name" placeholder="Enter Business Name"
                        required data-tab="group_one">
                </div>
                ...
                <div class="form-group business-field">
                    ...
                    <input type="text" value="{{ $escort->address }}" class="form-control" id="address"
                        name="address">
                </div>
    ...
    <div class="about_me_drop_down_info profile-sec">
        ...
        <form id="myProfileMediaForm" name="myProfileMediaForm"
            action="{{ route('center.update-massage-profile') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                ...
                                                <div class="col pr-0">
                                                    <div class="plate"><label class="newbtn dvDest"
                                                            data-toggle="modal" data-target="#photo_gallery"
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <ul class="nav nav-tabs border-0" id="escort_profile_media_filter_type">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-filter-type="all"  id="menu_all"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-filter-type="unverified" id="menu_unverified"
                                                                data-toggle="tab" href="#menu2">Unverified</a>
                                                        </li>
                                                    </ul>
                                                </div>
    ...
    $i++)
                                                                        ...
                                                                        @if (!in_array($image->position, [8]))
                                                                            <div class="item4"
                                                                                ...
                                                                                @switch($image->position)
                                                                                    @case(9)
                                                                                        <span
                                                                                            class="badge badge-red">Banner</span>
                                                                                    @break

                                                                                    @case(10)
                                                                                        <span class="badge badge-red">Pin
                                                                                            Up</span>
                                                                                    @break
            ...
            <div class="modal fade upload-modal_pic" id="upload-sec-pic" tabindex="-1" role="dialog"
                                            ...
                                            <div class="row mt-3 pt-1" style="border: 1px dotted;">
                                                <div class="col-6 pt-4 pb-4">
                                                    ...
                                                    <ul style="text-align: justify;">
                                                        <li>Two (2) selfies with your User Name and Membership ID
                                                            printed
                                                            (can be handwritten) on a sheet of paper held up to the side
                                                            of
                                                            you and not obscuring any part of you</li>
                                                        <li>A drivers licence which matches your User Name and Home
                                                            State
                                                        </li>
            ...
            <div class="modal fade upload-modal-pic" id="upload-sec-banner-pic" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-keyboard="false"
        ...
        <form id="myProfileVideoForm" name="myProfileVideoForm"
            action="{{ route('center.update-massage-profile') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 my-4">
                        <div class="upload-photo-sec">
                            <div
                                class="d-sm-flex align-items-center justify-content-between p-3 custom-img-filter-header">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-4">
                                    <label class="newbtn videoDroppable w-100" id="videoDroppable_1">
                                        ...
                                        <input type="hidden" id="pos_1" name="video_position[1]"
                                            value="">
                                    </label>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <label class="newbtn videoDroppable w-100" id="videoDroppable_2">
                                        ...
                                        <input type="hidden" id="pos_2" name="video_position[2]"
                                            value="">
                                    </label>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <label class="newbtn videoDroppable w-100" id="videoDroppable_3">
                                        ...
                                        <input type="hidden" id="pos_3" name="video_position[3]"
                                            value="">
                                    </label>
                                </div>
                            </div>
    ...
    <form id="update_about_me" action="{{ route('center.update-massage-profile') }}" method="POST"
        enctype="multipart/form-data" novalidate="">
        <div class="about_me_drop_down_info profile-sec p-4">
                                ...
                                <div class="about_me_drop_down_info ">
                                    ...
                                    <div class="business-info-field pt-3">
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                class="change_default form-control form-control-sm select_tag_remove_box_sadow update_profile_data"
                                                id="" name="building" required="">
                                                <option value="" selected="">-- Not Set --</option>
                                                @foreach (config('escorts.profile.Building') as $key => $buldingName)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->building == $key ? 'selected' : '' }}>
                                                        {{ $buldingName }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->building }}"
                                                class="form-control" id="profile_building">
                                        ...
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Parking') as $key => $ParkingName)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->parking == $key ? 'selected' : '' }}>
                                                        {{ $ParkingName }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->parking }}"
                                                class="form-control" id="profile_parking">
                                        </div>
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Entry') as $key => $EntryName)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->entry == $key ? 'selected' : '' }}>
                                                        {{ $EntryName }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->entry }}"
                                                class="form-control" id="profile_entry">
                                        </div>
                                        <div class="form-group business-field">
                                            <label for="exampleFormControlSelect1">Type</label>
                                            <select
                                                class="change_default form-control form-control-sm select_tag_remove_box_sadow update_profile_data"
                                                id="Type" name="furniture_types">
                                                <option value="" selected="">-- Not Set --</option>
                                                @foreach (config('escorts.profile.furniture_types') as $key => $furniture_type)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->furniture_types == $key ? 'selected' : '' }}>
                                                        {{ $furniture_type }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->furniture_types }}"
                                                class="form-control" id="profile_furniture_types">
                                        </div>
                                        <div class="form-group business-field">
                                            <label for="exampleFormControlSelect1">
                                                Shower</label>
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Shower') as $key => $Type)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->shower == $key ? 'selected' : '' }}>
                                                        {{ $Type }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->shower }}"
                                                class="form-control" id="profile_shower">
                                        </div>
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Ambiance') as $key => $AmbianceName)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->ambiance == $key ? 'selected' : '' }}>
                                                        {{ $AmbianceName }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->ambiance }}"
                                                class="form-control" id="profile_ambiance">
                                        </div>
                                        ...
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Security') as $key => $SecurityName)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->security == $key ? 'selected' : '' }}
                                                        data-name="{{ $SecurityName }}">{{ $SecurityName }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->security }}"
                                                class="form-control" id="profile_security">
                                        </div>
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Payments') as $key => $PaymentType)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->payment == $key ? 'selected' : '' }}
                                                        data-name="{{ $PaymentType }}">{{ $PaymentType }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->payment }}"
                                                class="form-control" id="profile_payment">
                                            @if (!empty($escort->payment))
                                                <div class='select_pay'>
                                                    <span
                                                        class='languages_choosed_from_drop_down'>{!! config("escorts.profile.payments.$escort->payment") !!}</span>
                                                </div>
                                            @endif
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.Loyalty') as $key => $LoyaltyType)
                                                    <option value="{{ $key }}"
                                                        {{ $escort->loyalty == $key ? 'selected' : '' }}>
                                                        {{ $LoyaltyType }}</option>
                                                @endforeach>
                                            </select>
                                            <input type="hidden" value="{{ $massage_default->loyalty }}"
                                                class="form-control" id="profile_loyalty">
                                        </div>
                                        ...
                                        <div class="form-group business-field">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('escorts.profile.languages') as $key => $language)
                                                    <option value="{{ $key }}"
                                                        @if (isset($escort->language) && $escort->language == $key) selected @endif
                                        ...
                                        <div class="form-group business-field">
                                            ...
                                            <input type="hidden" value="{{ $massage_default->contact }}"
                                                class="form-control" id="profile_contact">
                                        </div>
        ...
        <div class="about_me_drop_down_info profile-sec p-4">
            ...
            <div class="padding_20_all_side">
                <input type="text" name="about_title" id="about_title"
                    value="{{ $escort->about ? $escort->about : null }}"
                    class="whoiamtitle mc-whoiam-title mb-1 update_profile_data" placeholder="Enter Your Title Here"
                    required data-tab="group_one">
                <input type="hidden" value="{{ $massage_default->about_title }}" class="form-control"
                    id="profile_about_title">

                <div class="row mt-3">
                    <div class="col-12">
                        <textarea id="about_us_box" name="about_us_box">
@if (!empty($escort->about_us_box))
{{ $escort->about_us_box }}
@endif
</textarea>
    ...
    <div class="tab_btm_btns_preview_and_next py-3">
        <div class="row pt-3 pb-2">
            <div class="col-md-12 text-right mb-2 a_text_white_hover">
                ...
                <a class="nex_sterp_btn" id="profile-tab_next" data-toggle="tab" href="javascript:void(0)"
...
<div class="modal fade upload-modal" id="upload-sec" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="width: 800px;position: absolute;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"> <img class="custompopicon"
                            src="{{ asset('assets/dashboard/img/upload-photos.png') }}"> Manage Photos</h5>
                        ...
                        <div class="col-md-12">
                            <div class="container p-0">
                                <div class="row pr-2 modal_inner_area">
                                    <div class="col-4 full_pic">
                                        <div class="plate"><label class="newbtn">
                                                ...
                                                <img id="img1" class="img-fluid excludeTooltip"
                                                    data-position-id="1"
                                                    src="{{ asset($escort->imagefrontPosition(1)) }}"
                                                    style="object-fit: cover;width: 167px;height: 172px;">
                                                <input name="img[1]" id="pic1" data-id="1"
                                ...
                                <div class="row pt-1 varify_box" style="border: 1px dotted;">
                                    ...
                                    <div class="col-6">
                                        <div class="plate"><label class="newbtn">
                                                <img class="img-fluid" id="blah8"
                                                    src="{{ asset($escort->imagefrontPosition(8)) }}"
                                                    style="height: 138px;object-fit: cover;width: 370px;">
                                                <input name="img[8]" id="pic8" data-id="8"
                                                    class="pis" onchange="readURL(this);" type="file">
...
<div class="modal fade upload-modal" id="upload-sec-banner" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="color: white;" id="exampleModalLongTitle"> <img
                        src="{{ asset('assets/dashboard/img/banner.png') }}" class="custompopicon">Manage Banner
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><img src="{{ asset('assets/app/img/newcross.png') }}"
                            class="img-fluid img_resize_in_smscreen"></span>
                    ...
                    <div class="col-md-12">
                        <div class="container p-0">
                            ...
                            <div class="row mt-3" style="border: 1px dotted;">
                                ...
                                <div class="col-6">
                                    <div class="plate"><label class="newbtn">
                                            <img class="img-fluid" id="blah0"
                                                src="{{ asset($escort->imagefrontPosition(10)) }}"
                                                style="height: 138px;object-fit: cover;width: 291px;">
                                            <input name="img[10]" id="pic0" class="pis"
                                                onchange="readURL(this);" type="file">
...
<div class="modal upload-modal" id="photo_gallery" style="display: none">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><img src="{{ asset('assets/dashboard/img/banner.png') }}"
                        class="custompopicon"> Select Photo
                </h5>
