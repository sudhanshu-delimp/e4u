...
<div class="tab-pane fade" id="massuers" role="tabpanel" aria-labelledby="massuers-tab">
    ...
    <div class="about_me_drop_down_info p-4 profile-sec">
        ...
        <form id="my_masseurs" name="my_masseurs"  method="POST" enctype="multipart/form-data"> 
                <div class="fill_profile_headings_global">
                    <div class="row">
                        ...
                        <button type="button"  data-toggle="modal" data-target="#select_profile" >Add New Masseurs</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <input type="hidden" name="type" id="type" value="masseur">
                            <input type="hidden" name="massage_id" id="massage_id" value="{{$escort->id}}">
                            <button type="button" id="submit_form_massage" class="btn_width_hundred update_masseurs_btn">
                                Update Masseurs
                            </button>
                        </div>
                    </div>
...
\                                            </div>
                    ...
                    <div class="col-md-12 text-right pr-4">
                        ...
                        <button type="button" class="btn-success-modal add_masseurs">Add</button>   
                    </div>
                    <!-- end col -->
