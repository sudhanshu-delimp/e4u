        ...
        <div class="modal-content" style="width: 800px;position: absolute;">
            ...
            <div class="modal-content">
                                ...
                                <div class="row pr-2">
                                    <div class="col-3">
                                        <div class="plate"><label class="newbtn">
                                            <img id="blah1" class="img-fluid" src="{{ asset('assets/app/img/upload-1.png')}}" style="width: 171px;object-fit: cover;height: 206px;">
                                    ...
                                    <div class="col-9 pl-0">
                                        <div class="row" style="">
                                            <div class="col-4 pr-0">
                                                <div class="plate"><label class="newbtn">
                                                    <img id="blah2" class="img-fluid modal-image" src="{{ asset('assets/app/img/upload-5.png') }}">
                                            ...
                                            <div class="col-4 pr-0">
                                                <div class="plate"><label class="newbtn">
                                                    <img id="blah3" class="img-fluid modal-image" src="{{ asset('assets/app/img/upload-5.png') }}">
                                            ...
                                            <div class="col-4 pr-0">
                                                <div class="plate"><label class="newbtn">
                                                    <img id="blah4" class="img-fluid modal-image" src="{{ asset('assets/app/img/upload-5.png') }}">
                                        ...
                                        <div class="row" style="">
                                            <div class="col-4 pr-0">
                                                <div class="plate"><label class="newbtn">
                                                    <img id="blah5" class="img-fluid modal-image" src="{{ asset('assets/app/img/upload-5.png') }}">
                                            ...
                                            <div class="col-4 pr-0">
                                                <div class="plate"><label class="newbtn">
                                                    <img id="blah6" class="img-fluid modal-image" src="{{ asset('assets/app/img/upload-5.png') }}">
                                            ...
                                            <div class="col-4 pr-0">
                                                <div class="plate"><label class="newbtn">
                                                    <img id="blah7" class="img-fluid modal-image" src="{{ asset('assets/app/img/upload-5.png') }}">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Use Default</button>
