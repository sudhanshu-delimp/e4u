                                ...
                                @foreach ($massage_profile->massage_services()->where('category_id', 1)->get() as $value)
                                        <li class="mb-2" id="hideenclassOne_{{$value->service_id}}">
                                            <div class='my_service_anal hideenclassOne{{$value->id}}'>
                                                ...
                                                <input type='number' class='dollar-before input_border price-input' name='price[]' placeholder='0' value="{{$value->price}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <div class="service_rate_dolor_symbol form-group">
                                    <span>$</span>
                                    <input  placeholder="0" type="text"  class="form-control allow_only_numeric update_default_rate" data-duration_id="{{$duration->id}}" data-massage_profile_id="{{$massage_profile_id}}"  data-data_type="massage_price"  value="{{$massage_price}}" id="massage_price" name="massage_price[]" >
                            ...
                            <div class="col-3">
                                <div class="service_rate_dolor_symbol form-group">
                                    <span>$</span>
                                    <input  placeholder="0"  type="text"  class="form-control allow_only_numeric update_default_rate" data-duration_id="{{$duration->id}}" data-massage_profile_id="{{$massage_profile_id}}"  data-data_type="incall_price"  value="{{$incall_price}}" id="incall_price" name="incall_price[]">
                            ...
                            <div class="col-3">
                                <div class="service_rate_dolor_symbol form-group">
                                    <span>$</span>
                                    <input  placeholder="0"  type="text"  class="form-control allow_only_numeric update_default_rate" data-duration_id="{{$duration->id}}"  data-massage_profile_id="{{$massage_profile_id}}"  data-data_type="outcall_price"   id="outcall_price" name="outcall_price[]"  value="{{$outcall_price}}" >
