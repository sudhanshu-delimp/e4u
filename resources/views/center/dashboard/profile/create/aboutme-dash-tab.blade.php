     ...
     <div class="about_me_drop_down_info profile-sec">
                        ...
                        <div class="about_me_drop_down_info ">
                              ...
                              <div class="business-info-field pt-3">
                                 <div class="form-group business-field">
                                    ...
                                    <input type="hidden" value="{{ $escort->building}}" class="form-control" id="profile_building">
      ...
      <div class="about_me_drop_down_info profile-sec p-4">
         ...
         <div class="padding_20_all_side">
            <input type="text" name="about_title" id="about_title" value="" class="whoiamtitle mc-whoiam-title mb-1 update_profile_data" placeholder="Enter Your Title Here" required >
               <input type="hidden" value="{{ $escort->about_title}}" class="form-control" id="profile_about_title">
            <div class="row mt-3">
                  <div class="col-12">
                     <textarea id="about_us_box" name="about_us_box"  required></textarea>
