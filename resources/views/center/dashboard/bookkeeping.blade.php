            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="bothsearch-form d-flex gap-20">
                    ...
                    <button type="button" class="create-tour-sec dctour" data-toggle="modal"
                        data-target="#SetPinModal">Change PIN</button>
                    <button type="button" class="create-tour-sec dctour" data-toggle="modal" id="commission-modal"
                        data-target="#commission-report2">Add New Account</button>
                </div>
            </div>
        </div>
...
<button class="btn-success-modal" data-toggle="modal" data-target="#EFTInstructions">EFT Instructions </button> --}}
    ...
    <div class="modal fade upload-modal" id="commission-report" tabindex="-1" role="dialog"
        aria-labelledby="CompetitorLabel" aria-hidden="true" style="display: none">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content basic-modal">
                <div class="modal-header">
                    <h5 class="modal-title"><img src="/assets/dashboard/img/add-new-account.png" class="custompopicon"
                            alt="cross"> <span class="commission_report_title">Add New Account</span> </h5>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="bank_name" id="bank_name" required
                                        data-parsley-required-message="Plese select bank name">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Account Name"
                                        name="account_name" id="account_name" required
                                        data-parsley-required-message="Please enter your account number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>BSB</label>
                                    <input type="text " required class="form-control" placeholder="BSB" name="bsb"
                                        id="bsb" data-parsley-required-message="Please enter your BSB number"
                                        data-parsley-type="digits" data-parsley-type-message="Enter only numbers">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Account Number</label>
                                    <input type="text" class="form-control" required placeholder="Account Number"
            ...
            <div class="modal-content custome_modal_max_width">
                <form id="SendBankOtp" method="post" action="">
                    ...
                    <div class="modal-header main_bg_color border-0">
                        <h5 class="modal-title text-white"><img src="{{ asset('assets/app/img/face-lock.png') }}"
                                style="width:40px;" alt="face-lock verification"> 2FA Verification</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body forgot_pass pb-1">
                        <div class="form-group label_margin_zero_for_login">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-10">
                                <input type="password" maxlength="4" required class="form-control w-75" name="otp"
                                    id="otp" aria-describedby="emailHelp" placeholder="Enter One Time Password"
                    ...
                    <div class="modal-footer forgot_pass pt-0 pb-4 justify-content-center">
                        ...
                        <p class="pt-2">Not received your code? <a href="#" id="resendOtpSubmit"
                                class="termsandconditions_text_color">Resend Code</a></p>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content custome_modal_max_width">
                <div class="modal-header main_bg_color border-0">
                    ...
                    <h5 class="modal-title text-white"><img src="/assets/dashboard/img/remove-bank-account.png"
                            class="custompopicon" alt="cross"> Delete Bank Account</h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <img src="{{ asset('assets/dashboard/img/add-new-account.png') }}"
                            style="width:40px; padding-right:10px;" class="modal_title_img">New Bank Account added
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">
                            <img src="{{ asset('assets/app/img/newcross.png') }}"
    ...
    <div class="modal fade upload-modal" id="AddPayId" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <img src="{{ asset('assets/dashboard/img/payer.png') }}" style="width:40px; padding-right:10px;"
                            class="modal_title_img">PayID for Payer
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">
                            <img src="{{ asset('assets/app/img/newcross.png') }}"
                ...
                <div class="modal-body pb-0 agent-tour">
                    <div class="row">
                        <div class="col-md-12 my-4">
                            <ol class="pl-3">
                                <li class="pl-3">My PayID number is: <span class="font-weight-bold">1234567890</span>
                                </li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <img src="{{ asset('assets/dashboard/img/payer.png') }}" style="width:40px; padding-right:10px;"
                            class="modal_title_img">EFT Instructions for Payer
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">
                            <img src="{{ asset('assets/app/img/newcross.png') }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 my-4">
                            <ol class="pl-3">
                                ...
                                <p class="pl-3 d-flex justify-content-start"><span class="w-25">BSB:</span> <span
                                        class="font-weight-bold">123 445</span></p>
                                <p class="pl-3 d-flex justify-content-start"><span class="w-25">A/c Number:</span> <span
                                        class="font-weight-bold">123-1235</span></p>
    ...
    <div class="modal fade upload-modal" id="EnterPinModal" tabindex="-1" role="dialog" aria-hidden="true"
    ...
    <div class="modal fade upload-modal" id="InstructionPayerModal" tabindex="-1" role="dialog" aria-hidden="true"
        data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><img src="/assets/dashboard/img/add-new-account.png" class="custompopicon"
                            alt="cross"> Instructions for Payer</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><img src="http://127.0.0.1:8000/assets/app/img/newcross.png"
                                class="img-fluid img_resize_in_smscreen"></span>
                    </button>
                </div>
                    ...
                    <ol class="text-left">
                        <li class="pl-3">EFT your payment to this bank account:
                            <ul class="text-left list-unstyled instruction-list">
                                <li><span class="payer-lable">BSB: </span> <span class="font-weight-bold primary_bsb"> 123
                                        445</span></li>
                                <li><span class="payer-lable">A/C Number: </span> <span
                                        class="font-weight-bold primary_acc_no"> 123-1235</span></li>
                            </ul>
                        </li>
    ...
    {{-- set pin --}}
    <div class="modal fade upload-modal" id="SetPinModal" tabindex="-1" role="dialog" aria-hidden="true"
        data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-center text-center">
        ...
        $(function() {
            ...
            $("body").on('submit', '#escort_bank', function(e) {
                ...
                if (bankId == '') {
                    ...
                    else if ((previous_state != state) && is_primary_bank_acc == '0' && previous_state ==
                        '2' && state == '1') {
                        Swal.fire({
                            title: "",
                            text: "Do you want to save this bank account as Primary bank account?",
                    ...
                    } else if ((previous_state != state) && is_primary_bank_acc == '1' && previous_state ==
                        '2' && state == '1') {
                        Swal.fire({
                            title: "",
                            text: "Do you want to save this bank account as Primary bank account?",
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (isBankAccountChanged) {
                            $("#modal-title").text('Bank Account Update Confirmation');
                            $('.comman_msg').html(
                                '<h5>Your bank account details have been successfully updated.</h5>'
                                );
                            $("#comman_modal").modal('show');
