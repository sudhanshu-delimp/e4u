     ...
     <div class="col-md-12 my-4">
      ...
      <div class="col-md-12 mb-5">
         <div id="accordion" class="myacording-design">
            ...
            <div class="card">
               <div class="card-header">
                  <a class="card-link collapsed" data-toggle="collapse" href="#abbrieviations" aria-expanded="false">
                  Website abbrieviations
                  </a>
               </div>
...
<div class="accodien_manage_padding_content">
   ...
   <p>These Website Abbreviations (<b>Abbreviations</b>) are to be read in conjunction with the
      <a href="{{ asset('terms-conditions') }}" class="termsandconditions_text_color text-decoration-none">Terms and Conditions</a>. To the extent of any inconsistency between these Abbreviations
      and the Terms and Conditions, the Terms and Conditions</a> prevail.
   </p>
   <div class="row">
      <div class="col-lg-4">
         <h2>A</h2>
         ...
         <p><b>Account or My Account:</b> has the same meaning as “<a href="#" class="termsandconditions_text_color text-decoration-none">Account</a>” described in the Terms and incorporates the Membership Number.</p>
      ...
      <div class="col-lg-4">
         ...
         <p><b>Membership Number and Member ID:</b> means collectively the unique number allocated to the Member by Escorts4U after having completed the online registration, incorporating the Agent ID, Escort ID, Massage Centre ID and Viewer ID.
         </p>
      ...
      <div class="col-lg-4">
         ...
         <p class="pb-4"><b>Website:</b> has the same meaning as “<a href="#" class="termsandconditions_text_color text-decoration-none">Website</a>” described in
            the Terms
         </p>
      </div>
   </div>
