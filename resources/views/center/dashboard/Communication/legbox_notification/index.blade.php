                    ...
                    <div class="row">
                        ...
                        <div id="templateSelect" style="display: none;" class="col-12 mb-3">
                            ...
                            <select id="template_name" name="template_name" class="form-control rounded-0">
                                ...
                                <option value="Morning Special - 20% off all massages">
...
<div id="manage-route" data-scrf-token="{{ csrf_token() }}"
    ...
    data-pdf-download="{{ route('centrer.legbox.notification.pdf.download', ['id' => '__ID__']) }}"
    data-legbox-notification-index="{{ route('centrer.legbox.notification.index') }}"
    data-legbox-notification-status="{{ route('centrer.legbox.notification.status', ['id' => '__ID__']) }}"
    data-legbox-notification-edit="{{ route('centrer.legbox.notification.edit', ['id' => '__ID__']) }}"
    data-legbox-notification-update="{{ route('centrer.legbox.notification.update', ['id' => '__ID__']) }}"
    data-legbox-notification-store="{{ route('centrer.legbox.notification.store') }}"
    data-legbox-notification-show="{{ route('centrer.legbox.notification.show', ['id' => '__ID__']) }}">
...
<script>
    ...
    $('#createNotification').on('hide.bs.modal', function() {
        ...
        $(this).find('h5.modal-title').html(
            '<img src="{{ asset('
            assets / dashboard / img / create - notification.png ') }}" class="custompopicon"> Create Notification'
        );
            ...
            success: function(response) {
                if (response.status === true) {
                    ...
                    $('#createNotification').find('h5.modal-title').html(
                        '<img src="{{ asset('
                        assets / dashboard / img / create - notification.png ') }}" class="custompopicon"> Edit Notification'
                    );
