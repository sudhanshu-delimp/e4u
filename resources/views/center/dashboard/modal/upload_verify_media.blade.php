                            ...
                            <div class="col-lg-12 text-center">
                                <label class="newbtn rm">
                                    ...
                                    <img id="blah" class="item px-2"
                                        src="{{ asset('assets/app/img/upload-media.png') }}" style="width: 400px;object-fit: cover; height:100%">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-sm-12">
                                            ...
                                            <ol style="text-align: justify;">
                                              <li>Upload a photo of the Business premises which displays the name of the Business and the Business number.</li>
                                            </ol>
                                        </div>
