        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <label class="card-label shadow-sm">
                    <input type="checkbox" name="My_Legbox_Viewers" data-key="My_Legbox_Viewers" value="1" class="toggle-view">
                ...
                <label class="card-label shadow-sm">
                    ...
                    <div class="card-title-row">
                        ...
                        <div class="card-image">
                            <img src="{{asset('assets/dashboard/img/boxicon/center/suppor-tickets.png')}}" alt="Support Tickets">
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <label class="card-label shadow-sm">
                    ...
                    <div class="card-title-row">
                        ...
                        <div class="card-image">
                            <img src="{{asset('assets/dashboard/img/boxicon/center/recommendations-this-week.png')}}" alt="Recommendations">
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <label class="card-label shadow-sm">
                    ...
                    <div class="card-title-row">
                        ...
                        <div class="card-image">
                            <img src="{{asset('assets/dashboard/img/boxicon/center/reviews-posted-this-week.png')}}" alt="Reviews Posted">
                        </div>
                    </div>
