        ...
        <div class="col-md-4">
            <div class="upload-photo-sec">
                <div class="d-sm-flex align-items-center justify-content-between pt-4 pl-2">
                    <h1 class="h3 text-gray-800 mb-2">Default Video</h1>
                </div>
                                ...
                                <div class="row pl-2">
                                    <div class="col-12">
                                        <div class="row" style="">
                                            ...
                                            <div class="col-md-2 pl-0">
                                                <video controls="" poster="{{ asset('assets/app/img/video-poster.png')}}" style="width: 135px;height: 190px;background: #0000006b;">
                                                    <source src="{{ asset('assets/app/img/mov_bbb.mp4')}}" type="video/mp4">
                                                    <source src="mov_bbb.ogg" type="video/ogg">
                                                </video>
                                            </div>
