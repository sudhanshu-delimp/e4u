...
@section('content')
    <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li>When uploading your Photos, make sure they comply with our <a href="/escort-dashboard/help"
                                    class="custom_links_design">Profile Image</a>
                            ...
                            <li>
                                <ol class="level-2">
                                    ...
                                    <li>You must provide your Media Verification within 48 hours of having uploaded any
                                        ...
                                        Unverified and the appropriate icon will be displayed on your Listed Profile.</li>
                                    <li>Masseur Media is treated independently of your Default Images. Any Masseur who has
                                        had their Media verified will display the E4U Verified icon, regardless of the
                                        Member's Media Verification status.</li>
                                </ol>
                            </li>
                        </ol>
                    </div>
            ...
            <div class="col-md-12 mb-3 d-flex justify-content-end gap-10">
                ...
                @endphp
                <button type="button" id="mediaVerification"
                    class="change-avatar-btn {{ $disabledClass }} verify_timer" data-toggle="modal"
                    data-target="#veryfy_media" {{ $isDisabled ? 'disabled' : '' }}>
                                    ...
                                    <label class="newbtn dvDest" data-toggle="modal" data-target="#upload-sec">
                                        ...
                                        <div class="pm_verify_icon" id="verify_icon_7"
                                            ...
                                            @if (!empty($imageData['id']))
                                                @if ($status == '0')
                                                    <img
                                                        src="{{ asset('assets/app/img/pending_icon/e4u_pending-icon_REV.png') }}"><span
                                                        class="pm_tooltip">Media Pending</span>
                                                @elseif($status == '1')
                                                    <img
                                                        src="{{ asset('assets/app/img/verify/verified_icon.png') }}"><span
                                                        class="pm_tooltip">Media Verified</span>
                            ...
                            <ul class="nav nav-tabs border-0" id="escort_profile_media_filter_type">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link pm-status-tab" data-filter-type="verified" id="menu_varified"
                                        href="#menu1">
                                        <svg width="20px" height="20px" class="icons" viewBox="0 0 24 24"
                        ...
                        <ul class="nav nav-tabs border-0 js_gallery_category">
                            ...
                            <li>
                                <a class="nav-link pm-category active" data-type="gallery" data-toggle="tab"
                                    href="#Gallery"> <svg viewBox="0 0 24 24">
                                    <rect x="3" y="4" width="18" height="16" rx="2"></rect>
                                    <circle cx="8" cy="9" r="1.5"></circle>
                                    <path d="m4 17 5-5 3 3 2-2 6 5"></path>
                                </svg>Gallery</a>
    ...
    <div class="modal delete" id="pesrmissionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
