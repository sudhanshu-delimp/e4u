...
<script>
    ...
    var url ="{{ route('escort.state.profile.list.dataTable',':cityid') }}";
    var cid = $('#cityId').val();
    url = url.replace(':cityid',cid);
    var table = $('#myTable').DataTable({
        ...
        columns: [
            ...
            { data: 'profile_name', name: 'profile_name', searchable: false, orderable:false, defaultContent: 'NA'},
