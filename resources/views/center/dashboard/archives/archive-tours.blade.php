...
<div class="row">
  ...
  <ol class="breadcrumb bread-sec pl-0">
    <li class="breadcrumb-item"><a href="{{ url('center-dashboard/view-archives') }}" style="
...
<div class="row">
                    ...
                    <div class="card archive-sec">
                      <a href ="{{route('cen.archive-tour-profiles')}}">
                      <figure class="figure m-0">
  <img src="{{ asset('assets/dashboard/img/Vector.png') }}" class="figure-img img-fluid rounded" alt=" ">
  <figcaption class="figure-caption"><p>Tours 2022</p></figcaption>
</figure>
</a>
                    </div>
                </div>
                    ...
                    <div class="card archive-sec">
                      ...
                      <figure class="figure m-0">
  <img src="{{ asset('assets/dashboard/img/Vector.png') }}" class="figure-img img-fluid rounded" alt=" ">
  <figcaption class="figure-caption"><p>Tours 2021</p></figcaption>
</figure>
</a>
                    </div>
                </div></div></div>
