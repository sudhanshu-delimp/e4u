...
<div class="container-fluid">
      ...
      <div class="row">   
         <div class="col-md-12">
            <div class="v-main-heading h3" style="display: inline-block;"><h1 class="p-0 m-0">New Profile</h1></div>
            ...
            <div class="col-lg-12">
               ...
               <div class="row">
                  <div class="col-md-12 remove_padding_in_ph">
                     <ul class="dk-tab nav gap_between_btns mb-2" id="myTab" role="tablist">
                     ...
                     <div class="tab-content tab-content-bg p-2" id="myTabContent">
