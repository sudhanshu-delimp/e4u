                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="auth" checked type="checkbox"
                                                id="auth" value="2" checked="">
                                            <label class="form-check-label" for="auth">Text [default]</label>
                                        </div>
                                        <div class="pt-1"><i>How your authentification code will be sent to you.</i>
                                        </div>
                                    </div>
                                </div>
                            </div>
