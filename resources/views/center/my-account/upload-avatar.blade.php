                    ...
                    <div class="col-md-12">
                        ...
                        <div class="avatar-grid">
                            ...
                            <div class="avatar-card">
                                <form id="my_avatar" action="{{ route('center.save.avatar', auth()->user()->id) }}"
                                    ...
                                    <!-- Upload Area -->
                                     <label for="avatar-upload" class="upload-area">
                                        ...
                                        <input class="file-upload-input gambar item-img" id="avatar-upload" name="avatar_img" type="file"
