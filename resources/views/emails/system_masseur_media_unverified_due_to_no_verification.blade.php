                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                                         <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Media Status - Unverified (Masseur)</h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                              As you have not uploaded a Media Verification image within the required 48 hours, your Media for Masseur: {{ $body['masseur_member_id'] }}
 has been changed to Unverified.
                            </p>
