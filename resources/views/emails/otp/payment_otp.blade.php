...
<head>
  <meta charset="UTF-8">
  <title>E4u Payment - One Time Password</title>
</head>
      ...
      <td align="center">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                    <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Payment Otp </h1>
        ...
        <tr>
            <td style="padding: 30px;">
              ...
              <p style="font-size: 16px; margin: 20px 0 15px 0;">Your one time password for payment: <strong>{{ $otp }}</strong></p>
