                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                                        <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Reset Password - Request</h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                We have received a request to reset your password. Click the button below to create a
                                new
                                password for your Account.
                            </p>
                            <div style="text-align:center;margin:20px 0px;"><a href="{{ $body['url'] }}"
                                    style="background-color:#0c223d;  padding:10px 20px; color:#fff; text-decoration:none;">Reset
                                    Password</a></div>
