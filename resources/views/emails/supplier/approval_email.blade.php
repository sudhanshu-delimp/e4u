...
<head>
  <meta charset="UTF-8">
  <title>Account Approval - Supplier</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border:1px solid #dddddd; font-family:Arial, sans-serif; color:#2b3d50;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                   <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;"> Account Approval - Supplier </h1>
          ...
          <tr>
            <td style="padding: 30px;">
              <p style="font-size: 16px; margin: 0 0 15px 0;">Dear {{$supplier['business_name']}},</p>
                <p style="font-size: 16px; margin: 20px 0 15px 0;">Your supplier account has been approved.</p>
                 <!-- email info -->
                                <x-email-info/>
                            <!-- end -->
            </td>
