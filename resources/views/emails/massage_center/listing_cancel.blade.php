                ...
                <table width="600" cellpadding="0" cellspacing="0"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align: middle; text-align: right;">
                                        <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Listing Cancellation- Massage</h1>
                                        <div style="font-size: 13px; color: #cccccc;">Member ID : {{ $data['user']->member_id ?? '' }}</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: justify;">
                            <p style="font-size: 16px; margin: 0 0 15px 0;">Dear {{  $data['massageProfile']->profile_name  ?? ''}},</p>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>{{ $data['massageProfile']->profile_name }}</td>
                                </tr>
                                <tr>
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                Pursuant to your cancellation, your Wallet has been credited with {{ formatCurrency( $data['refundAmount']) }} for future use.
                            </p>
                            <!-- email info -->
                            <x-email-info />
                            <!-- end -->
