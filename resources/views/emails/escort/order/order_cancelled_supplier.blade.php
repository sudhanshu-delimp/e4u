                    ...
                    <tr>
                        <td style="padding: 30px; font-size: 16px;">
                            ...
                            <p style="margin:20px 0 15px 0;">
                                Please be advised that the below order has been cancelled.
                            </p>
                            ...
                            <p style="margin:15px 0;">
                                Please stop any pending processing, dispatch, or delivery activity related to this
                                order.
                            </p>

                            <p style="margin:15px 0;">
                                If the order has already been dispatched or any costs have been incurred, please contact
