...
<head>
  <meta charset="UTF-8">
  <title>Account Approval - Operator Staff</title>
</head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                     <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Account Approval - Operator Staff </h1>
                    <span style="font-size: 13px; color: #cccccc;">
                      Operator Staff ID: {{$staff['member_id'] ?? ''}}</span>
                  </td>
                </tr>
              </table>
            </td>
