                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                                         <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Report Rejected - NUM</h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; line-height: 2.0; margin-bottom: 15px;">
                                We advise your recent Report has been rejected for the reasons set out below. If you
                                wish
