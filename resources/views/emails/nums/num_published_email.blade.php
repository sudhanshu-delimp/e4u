                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                                         <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Report Published - NUM<h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; line-height: 2.0; margin-bottom: 15px;">
                                ...
                                now available to all Escorts, and your My Reports status for the published Report has
                                been
                                updated.
                            </p>
