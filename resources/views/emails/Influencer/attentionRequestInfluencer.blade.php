              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold; vertical-align: middle;">
                    <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Request to be an Influencer {{$body['member_id']}}</h1>
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <p style="font-size: 16px; margin: 0 0 15px 0;"><b>Attention Operations</b></p>
                <p style="font-size: 16px; margin: 35px 0 15px 0;">A request to be an Influencer has been submitted by:</p>
                <!-- Details Table -->
