                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align: middle; text-align: right;">
                                        <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Listing Extended - {{ $mainAccount->type=='4' ? 'Massage' : 'Escort' }}</h1>
