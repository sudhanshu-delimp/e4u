                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align: middle; text-align: right;">
                                        <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Tour Listing - Escort</h1>
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: justify;">
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                Thank you for Listing your Profile with us. Attached is a summary of your transaction.
                            </p>
