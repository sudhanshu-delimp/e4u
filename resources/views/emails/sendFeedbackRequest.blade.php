                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold; vertical-align: middle;">
                                        <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;">Feedback Request</h1>
                        ...
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 18px; margin: 0 0 15px 0;"><b>Attention Operations</b></p>
                             ...
                             <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                A User has logged a request for feedback. Details are:
                            </p>
                            ...
                            <table cellpadding="8" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="padding-left: 0;">Option:</td>
                                    <td>{{ $body['option'] }}</td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 0;">Email address:</td>
                                    <td>{{ $body['email'] }}</td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 0;">Comment:</td>
                                    <td>{{ $body['comment'] }}</td>
                                </tr>
