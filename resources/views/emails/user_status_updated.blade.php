                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                Simply go to the<a href="{{route('home')}}"> Log in </a>page to access the Website. Thank you for your patience.
                            </p>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                ...
                                the <a href="{{route('home')}}">Log in</a> page to access the Website. Thank you for your patience.
                            </p>
                            <p style="font-size: 15px; margin-top: 20px;">
                                Regards,<br>
                                <b>E4U - Operations Centre</b>
