...
<head>
  <meta charset="UTF-8">
  <title>Account Approval - Shareholder</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border:1px solid #dddddd; font-family:Arial, sans-serif; color:#2b3d50;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold;">
                     <h1 style="margin: 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: right;"> Account Approval - Shareholder</h1>
                    <span style="font-size: 13px; color: #cccccc;">
                      Shareholder ID: {{$shareholder['member_id'] ?? ''}}</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 30px;">
              <p style="font-size: 16px; margin: 0 0 15px 0;">Dear {{$shareholder['contact_person']}},</p>
                ...
                <table width="100%" cellpadding="5" cellspacing="0" style="border-collapse: collapse; font-size: 15px; color: #2b3d50;">
                  <tr>
                    ...
                    <td style="padding: 10px 0px 10px 10px">{{$shareholder['email'] ?? ''}}</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; padding: 10px 0px;">Password:</td>
                    <td style="padding: 10px 0px 10px 10px">{{$shareholder['plainPassword'] ?? ''}}</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; padding: 10px 0px;">Login url:</td>
                    <td style="padding: 10px 0px 10px 10px">{{route('shareholder.login')}}</td>
                  </tr>
                </table>
                 <!-- email info -->
                                <x-email-info/>
