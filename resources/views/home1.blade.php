...
<section class="padding_ninty_top_ninty_px padding_btm_ninty_pxonly homebanner_bg">
    <div class="container-fluid banner_width">
        <div class="row align-items-center">
            ...
            <div class="col-md-5">
                <p class="primery_color normal_heading">AUSTRALIA’S MOST SEXIEST AND ACCESSIBLE ESCORTS</p>
                ...
                <div class="padding">
                    ...
                    <a class="btn  btn_become_pin_up" style="font-weight:500" href="#" role="button">Become a Pin-up</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="our_aim">
                <ul id="our_aim_list">
                    ...
                    <li>
                        ...
                        <p>Good "Support" services for Advertisers and Viewers</p>
                    </li>
                    <li>
        ...
        <div class="col-lg-6">
            <div class="point_of_diff">
                ...
                <div class="point_of_diff_peragrapg">
                    <p class="text-white">It became apparent to us after talking with Advertisers and Viewers that there were a number of concerns about the quality and integrity of the services and offerings websites brought to private escorts. Those discussions helped bring about this Website, ensuring also that it complies with the Local Laws. Features such as verified photos, reviews, guides, concierge services, notes and Alerts are designed to make your experience a pleasant one. We also offer a loyalty program.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="register-img">
                        <img src="{{ asset('assets/app/img/girl.png') }}">
                    </div>
                </div>
                <div class="col-md-7 d-flex flex-column justify-content-center">
                    ...
                    <div class="reg_now_pera">
                        <p class="primery-color  pt-3">There are no fees when your create an Account. Fees only apply when you post a Profile or Tour where you are charged according to the number of days and the Membership type you select. See also <a href = "{{ route('page.show','help-for-advertisers') }}" class="termsandconditions_text_color" >help for Advertisers</a></p>
                    </div></br>
                    <div class="padding">
                        ...
                        <a class="btn  btn_viewer" style="color:red;border: 1px solid;" href="{{ route('agent.register')}}" role="button">Become an Agent</a>
                    </div>
                </div>
            </div>
        </div>
