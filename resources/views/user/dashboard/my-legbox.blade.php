...
<div class="container-fluid pl-3 pl-lg-5">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <div class="v-main-heading h3 mb-2 pt-4 d-flex align-items-center"><h1 class="p-0">Dashboard - My Legbox</h1>
        ...
        <div class="col-md-12 mb-4">
           ...
           <div class="table-responsive list-sec" id="sailorTableArea">
              <div id="myTable_wrapper" class="dataTables_wrapper no-footer">
                 <table id="massagelistTable" class="table table-bordered display dataTable no-footer" width="100%" role="grid" aria-describedby="myTable_info" style="width: 100%;">
                    <thead>
                       <tr role="row">
...
$('#escortCenterlegboxTable').DataTable({
            responsive: true,
            language: {
