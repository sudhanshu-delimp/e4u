...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
                <div class="modal-body text-center">
                    <h3 class="mb-4 mt-5"><span id="Lname"><img src="{{ asset('assets/app/img/alert.png') }}"
                                class="img-fluid">Are you sure want to remove?</span> </h3>
    ...
    <div class="modal fade upload-modal" id="rateMassageModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <img src="{{ asset('assets/dashboard/img/rating.png') }}"
                                ...
                                <div class=" d-flex align-items-center justify-content-start flex-wrap gap-10">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="massage_rating"
                                            id="massage_not_rate" value="massage_not_rate">
                                        <label class="form-check-label" for="not_rate">Not Rated</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="massage_rating"
    ...
    <div class="modal fade upload-modal bd-example-modal-lg" id="escortProfileMissingModal" tabindex="-1"
            ...
            <div class="modal-content basic-modal modal-lg">
                <div class="modal-header">
                    <h5 class="modal-title" id="emailReport">
                        <img src="{{ asset('assets/dashboard/img/view.png') }}" style="width:40px; margin-right:10px;"
                            alt="Request Rejected">
                        <span class="iframeEscortTitle">Escort Profile</span>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        {{-- <img src="{{ asset('assets/dashboard/img/not-allowed.png') }}"
                            style="width:45px; padding-right:10px;"> --}}
                        <img src="{{ asset('assets/dashboard/img/unblock.png') }}"
                            style="width:40px; padding-right:10px;" class="modal_title_img">
        ...
        $(document).ready(function() {
            var escortTable = $('#escortCenterlegboxTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'is_enabled_contact',
                        name: 'is_enabled_contact'
                    }, // 6
                    {
                        data: 'contact_method',
                        name: 'contact_method'
            ...
            $(document).on('click', '.escortProfileView', function(e) {
                ...
                if (escortProfileIsEnabled == '0') {
                    let htmlData =
                        '<div class="col-md-12 my-4  text-center"><h5 class=" body_text mb-2">This Escort does not presently have any Listed Profiles.</h5></div>';
            ...
            $(document).on('click', '.toggle-notification', function(e) {
                ...
                if (newStatus == 'disable') {
                    $(".modal_title_img").attr('src',
                        '{{ asset('assets/dashboard/img/disable_notification.png') }}');
                } else {
                    $(".modal_title_img").attr('src',
                        '{{ asset('assets/dashboard/img/enable_notification.png') }}');
                }
            ...
            $('#massagelistTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'massage_communication',
                        name: 'massage_communication'
                    },
                    {
                        data: 'is_blocked',
                        name: 'is_blocked',
            ...
            $(document).on('click', '.massageProfileView', function(e) {
                ...
                if (massageProfileIsEnabled == '0') {
                    let htmlData =
                        '<div class="col-md-12 my-4  text-center"><h5 class=" body_text mb-2">This Massage Centre does not presently have a Listed Profile.</h5></div>';
