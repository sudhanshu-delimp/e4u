...
<div class="row mt-5 d-none">
    <div class="col-md-9">
        ...
        <div class="alert alert-info bg-white border-0 shadow" style="border-left: #FFB648 solid 9px !important;">
            <button type="button" aria-hidden="true" class="close"><span aria-hidden="true"><img
                        src="{{ asset('assets/app/img/noti-cross.png') }}"
...
<div class="modal fade upload-modal" id="WelcomeViewerPopup" tabindex="-1" role="dialog"
