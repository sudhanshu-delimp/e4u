        ...
        <div class="row">
            ...
            @if ($notifications)
                @foreach ($notifications as $notification)
                    <x-global.notification-alert :heading="$notification['heading']" :content="$notification['content'] ?? $notification['template_name']" type="success" :member="null" />
                @endforeach
            @endif
            ...
            <div class="col-lg-4 box-wrapper">
                <div class="my-custom-box shadow-sm">
                    <a href="{{ url('user-dashboard/submitticket') }}?from=dashboard">
                        <div class="box-icon">
                            <img src="{{ asset('assets/dashboard/img/boxicon/icon_support-tickets.png') }}"
                                alt="Support Tickets">
                        </div>
                        <h2>
                            Support Tickets
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="welcome_common_para">
                                    ...
                                    <p>And a Profile system that delivers relevant information for you. Our Website has
                                        two Profile
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        new Swiper('.notification-swiper', {
            ...
            navigation: {
                nextEl: '.notification-swiper .swiper-button-next',
                prevEl: '.notification-swiper .swiper-button-prev',
            },
        });
    });
    ...
    $(document).ready(function() {
        ...
        $('.accordion-container .set > .accordion-title').on('click', function(e) {
            ...
            if ($this.hasClass('active')) {
                ...
                $('.accordion-container .set > a i').removeClass('fa-angle-up').addClass(
                    'fa-angle-down');
