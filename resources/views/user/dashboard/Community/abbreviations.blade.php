...
<div class="accodien_manage_padding_content">
   ...
   <p>These Website Abbreviations (<b>Abbreviations</b>) are to be read in conjunction with the
      <a href="{{ asset('terms-conditions') }}" class="termsandconditions_text_color custom_links_design">Terms and Conditions</a>. To the extent of any inconsistency between these Abbreviations
   ...
   <div class="row">
      <div class="col-lg-4">
         ...
         <p><b>Account or My Account:</b> has the same meaning as “<a href="#" class="termsandconditions_text_color custom_links_design">Account</a>” described in the Terms and incorporates the Membership Number.</p>
      ...
      <div class="col-lg-4">
         ...
         <p class="pb-4"><b>Website:</b> has the same meaning as “<a href="#" class="termsandconditions_text_color custom_links_design">Website</a>” described in
            the Terms
         </p>
      </div>
   </div>
