                        ...
                        <div class="tab-content tab-content-bg" id="myTabContent">
                            <div class="tab-pane fade show active" id="aboutme" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <div class="about-me-box-one-map">
                                                ...
                                                {{ $escort->address ? $escort->address.',' : null }} {{ $escort->city ? $escort->city->name : null }} {{ $escort->pincode }}
                                            </div>
                                ...
                                <div class="about_me_drop_down_info box_shadow_fill_profile">
                                    ...
                                    <div class="padding_20_all_side">
                                        <form id="update_about_me" action="{{ route('escort.about.me',[$escort->id])}}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select class="form-control form-control-sm select_tag_remove_box_sadow" id="" name="gender">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select class="form-control form-control-sm select_tag_remove_box_sadow" id="select2-dropdown" required name="nationality_id">
                                                                <option value="{{$escort->nationality_id}}" > {{$escort->nation->name}}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                            ...
                            <div class="tab-pane fade" id="available" role="tabpanel" aria-labelledby="contact-tab">
                                <div class="about_me_drop_down_info box_shadow_fill_profile">
                                    ...
                                    <div class="padding_20_all_side">
                                        <form id="myability" action="{{ route('escort.store.availability', [$escort->id])}}" method="Post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="col-md-5">
                                                                    <div class="service_rate_dolor_symbol form-group">
                                                                        <input type="text" class="form-control form-control-sm select_tag_remove_box_sadow timepicker-hr" name="mon_hh_from" value="{{ old('mon_hh_from', $escort->availabilityFromHour('monday')) }}"/>
                                                                        <span>:</span>
                                                                        <input type="text" class="form-control form-control-sm select_tag_remove_box_sadow timepicker-min" name="mon_mm_from" value="{{ old('mon_mm_from', $escort->availabilityFromMinute('monday')) }}"/>
                                                                        <input type="text" class="form-control form-control-sm select_tag_remove_box_sadow timepicker-a" name="mon_time_from" value="{{ old('mon_time_from', $escort->availabilityFromA('monday')) }}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-1">
                                                                    <span>to</span>
                            ...
                            <div class="tab-pane fade" id="pricing" role="tabpanel" aria-labelledby="contact-tab">
                                <form id="myPolicy" action="{{ route('escort.update.policy', [$escort->id])}}" method="Post">
                                    @csrf
                                <div class="about_me_drop_down_info box_shadow_fill_profile">
                                    <div class="about_me_heading_in_first_tab fill_profile_headings_global">
...
<script>
    ...
    $('.timepicker-hr').timepicker({
        timeFormat: 'hh'
    });

    $('.timepicker-min').timepicker({
        timeFormat: 'mm',
        interval: 15,
        minTime: '00',
        maxTime: '12:45am'
