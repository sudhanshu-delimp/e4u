                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mt-4">
                                        ...
                                        <form id="my_avatar" action="{{ route('user.save.avatar', auth()->user()->id) }}"
                                                    ...
                                                    <div class="image-title-wrap">
                                                        ...
                                                        <button type="button" onclick="removeUpload()"
                                                            class="remove-image">Remove <span class="image-title">Uploaded
                                                                Image</span></button>
                                                        <button type="submit" class="remove-image crop_image">Save <span
                                    ...
                                    <div class="col-lg-4 mt-4 current-avatar">
                                        ...
                                        <!-- <i class="fab fa-twitter delete_avatar"></i> -->
                            ...
                            <div class="card">
                                ...
                                <div id="File_name" class="collapse hide" data-parent="#accordion" style="">
                                    <div class="card-body">
                                        ...
                                        <p>We recommend using image files of less than 500 KB for best results, though the
                                            limit for an individual image upload is 2 MB.</p>
                                        ...
                                        <p>Save images in the sRGB color profile. If images don't look right on mobile
                                            devices, it's probably because they don't have an sRGB color profile.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><img src="{{ asset('assets/dashboard/img/crop-image.png') }}"
                            class="custompopicon"> Crop Photo</h5>
...
@push('script')
    ...
    <script>
        ...
        $("#my_avatar").on('submit', function(e) {
            ...
            // Client-side 10MB check before sending AJAX
