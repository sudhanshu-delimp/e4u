                    ...
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li>Complete the form to add an incident to Punterbox. When completing the form please
                                ...
                                complies with the <a href="{{ route('user.code-of-conduct') }}"
                                    class="custom_links_design">Code of Conduct</a>. </li>
                            <li>
        ...
        <div class="row">
            <div class="col-md-12 add-punterbox-report">
                <div class="common-card">
                    <form id="punterbox-reports" class="common-form">
                                ...
                                <div class="inner-field-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="incident_state" required>
                                            @foreach ($states as $key => $state)
                                                <option value="{{ $key }}"
                                                    {{ $key == auth()->user()->state_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="10"
                                            ...
                                            name="escorts_mobile" required
                                            placeholder="No spaces or any other characters - just numbers">
                                    </div>

                                    <div class="form-group">
                                        <label>Escort's Email</label>
                                        <input type="email" class="form-control" name="escorts_email"
                                            placeholder="If known">
                                    </div>

                                    <div class="form-group">
                                        <label class="required">Incident Nature</label>
                                        <select class="form-control" name="incident_nature" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="profile_link"
                                            placeholder="Link or Membership ID or Ref">
                                    </div>
                                </div>
                                <div class="inner-field-row">
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio-options mt-1">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" value="Do not book" checked type="radio"
                                                    name="rating" id="rate1">
                                                <label class="form-check-label" for="rate1">Do not book</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" value="Exercise caution" type="radio"
                                                    name="rating" id="rate2">
                                                <label class="form-check-label" for="rate2">Exercise caution</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" value="Safe" type="radio" name="rating"
                                                    id="rate3">
                    ...
                    success: function(data) {
                        ...
                        if (data.status) {
                            swal.fire(
                                ...
                                "Your Report has been received. Once approved by our administration it will appear on the Report list.",
                                'success'
                            );
                            form[0].reset();
                        } else {
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            $.each(errors, function(key, value) {
                                let input = $('[name="' + key + '"]');
                                input.after('<span class="text-danger error-text error_text">' +
                                    value[0] + '</span>');
                            });
                        } else {
                            swal.fire(
