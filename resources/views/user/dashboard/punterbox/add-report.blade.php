...
<div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
    ...
    <div class="row">
        <div class="col-md-9 add-punterbox-report">
            <form id="add_report_form" action="{{ route('punterbox.store') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" id="incident_state" name="incident_state">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="incident_location" name="incident_location" placeholder="Which city were you in">
                </div>

                <div class="form-group">
                    <label>Escort's Name</label>
                    <input type="text" class="form-control" id="escort_name" name="escort_name" placeholder="If known">
                </div>

                <div class="form-group">
                    <label class="required">Escort's Mobile</label>
                    <input type="text" class="form-control" id="escort_mobile" name="escort_mobile" maxlength="10" placeholder="No spaces or any other characters - just numbers">
                </div>

                <div class="form-group">
                    <label>Escort's Email</label>
                    <input type="email" class="form-control" id="escort_email" name="escort_email" placeholder="If known">
                </div>

                <div class="form-group">
                    <label class="required">Incident Nature</label>
                    <select class="custom-select" id="incident_nature" name="incident_nature">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="platform" name="platform" placeholder="If known">
                </div>

                <div class="form-group">
                    <label>Profile Link</label>
                    <input type="text" class="form-control" id="profile_link" name="profile_link" placeholder="Link or Membership ID or Ref">
                </div>

                <div class="form-group">
                    <label class="required">What Happened</label>
                    <textarea class="form-control" id="what_happened" name="what_happened" rows="4"></textarea>
                </div>

                <div class="form-group"> <label class="required d-block">Rating</label>
                    <div class="form-check d-flex align-items-center"> <input class="form-check-input" type="radio" name="rating" id="rate1" value="Do not book"> <label class="form-check-label" for="rate1">Do not book</label> </div>
                    <div class="form-check d-flex align-items-center"> <input class="form-check-input" type="radio" name="rating" id="rate2" value="Exercise caution"> <label class="form-check-label" for="rate2">Exercise caution</label> </div>
                    <div class="form-check d-flex align-items-center"> <input class="form-check-input" type="radio" name="rating" id="rate3" value="Safe"> <label class="form-check-label" for="rate3">Safe</label>
                    </div>
...
<script src="{{ asset('assets/dist/js/pages/punterbox/add-punterbox.js') }}"></script>
@endpush