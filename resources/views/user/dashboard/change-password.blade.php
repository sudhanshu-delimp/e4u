            ...
            <div class="col-md-12 mb-5">
                <div class="common-grid">
                    ...
                    <div class="common-card">
                        <form class="" autocomplete="off" id="userProfile"
                                    ...
                                    <div class="form-group cp-field">
                                        ...
                                        <div class="cp-input-wrap">
                                            <input type="password" placeholder="Confirm password" id="confirm_password"
                                                name="password_confirmation" data-parsley-equalto="#new_password"
                    ...
                    <div class="common-card">
                        <form class="" id="passwordExpiry" action="{{ route('user.update.password.expiry') }}"
                            method="POST">
                            <div class="col-md-12">
                                ...
                                <div class="option-list">
                                    ...
                                    <div class="form-radio">
                                        <input class="" name="password_expiry_days" type="radio" value="30"
                                            id="30days" @if ($user->account_setting && $user->account_setting->password_expiry_days == '30') {{ 'checked' }} @endif>
                                    ...
                                    <div class="form-radio">
                                        <input class="" name="password_expiry_days" type="radio" value="60"
                                            id="60days" @if ($user->account_setting && $user->account_setting->password_expiry_days == '60') {{ 'checked' }} @endif>
                                    ...
                                    <div class="form-radio">
                                        <input class="" name="password_expiry_days" type="radio" value="90"
                                            id="90days" @if ($user->account_setting && $user->account_setting->password_expiry_days == '90') {{ 'checked' }} @endif>
                                        <label class="form-check-label" for="90days">Renew every 90 days</label>
                                    </div>
                                    <div class="card-note">
                                        <span class="note-icon">i</span>
                                        <p> <i>Unless you set your preferred Password Expiry, by default your
                                                password will
                            ...
                            <div class="col-md-12 mt-4">
                                ...
                                <div class="card-note">
                                    <span class="note-icon">i</span>
                                    <p> <i>If you select to be notified of your impending password expiry by
                                            Text or
