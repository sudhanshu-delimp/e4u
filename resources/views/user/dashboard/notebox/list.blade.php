                    ...
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li>You can also select a Notebox you wish to edit or remove from your register by clicking
                                ...
                                removed.</li>
                            <li>New Noteboxes when created or edited, are listed here. You can only create one Notebox for
                                any Member ID.</li>
                        </ol>
                    </div>
                </div>
                                ...
                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path
                                            ...
                                            stroke="#ff3c5f" stroke-width="2" stroke-linecap="round"></path>
                                    </g>
                                </svg>
                            </div>
                            <div class="stats-top">
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            $('.notebox-profile-wrap').off('click');
            $('.notebox-profile-wrap').on('click', function() {
                alert("df");
                var image = $(this).find('.note-box-profile');
            ...
            <tr>
                <td colspan="6" class="border-0">
                  <div class="notebox-profile notebox-profile-wrap">
                    <img src="${data.profile_pic}"
                         alt="Profile Image" class="note-box-profile"
                         style="width: 120px; height: 120px; object-fit: cover; border-radius: 6px;">

                     <span class="custom-tooltip" data-target="#viewProfile" data-toggle="modal">Click to view </span>
                  </div>
                </td>
            </tr>
        `;
    ...
    `;
        ...
        $(document).on('click', '.notebox-profile-wrap', function() {
            const img = $(this).find('img.note-box-profile');
