                     ...
                     <div class="col-md-6 mb-3">
                        <div class="form-check form-check-inline">
                           ...
                           <div class="d-flex flex-wrap">
                              ...
                              <div class="form-check form-check-inline">
                                 <input type="radio" class="form-check-input" name="rating" id="r5" value="5">
                                 <label class="form-check-label" for="r5">5</label>
                              </div>
                              <div class="form-check form-check-inline">
                                 <input type="radio" class="form-check-input" name="rating" id="r6" value="6">
                                 <label class="form-check-label" for="r6">6</label>
                              </div>
                              <div class="form-check form-check-inline">
                                 <input type="radio" class="form-check-input" name="rating" id="r7" value="7">
                                 <label class="form-check-label" for="r7">7</label>
                              </div>
                              <div class="form-check form-check-inline">
                                 <input type="radio" class="form-check-input" name="rating" id="r8" value="8">
                                 <label class="form-check-label" for="r8">8</label>
                              </div>
                              <div class="form-check form-check-inline">
                                 <input type="radio" class="form-check-input" name="rating" id="r9" value="9">
                                 <label class="form-check-label" for="r9">9</label>
                              </div>
                              <div class="form-check form-check-inline">
                                 <input type="radio" class="form-check-input" name="rating" checked id="r10" value="10">
