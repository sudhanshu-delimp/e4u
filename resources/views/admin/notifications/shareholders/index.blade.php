...
@endphp
                ...
                <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
                    <div class="row">
                        <div class="custom-heading-wrapper col-md-12">
                            <h1 class="h1">Shareholder (Notifications)</h1>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="card collapse" id="notes">
                                <div class="card-body">
                                    ...
                                    <ol>
                                        <li>You can create a Notification, published at the top of the Shareholder's Dashboard.
                                        </li>
                                    </ol>
                                </div>
                            </div>
    ...
    <div id="manage-route" data-scrf-token="{{ csrf_token() }}"
        ...
        data-shareholders-notification-index="{{ route('admin.shareholders.notifications.index') }}"
        data-shareholders-notification-store="{{ route('admin.shareholders.notifications.store') }}"
        data-shareholders-notification-show="{{ route('admin.shareholders.notifications.show', ['id' => '__ID__']) }}">
        ...
        <script>
            $(document).ready(function() {
                ...
                endpoint = {
                    ...
                    shareholders_notification_status: mmRoot.data('shareholders-notification-status'),
                    shareholders_notification_edit: mmRoot.data('shareholders-notification-edit'),
                    shareholders_notification_update: mmRoot.data('shareholders-notification-update'),
                    shareholders_notification_index: mmRoot.data('shareholders-notification-index'),
                    shareholders_notification_store: mmRoot.data('shareholders-notification-store'),
                    shareholders_notification_show: mmRoot.data('shareholders-notification-show'),
                }
                ...
                function ensureParsleyAndSubmit(form) {
                    ...
                    $.ajax({
                        url: endpoint.shareholders_notification_store,
                        type: "POST",
                ...
                var table = $("#agentNotificationTable").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: endpoint.shareholders_notification_index,
                        type: 'GET'
                    },
                    columns: [{
                            data: 'ref',
                ...
                $(document).on('click', '.js-view', function(e) {
                    ...
                    $.ajax({
                        url: endpoint.shareholders_notification_show.replace('__ID__', id),
                        type: 'GET',
                        success: function(response) {
                ...
                $(document).on('click', '.js-suspend, .js-publish, .js-remove', function(e) {
                    ...
                    body.off('click', '#confirmRemove').on('click', '#confirmRemove', function() {
                        $(this).prop('disabled', true);
                        $.ajax({
                            url: endpoint.shareholders_notification_status.replace('__ID__', id),
                            type: 'POST',
                            data: {
                                _token: endpoint.csrf_token,
                                status: status
                ...
                $(document).on('click', '.js-edit', function(e) {
                    ...
                    removeValidationMsg();
                    $.ajax({
                        url: endpoint.shareholders_notification_edit.replace('__ID__', id),
                        type: 'GET',
                        success: function(response) {
