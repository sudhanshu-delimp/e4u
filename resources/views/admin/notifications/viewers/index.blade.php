                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group col-lg-12 schedule-options" id="startyearlyOptions"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label class="label" for="startFirstMonth">Start
                                                                Month</label>
                                                            <select id="startFirstMonth"
                                        ...
                                        <div class="form-group col-lg-12 schedule-options" id="monthlyOptions"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label class="label" for="monthWiseStartDate">Start
                                                                Day</label>
                                        ...
                                        <div class="form-group col-lg-12 schedule-options" id="weekOptions"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label class="label" for="weekWiseStartDate">Start
                                                                Day</label>
                                ...
                                <div id="templateSelect" style="display: none;" class="col-12 mb-3">
                                    ...
                                    <select id="template_name" name="template_name" class="form-control rounded-0">
                                        ...
                                        <option
                                            value="Have you completed all of your feature settings?  To access all the features, they must be enabled.">
                                            Have you completed all of your feature settings? To access all the features,
                                            they must be enabled.</option>
                                        <option
                                            value="To receive a Tour Notification from your Legbox Escorts, that feature must be enabled.">
                                            To receive a Tour Notification from your Legbox Escorts, that feature must be
                                            enabled.
                                        </option>
                                        <option
                                            value="To write a Review on any of your favourite Advertisers, that feature must be enabled.">
                                            To write a Review on any of your favourite Advertisers, that feature must be
                                            enabled.
                                        </option>
                                        <option
                                            value="What to communicate with your Legbox Escorts?  Make sure you have enabled that feature.">
                                            What to communicate with your Legbox Escorts? Make sure you have enabled that
                                            feature.</option>
                                    </select>
                                </div>
