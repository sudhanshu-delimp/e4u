                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input monday" type="radio" name="availability_time[monday]" id="monday" value="unavailable" data-parsley-multiple="covidreport" @if(!empty($massage_profile->availability->availability_time['monday'])) {{ $massage_profile->availability->availability_time['monday'] == 'unavailable' ? 'checked' : ''}} @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11 p-0 tuesday">
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input tuesday" type="radio" name="availability_time[tuesday]" id="tuesday" value="unavailable" data-parsley-multiple="covidreport" @if(!empty($massage_profile->availability->availability_time['tuesday']))  {{ $massage_profile->availability->availability_time['tuesday'] == 'unavailable' ? 'checked' : ''}} @endif>
                                            <label class="form-check-label" for="inlineRadio1">Unavailable</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11 p-0 wednesday">
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input wednesday" type="radio" name="availability_time[wednesday]" id="wednesday" value="unavailable" data-parsley-multiple="covidreport" @if(!empty($massage_profile->availability->availability_time['wednesday'])) {{ $massage_profile->availability->availability_time['wednesday'] == 'unavailable' ? 'checked' : ''}} @endif>
                                            <label class="form-check-label" for="inlineRadio1">Unavailable</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11 p-0 thursday">
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input thursday" type="radio" name="availability_time[thursday]" id="thursday" value="unavailable" data-parsley-multiple="covidreport"  @if(!empty($massage_profile->availability->availability_time['thursday'])) {{ $massage_profile->availability->availability_time['thursday'] == 'unavailable' ? 'checked' : ''}} @endif>
                                            <label class="form-check-label" for="inlineRadio1">Unavailable</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11 p-0 friday">
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input friday" type="radio" name="availability_time[friday]" id="friday" value="unavailable" data-parsley-multiple="covidreport" @if(!empty($massage_profile->availability->availability_time['friday'])) {{ $massage_profile->availability->availability_time['friday'] == 'unavailable' ? 'checked' : ''}} @endif>
                                            <label class="form-check-label" for="inlineRadio1">Unavailable</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11 p-0 saturday">
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input saturday" type="radio" name="availability_time[saturday]" id="saturday" value="unavailable" data-parsley-multiple="covidreport" @if(!empty($massage_profile->availability->availability_time['saturday'])) {{ $massage_profile->availability->availability_time['saturday'] == 'unavailable' ? 'checked' : ''}} @endif>
                                            <label class="form-check-label" for="inlineRadio1">Unavailable</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11 p-0 sunday">
                                <div class="row">
                                    ...
                                    <div class="col-4 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input sunday" type="radio" name="availability_time[sunday]" id="sunday" value="unavailable" data-parsley-multiple="covidreport" @if(!empty($massage_profile->availability->availability_time['sunday'])) {{ $massage_profile->availability->availability_time['sunday'] == 'unavailable' ? 'checked' : ''}} @endif>
                                            <label class="form-check-label" for="inlineRadio1">Unavailable</label>
                                        </div>
                                        <div class="form-check form-check-inline">
