        ...
        <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-2">
                    <button type="button" class="create-tour-sec dctour" id="change_pin_modal" data-toggle="modal" data-target="#sendOtp_modal">Change PIN</button>
                </div>
