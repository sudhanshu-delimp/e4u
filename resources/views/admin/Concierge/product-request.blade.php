            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="card-body">
                    ...
                    <ol>
                     ...
                     <li>An email setting out the Product order has also been sent to <a href="mailto:admin@e4u.com.au" class="custom_links_design">admin@e4u.com.au</a>.</li>
...
<script>
      var table = $("#ProductOrdersTable").DataTable({
      language: {
