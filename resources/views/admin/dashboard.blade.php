...
{{-- display none hai old code --}}

<div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5 d-none">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-9 ">
            ...
            <div class="custom-heading-wrapper mb-4">
                <h1 class="h1">Administrator Dashboard</h1>
            </div>
