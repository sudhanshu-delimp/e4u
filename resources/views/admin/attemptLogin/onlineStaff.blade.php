        ...
        <div class="col-sm-12 col-md-12 col-lg-12 ">
            ...
            <div class="container-fluid" style="padding: 0px 0px;">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800 font-weight-500">Online Users</h1>
                                    ...
                                    <th scope="col">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                for="flexCheckDefault">Status</label>
                                        </div>
                                    </th>
                                    <th scope="col">ID</th>
...
<script>
    ...
    $("#service-table").DataTable({
        ...
        ajax: {
            url: "{{ route('admin.monitor.showOnlineStaff') }}",
            data: function (d) {
                d.type = 'player';
            }
        },
        columns: [
            { data: 'staff_status', id: 'staff_status', searchable: true, orderable:true,defaultContent: 'NA' },
            { data: 'id', id: 'id', searchable: true, orderable:true,defaultContent: 'NA' },
            { data: 'staff_name', name: 'staff_name', searchable: true, orderable:true,defaultContent: 'NA' },
            { data: 'staff_type', name: 'staff_type', searchable: true, orderable:true,defaultContent: 'NA' },
