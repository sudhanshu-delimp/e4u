...
<script>
    ...
    $("#service-table").DataTable({
        ...
        ajax: {
            url: "{{ route('admin.monitor.attemptLogin') }}",
            data: function (d) {
                d.type = 'player';
            }
        },
        columns: [
            ...
            { data: 'type', name: 'type', searchable: false, orderable:true ,defaultContent: 'NA'},
            { data: 'device', name: 'device', searchable: true, orderable:true,defaultContent: 'NA' },
            { data: 'country', name: 'country', searchable: true, orderable:true, defaultContent: 'NA' },
            { data: 'city', name: 'city', searchable: true, orderable:true, defaultContent: 'NA' },
            { data: 'time', name: 'time', searchable: true, orderable:true, defaultContent: 'NA' },
        ]
    });
