                    ...
                    <div class="notes-section">
                        ...
                        <div class="mt-5 table-responsive">
                            <table style="width:100%; border-collapse:collapse;">
                                <tr>
                                    ...
                                    <td colspan="2" style="border:1px solid #000; padding:8px;">
                                        <label style="display:inline-flex; align-items:center; gap:6px; margin:0;">
                                            <input type="checkbox" style="margin:0;"> <span
                                                style="font-weight:600;">Reject
                                                Review</span>
                                        </label>
                                    </td>
                                    <td colspan="2" style="border:1px solid #000; padding:8px;">
                                ...
                                <tr>
                                    <td colspan="1"
                                        style="border:1px solid #000; padding:25px 12px; font-weight:bold; width:110px;"
                                        colspan="1">Name:</td>
                                    <td colspan="2" style="border:1px solid #000; padding:25px 12px;"></td>
                                    <td colspan="1"
                                        style="border:1px solid #000; padding:25px 12px; font-weight:bold; width:120px">
                                        Signature:</td>
                                    <td colspan="2" style="border:1px solid #000; padding:25px 12px;"></td>
                                </tr>
                            </table>
        ...
        $(document).on('click', '.saveStatus', function(e) {
            ...
            if (status == 'published') {
                ...
                $(".success-modal-text").text(
                    'We’re sorry to inform you that your review has been updated to pending.');
            }
