...
<style type="text/toastr.success('User status updated successfully!');css">
    .parsley-errors-list {
        list-style: none;
        color: rgb(248, 0, 0)
    }
...
<div class="modal fade upload-modal" id="viewMemberdetails" tabindex="-1" role="dialog" aria-labelledby="Edit_CompetitorLabel" aria-hidden="true"></div>
<div class="modal fade upload-modal" id="rejectRegReason" tabindex="-1" role="dialog" aria-labelledby="Edit_CompetitorLabel" aria-hidden="true"></div>
                                          ...
                                          <div class="card mb-3 p-3">
                                              <div class="row">
                                                ...
                                                <div class="d-flex justify-content-end  mt-2">
                                                   <!-- Print Button -->  
                                                 <button type="button" class="btn-success-modal mr-2 mt-3 confirm-reject-registration" data-target="#reject-registration-confirm-popup" data-toggle="modal">Save</button>
