            ...
            <div class="modal-body" id="escortPopupModalBody">
                <div class="col-md-12 " id="printArea">
                    ...
                    <table class="table table-bordered mb-3">
                        <tr>
                            <th style="font-weight: 600"> Merchant ID</th>
                            <td><span class="account_member_id">M60178</span></td>
                        </tr>
                        <tr>
                            <th style="font-weight: 600"> Member</th>
                            <td><span class="account_member_name">Lins Massage</span></td>
                        </tr>
                        <tr>
                            <th style="font-weight: 600"> IP Address</th>
                            <td><span class="account_ip_address">123.176.113.164</span></td>
                        </tr>
                        <tr>
                            <th style="font-weight: 600"> Platform</th>
                            <td><span class="account_platform">Firefox</span></td>
                        </tr>
                        <tr>
                            <th style="font-weight: 600"> Page</th>
                            <td><span class="account_visit_page">/escort-dashboard</span></td>
                        </tr>
