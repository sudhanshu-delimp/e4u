<div class="modal fade upload-modal" id="view_tag" style="display: none">
                                ...
                                <div class="dropdown no-arrow">
                                    ...
                                    <div class="dot-dropdown dropdown-menu  dropdown-menu-right shadow animated--fade-in"
                                        ...
                                        <a class="dropdown-item d-flex align-items-center justify-content-start gap-10"
                                            href="#" data-toggle="modal" data-target="#approve_media"> <i
                                                class="fa fa-check-circle"></i> Approve</a>
                                        <div class="dropdown-divider"></div>

                                        <a class="dropdown-item d-flex align-items-center justify-content-start gap-10"
                                            href="#" data-toggle="modal" data-target="#reject_media"> <i
