            ...
            <div class="stats-container">
                <div class="stat-card-wrapper">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number month_report ">{{number_format(00)}}</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number year_report">{{number_format(00)}}</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number all_time_report">{{number_format(00)}}</div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" charset="utf8" src="{{ asset('assets/dist/js/pages/punterbox/punterbox-admin-list.js') }}"></script>
@endpush