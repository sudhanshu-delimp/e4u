                                        ...
                                        @foreach ($feeDatas as $agentId => $feeData)
                                            ...
                                            @if (count($esortReports) > 0)
                                                @foreach ($esortReports as $esortReport)
                                                    @php
                                                        $totalEscortDays =
                                                            $totalEscortDays + $esortReport['total_days'];
                                                        $totalEscortSpent =
                                                            $totalEscortSpent + $esortReport['total_purchase_amount'];
                                                        $totalEscortAgenFee =
                                                            $totalEscortAgenFee +
                                                            $esortReport['total_commission_amount'];
                                                        $cnt++;
                                                    @endphp
                                                    ...
                                                    <tr class="accordion-toggle" data-toggle="collapse"
                                                        ...
                                                        <td class="text-left">
                                                            <div class="num_value">
                                                                $<span>{{ $esortReport['total_commission_amount'] }}</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <!-- Detail rows -->
                                            ...
                                            @if (count($massgeReports) > 0)
                                                @foreach ($massgeReports as $massgeReport)
                                                    @php
                                                        $totalMassageDays =
                                                            $totalMassageDays + $massgeReport['total_days'];
                                                        $totalMassageSpent =
                                                            $totalMassageSpent + $massgeReport['total_purchase_amount'];
                                                        $totalMassageAgenFee =
                                                            $totalMassageAgenFee +
                                                            $massgeReport['total_commission_amount'];
                                                    @endphp

                                                    <tr class="accordion-toggle" data-toggle="collapse"
                                                        data-target="#details3" aria-expanded="false"
                                                        aria-controls="details3">
                                                        <td class="text-left">{{ $agentMemberId }}</td>
                                                        <td class="opr_expand_arrow">{{ $massgeReport['user_name'] }}
                                                        </td>
                                    ...
                                    <tfoot>
                                        @php
                                            ...
                                            $totalSpent = number_format(
                                                $totalMassageSpent + $totalEscortSpent,
                                                2,
                                                '.',
                                                '',
                                            );
                                            $totalAgenFee = number_format(
                                                $totalMassageAgenFee + $totalEscortAgenFee,
                                                2,
                                                '.',
                                                '',
                                            );
