      ...
      <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
         ...
         <div class="row">
            <div class="custom-heading-wrapper col-md-12">
                  <h1 class="h1">Set Security & Access Levels</h1>
                  ...
                  <div class="panel-body">
                     <div class="tab-content">
                        <div class="tab-pane fade in active show" id="tab1warning">
                           <div  class="table-responsive-xl w-100 mt-5">
                        ...
                        <div class="tab-pane fade mt-5" id="tab2warning">
                        ...
                        <div class="tab-pane fade mt-5" id="tab4warning">
                           <div class="table-responsive-xl">
                              <ol>
                                 ...
                                 <ul class="w-75 mt-2" style="list-style: none;">
                                    <li>Access levels are set by the Managing Director. By default, the levels are:</li>
                                 </ul>
                                 <ul class="w-75" style="list-style: none;">
                                 ...
                                 <ul class="w-75" style="column-count: 3;list-style: none;">
                                    ...
                                    <li style="margin-left: -70px;">
                                       <ul style="display: inline-block;">
                                          ...
                                          <li>My Account</li>
                                          <li>Profiles &amp; Archives</li>
                                          <li style="list-style: none;margin-left: -30px;">Massage Centre Console:</li>
                                          <li>My Account</li>
                                          <li>Profiles &amp; Archives</li>
                                          <li>Masseurs Profiles</li>
                                       </ul>
                                    </li>
                                 </ul>

                                 <ul class="w-75" style="list-style: none;">
                                    <li><span class="pr-5">(e)</span>Staff:<span class="pl-5 ml-5">Operations Console - Security Level 2 Consoles</span></li>
                                 </ul>
