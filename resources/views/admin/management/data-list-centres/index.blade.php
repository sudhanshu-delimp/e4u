...
@section('content')
    ...
    <!-- open success popup -->
    <div class="modal fade upload-modal" id="successModal" tabindex="-1" role="dialog" aria-labelledby="successModallabel" aria-hidden="true" data-backdrop="static">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.js-suspend, .js-pending, .js-active', function(e){
                    ...
                    let status = '';
                    let confirmMsg = '';
                    if ($(this).hasClass('jjs-suspend')) {
                        status = 'Suspended';
                        confirmMsg = 'Are you sure you want to suspend this Centres';
                    } else if($(this).hasClass('js-active')){
                        status = 'Active';
                        confirmMsg = 'Are you sure you want to Active this Centres';
                    } else if($(this).hasClass('js-pending')) {
                        status = 'Pending';
                        confirmMsg = 'Are you sure you want to Pending this Centres';
                    }
