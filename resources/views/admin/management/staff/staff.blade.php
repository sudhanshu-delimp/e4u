                    ...
                    <form name="add_staff" id="add_staff" method="POST" action="{{ route('admin.add-staff') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="tel" maxlength="14" autocomplete="off" class="form-control rounded-0 formatMobile" name="phone" id="phone"
                                    oninput="this.value = this.value.replace(/\D/g,'');" onfocus="this.value = this.value.replace(/\D/g,'');">
