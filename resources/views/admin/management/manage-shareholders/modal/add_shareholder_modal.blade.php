                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addShareholderTitle"><img
                                src="{{ asset('assets/dashboard/img/add-member.png') }}" class="custompopicon"> Add New Shareholder</h5>
                                ...
                                <div class="col-12 mb-3">
                                 <h6 class="border-bottom pb-1 text-blue-primary">Method of Contact:</h6>
                                    ...
                                    <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="checkbox" id="email" name="contact_type[]" value="3">
                                          <label class="form-check-label" for="email">Email</label>
                                    </div>
                                    <div class="form-check form-check-inline">
