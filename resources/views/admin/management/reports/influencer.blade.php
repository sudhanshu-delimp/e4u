                ...
                <div class="report-wrapper">
                    ...
                    <table class="report-table">
                        ...
                        <tr>
                            <th>Past Listings</th>
                            <td>
                                <div class="flex_value"><span>Platinum:</span> No.</div>
                            </td>
                            <th>Spend</th>
                            <td>$ Value (Avg: $)</td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                <div class="flex_value"><span>Gold:</span> No.</div>
                            </td>
                            <th>Spend</th>
                            <td>$ Value (Avg: $)</td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                <div class="flex_value"><span>Silver:</span> No.</div>
                            </td>
                            <th>Spend</th>
                            <td>$ Value (Avg: $)</td>
                        </tr>
                        <tr>
                            <th></th>
                            <td class="text-right total-value">Total: No.</td>
                            <th class="text-right total-value">Total</th>
                            <td class="total-value">$ Value (Avg: $)</td>
                        </tr>

                        <tr>
                            <th>Tours</th>
                            <td>
                                <div class="flex_value"><span>Current:</span> Yes or No
                            </td>
                            <th>Spend</th>
                            <td>$ Value</td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                <div class="flex_value"><span>Past:</span> No.
                            </td>
                            <th>Spend</th>
                            <td>$ Value</td>
                        </tr>
