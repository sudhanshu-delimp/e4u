...
<style>
    /*  HEADER  */
        ...
        .checkbox-row input:checked+.custom-checkbox i {
            display: block;
        }
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="seo-wrapper">
                        ...
                        <form id="seoForm" method="POST" action="{{ route('admin.seo.save') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="route_name" id="seoRouteName" value="">
                            <input type="hidden" name="url" id="seoUrl" value="{{ request('url') }}">
                            ...
                            <div class="seo-layout">
                                ...
                                <main class="content-panel">
                                    ...
                                    <section class="seo-card">
                                        <div class="section-heading">
                                            <div class="section-icon">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <g id="SVGRepo_iconCarrier">
                                                        <path d="M12.32 19.98C11.74 19.98 11.16 19.76 10.72 19.32L4.24 12.85C4.1 12.71 4.02 12.52 4.02 12.32V4.77002C4.02 4.36002 4.36 4.02002 4.77 4.02002H12.31C12.51 4.02002 12.7 4.10002 12.84 4.24002L19.32 10.72C20.19 11.6 20.19 13.03 19.32 13.91L13.91 19.32C13.47 19.76 12.89 19.98 12.31 19.98H12.32ZM5.52 12.01L11.78 18.26C12.08 18.55 12.56 18.55 12.85 18.26L18.26 12.85C18.55 12.56 18.55 12.08 18.26 11.78L12 5.52002H5.52V12V12.01ZM8.5 9.75002C7.81 9.75002 7.25 9.19002 7.25 8.50002C7.25 7.81002 7.81 7.25002 8.5 7.25002C9.19 7.25002 9.75 7.81002 9.75 8.50002C9.75 9.19002 9.19 9.75002 8.5 9.75002Z"
                                                        fill="#ff3c5f"></path>
                                                    </g>
                                                </svg>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="textarea-counter">
                                                <textarea id="metaDescription" name="meta_description" maxlength="160" rows="3">Shop handcrafted leather bags made in small batches. Free shipping over $50 and a 30-day return policy.</textarea>
                                        ...
                                        <div class="google-preview">
                                            ...
                                            <div class="preview-description" id="googleDescription">
                                                Shop handcrafted leather bags made in small batches. Free shipping over $50 and a 30-day return policy.
                                            </div>
                                        </div>
                                    </section>
                                    <!--  OPEN GRAPH  -->
                                    <section class="seo-card">
                                        ...
                                        <div class="og-layout">
                                            ...
                                            <div class="image-upload">
                                                <input type="file" id="ogImage" name="og_image" accept="image/*" hidden>
                                                <label for="ogImage">
                                            ...
                                            <div class="og-fields">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="ogTitle" name="og_title" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section class="seo-card">
                                            ...
                                            <div class="section-heading">
                                                <div class="section-icon">
                                                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                                            <path d="M7 8L3 11.6923L7 16M17 8L21 11.6923L17 16M14 4L10 20" stroke="#ff3c5f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                        </g>
                                                    </svg>
                                                </div>
                                                <h2>Schema Markup</h2>
                                        ...
                                        <textarea class="schema-code" id="schemaScript" name="schema_script" rows="8"></textarea>
                                        <p class="schema-help">
                                            Fields above generate this automatically. No JSON editing needed.
                                        </p>
                                    </section>
                                </main>
                                <!--  RIGHT SIDEBAR  -->
                                    ...
                                    <section class="tip-card">
                                        <div class="tip-icon">
                                            <svg width="24px" height="24px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="none">
                                                ...
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                <g id="SVGRepo_iconCarrier">
                                                    <path fill="#ff3c5f" fill-rule="evenodd" d="M10 3a7 7 0 100 14 7 7 0 000-14zm-9 7a9 9 0 1118 0 9 9 0 01-18 0zm8-4a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1zm.01 8a1 1 0 102 0V9a1 1 0 10-2 0v5z">
                                                    </path>
                                                </g>
                                            </svg>
                                        </div>
                                        <p>
                                            Make sure your meta title and description are unique and relevant to get better visibility on search engines.
                                        </p>
                                    </section>
                                </aside>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateCounterClass( element, length, maximum) {
            ...
            function setSeoFormData(data) {
                ...
                $("input[name='sitemap_include'][type='checkbox']").prop(
                    "checked",
                    Boolean(Number(data.sitemap_include))
                );
                updateTitle();
                updateDescription();
            }

            function loadSeoData(pageItem) {
                const pageUrl = $(pageItem).data("url-name");
                const routeName = $(pageItem).data("route-name");

                $(".page-item").removeClass("active");
                $(pageItem).addClass("active");
                $("#seoRouteName").val(routeName);
                $("#seoUrl").val(pageUrl);
            ...
            const seoRouteName = $("#seoRouteName");
            const seoUrl = $("#seoUrl");

            $(".page-item").each(function() {
                const pageUrl = $(this).data("url-name");

                if (pageUrl === selectedUrl) {
                    $(this).addClass("active");
                    seoRouteName.val($(this).data("route-name"));
                    seoUrl.val(pageUrl);
                    loadSeoData(this);
                }
            }).on("click", function() {
                ...
                nextUrl.searchParams.set("url", $(pageItem).data("url-name"));
                window.history.pushState({}, "", nextUrl.toString());
                loadSeoData(pageItem);
            });

            if (!selectedUrl && $(".page-item").length) {
                const firstPageItem = $(".page-item").first();
                const nextUrl = new URL(window.location.href);

                nextUrl.searchParams.set("url", firstPageItem.data("url-name"));
                window.history.replaceState({}, "", nextUrl.toString());
                loadSeoData(firstPageItem[0]);
            }
