               ...
               <div class="modal-body">
                   <div class="row">
                       ...
                       <div class="col-12 mb-3">
                           ...
                           <select name="shareholder_id" id="edit_shareholder_id" class="form-control rounded-0">
                               ...
                               <option value="3" data-name="Michael Johnson" data-memberid="MEM003">Michael Johnson
                               </option>
                       ...
                       <div class="col-md-12 mb-3 trust-fields d-none">
                           <label for="trustee">Upload Trust Deed <a href="#" class="custom_links_design"
                                   data-target="#trust_deed_modal" data-toggle="modal">here</a>.</label>
       ...
       @push('script')
           <script>
               $(document).ready(function() {
                   ...
                   $('#edit_shareholder_id').on('change', function() {
