<div class="dropdown no-arrow">
    ...
    <div class="dot-dropdown dropdown-menu dropdown-menu-right shadow animated--fade-in"
       ...
       <div class="custom-tooltip-container">
         ...
         <a class="dropdown-item align-item-custom cancel_discount" href=""  data-discount_id="{{$item->id}}"> <i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
         {{-- <a class="dropdown-item align-item-custom cancel_discount" data-toggle="modal" data-target="#confirm" href=""  data-discount_id="{{$item->id}}"> <i class="fa fa-times" aria-hidden="true"></i> Cancel</a> --}}
