   ...
   <script>
      ...
      $(document).ready(function() {
         ...
         $(document).on('click', '.edit_item', function(e) {
            ...
            $('#concierge_services_modal').modal({
               backdrop: 'static',
               keyboard: false
            });
      ...
      $(document).on('click', '.edit_item_loyalty_program_advertisers', function(e) {
         ...
         $('#loyalty_program_advertisers_modal').modal({
            backdrop: 'static',
            keyboard: false
         });
      ...
      $(document).on('click', '.edit_item_agent_operator_fees_modal', function(e) {
         ...
         $('#agent_operator_fees_modal').modal({
            backdrop: 'static',
            keyboard: false
         });
      ...
      $(document).on('click', '.edit_item_commision_playbox_fees', function(e) {
         ...
         $('#commision_playbox_fees_fees_modal').modal({
            backdrop: 'static',
            keyboard: false
         });
