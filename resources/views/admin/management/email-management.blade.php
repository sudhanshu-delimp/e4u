...
@section('content')
    ...
    {{-- add new record --}}
    <div class="modal fade upload-modal" id="createNewrecord" tabindex="-1" role="dialog"
        aria-labelledby="createNewrecord" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content basic-modal">
                <div class="modal-header">
                    <h5 class="modal-title" id="createNewrecord"> <img src="{{ asset('assets/dashboard/img/mailing.png') }}"
                            class="custompopicon"> Add New Record</h5>
                    ...
                    <div class="modal-body pb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="email" class="form-control rounded-0 fw-bold" placeholder="Email Account "
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control rounded-0" placeholder="Notification Address"
    ...
    <div class="modal fade upload-modal" id="renewEmailmodal" tabindex="-1" role="dialog"
        aria-labelledby="renewEmailmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    {{-- edit new record --}}
    <div class="modal fade upload-modal" id="editNewrecord" tabindex="-1" role="dialog"
        aria-labelledby="editNewrecord" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editNewrecord"> <img
                            src="{{ asset('assets/dashboard/img/mailing.png') }}" class="custompopicon"> Edit Email Record
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><img src="{{ asset('assets/app/img/newcross.png') }}"
                                class="img-fluid img_resize_in_smscreen"></span>
                    ...
                    <div class="modal-body pb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="email" class="form-control rounded-0 fw-bold"
                                    placeholder="Server email account " name="server" required>
                            </div>
