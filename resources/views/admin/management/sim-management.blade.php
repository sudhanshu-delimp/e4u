...
@section('content')
                           ...
                           <div class="d-flex justify-content-end mt-3">
                              @if ($addAccessEnabled)
                                 <button type="button" class="btn-common mr-0" data-toggle="modal"
                                       data-target="#createNotification">Add New Record</button>
                              @endif
                           </div>
                          </div>
                        </div>
                                ...
                                <table class="table" id="EmailManageTable">
                                    ...
                                    <tbody class="table-content">
                                        <tr class="row-color">
                                            ...
                                            <td class="theme-color">-</td>
                                            <td class="theme-color">-</td>
                                            <td class="theme-color"><span
                                                    class="custom_badge badge_available">Available</span></td>
                                                ...
                                                @if ($editAccessEnabled)
                                                    <div class="dropdown no-arrow text-center">
                                                        ...
                                                        <div class="dot-dropdown dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center justify-content-start gap-10"
                                                                href="javascript:void(0);" data-toggle="modal"
                                                                data-target="#editSIMModal"> <i class="fa fa-fw fa-pen"></i>
                                                                Edit</a>
                                                            <div class="dropdown-divider"></div>

                                                            <a class="dropdown-item d-flex align-items-center justify-content-start gap-10"
                                                                href="javascript:void(0);" data-target="#renewSIMModal"
                                                                data-toggle="modal"> <i class="fa fa-sync-alt"></i>
                                                                Renew</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item d-flex align-items-center justify-content-start gap-10"
                                                                href="javascript:void(0);" data-toggle="modal"
                                                                data-target="#confirmModal"> <i class="fa fa-fw fa-ban"></i>
                                                                Suspend</a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createNotification"> <img
                            src="{{ asset('assets/dashboard/img/add-sim.png') }}" class="custompopicon"> Add New Record
                    </h5>
                    ...
                    <div class="modal-body pb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control rounded-0 fw-bold" placeholder="Carrier"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="email" class="form-control rounded-0" placeholder="USIM" name="usim"
                                    required>
                            </div>
    ...
    <!-- Confirmation Modal -->
    <div class="modal fade upload-modal" id="confirmSaveModal" tabindex="-1" role="dialog"
    ...
    <div class="modal fade upload-modal" id="confirmModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmSaveModalLabel">
                        <img src="{{ asset('assets/dashboard/img/unblock.png') }}" class="custompopicon"> Common
                        Confirmation Modal
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">
    ...
    <div class="modal fade upload-modal" id="editSIMModal" tabindex="-1" role="dialog"
        aria-labelledby="editSIMModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <form>
                    <div class="modal-body pb-0">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label for="USIM" class="label">USIM</label>
                                <input type="text" class="form-control rounded-0 fw-bold" placeholder="USIM"
                                    name="usim" required>
                            </div>
                            <!-- Mobile Number Field -->
                            <div class="col-12 mb-3">
    ...
    <div class="modal fade upload-modal" id="renewSIMModal" tabindex="-1" role="dialog"
        aria-labelledby="renewSIMModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content basic-modal">
                <div class="modal-header">
                    ...
                    <div class="modal-body pb-0">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" class="form-control rounded-0 fw-bold"
                                    placeholder="Term (e.g. 12 months)" name="term" required>
                            </div>
                            <!-- Activation Date -->
                            <div class="col-12 mb-3">
                                <label for="date" class="label">Activation Date</label>
                                <input type="date" class="form-control rounded-0" placeholder="Activation Date"
                                    name="activation_date" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer pr-3">
