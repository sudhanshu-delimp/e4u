...
@section('content')
            ...
            <div class="col-md-12">
                <div class="email-content">
                    ...
                    <div class="section-one">
                        ...
                        <button onclick="previewTemplate()" type="button" data-toggle="modal"
                            data-target="#previewTemplate">Preview</button>
                    </div>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>2</td>
                                    <td rowspan="6" class="button-cell"
                                        style="vertical-align: center; text-align: center;">
                                        <button class="email-report" type="button" data-toggle="modal"
                                            data-target="#emailReport">See Email Report</button>
                                    </td>
                                </tr>
                                <tr>
    ...
    <div class="modal fade upload-modal bd-example-modal-lg" id="emailReport" tabindex="-1" role="dialog"
        aria-labelledby="emailReportLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="emailReport"> <img
                            src="{{ asset('assets/dashboard/img/email-details.png') }}" class="custompopicon"> Email
                        Report</h5>
                ...
                <div class="modal-body">
                    <table border="1" cellpadding="10" cellspacing="0" width="100%"
                        ...
                        <tr style="background-color: #0c223d; color: white;">
                            <td colspan="5" style="font-weight: bold; text-align: center;">Post Office Report: [date &
                                time]</td>
                        </tr>
                        ...
                        <!-- Footer Row -->
                        <tr>
                            <td colspan="4" style="background-color: #0c2340; color: white; font-weight: bold;">Sent:
                                156</td>
                            <td style="background-color: #ff3c5f; text-align: center;">
                                <a href="#" style="color: white; text-decoration: none; font-weight: bold;">Print
                                    Report</a>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td align="center" style="border:none !important">
                                ...
                                <table cellpadding="0" cellspacing="0"
                                    style="background-color:#ffffff; border:1px solid #dddddd; font-family:Arial, sans-serif; color:#0c223d;">
                                        ...
                                        <td style="background-color:#0c223d; padding: 20px;border:none !important">
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td
                                                        style="text-align: right; color: #ffffff; font-size: 16px; font-weight: bold; border:none !important">
                                                        Mobile SIM - Available<br>
                                                        <span style="font-size: 13px; color: #cccccc;">Member ID: [Member
                                                            ID]</span>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="padding: 30px;border:none !important">
                                            ...
                                            <!-- Greeting -->
                                            <p style="font-size: 16px; margin: 0 0 15px 0;"><b>Dear [salutation (> My
                                                    Account > Edit My Account > About Me > My Name)],</b></p>

                                            <!-- Main Message -->
                                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                                Are you aware of our Mobile SIM service? Simply order your SIM from E4U, and
                                                save yourself all the fuss of having to go to a Telco shop.
                                            </p>

                                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                                It is really easy, just logon and go to your Dashboard and click Concierge
                                                Services > Mobile and complete the order request. Your SIM will be sent
                                                directly to you.</p>
                                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 15px;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-style: italic; text-align:justify; ">
                                            <p style="font-size: 13px; margin-bottom: 5px;">This email and any attachments
                                            ...
                                            <p style="font-size: 13px;  margin-bottom: 5px;">Unless expressly stated by the
                                                parties, this email does not constitute a binding contract.</p>
                                            <p
                                                style="font-size: 13px; margin-bottom: 5px;">
                                                You rely on the information contained in this email at your own risk. We
                                                accept no liability, and you waive and release us from any liability and for
                                                any damage caused by this email or its attachments due to viruses,
                                                interference, interception, corruption or unauthorised access.</p>
                                            <p
                                                style="font-size: 13px; margin-bottom: 5px;">
                                                Personal information contained in emails sent to us is subject to our
                                                Privacy Policy, available on our website.</p>
