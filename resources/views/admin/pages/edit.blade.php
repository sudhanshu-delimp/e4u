            ...
            <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9 left-sidebar-bg">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h2 class="h4 mb-0 text-gray-800 font-weight-500">{{ ($page->id) ? "Edit Page - $page->page_title" : "New Page" }}</h2>
                        </div>
                        <h6>{{ ($page->id) ? "Edit Page" : "Creating New Page" }}</h6>
                        <div class="row">
                            <div class="col-md-12">
                                    @csrf
                                <div class="form-row new-page-input-text">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Body Subtitle" name="body_title" value="{{ old('body_title', $page->body_title) }}">
                        ...
                        <textarea id="editor1" name="content" style="width:100%">
