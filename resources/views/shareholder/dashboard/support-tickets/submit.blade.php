            ...
            <form class="mb-4 col-md-9" id="supportTicket" method="post" action="{{route('support-ticket.create')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="service_type" required>
                        ...
                        <option value="E4U Query">E4U Query</option>
                        <option value="Shareholder Documents">Shareholder Documents</option>
                ...
                <input type="hidden"  name="user_type"  value="shareholder">
