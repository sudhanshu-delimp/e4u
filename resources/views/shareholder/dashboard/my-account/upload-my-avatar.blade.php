    ...
    <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
        ...
        <div class="row">
            <div class="col-md-12 custom-heading-wrapper">
                <h1 class="h1">Upload my avatar</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 mt-4">
                                ...
                                <form id="my_avatar" action="{{ route('shareholder.save.avatar', auth()->user()->id) }}"
                                        ...
                                        <div class="file-upload-content">
                                            ...
                                            <div class="image-title-wrap">
                                                ...
                                                <button type="button" onclick="removeUpload()"
                                                    class="opr-btn-common">Remove <span class="image-title">Uploaded
                                                        Image</span></button>
                                                <button type="submit" class="opr-btn-common">Save <span
                            ...
                            <div class="col-lg-4 mt-4 current-avatar">
                                ...
                                @endif
                                <img src="{{ !auth()->user()->avatar_img ? asset('avatars/default/supplier_default.png') : asset('avatars/' . auth()->user()->avatar_img) }}"
                                    alt="" class="img-rounded avatarName">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white"> <img src="{{ asset('assets/dashboard/img/crop-image.png') }}"
                            style="width:32px; padding-right:10px;"> Crop Photo</h5>
    ...
    <script type="text/javascript">
        ...
        $('#confirmDelete').on('click', function(e) {
            ...
            try {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('shareholder.avatar.remove') }}",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    success: function(data) {
