                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded-0" name="shareholder"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded-0" name="contact"
                                                    id="contact" value="Wayne Primrose">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded-0" name="email"
                                                    id="email" value="wayne@waykar.com.au">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="idle_preference_time" checked>
                                                ...
                                                <div>
                                                    <i id="emailHelp">Set the Idle time before you are logged out of
                                                        your Console.</i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <i id="emailHelp">How your authentication code will be sent to
                                                        you.</i>
                                                </div>
                                            </div>
