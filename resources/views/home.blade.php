        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 home-right-half">
                    ...
                    <h2 class="home-head-icon">
                        <span>
                            <svg width="25px" height="25px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1"
                                class="icon_mc" xmlns="http://www.w3.org/2000/svg" fill="#ff3c5f" stroke="#ff3c5f">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <defs>
                ...
                <div class="buttons">
                    ...
                    <a class="hero-btn btn-light" id="view_btn_advertiser" href="{{route('public.web.escort.listing')}}"
