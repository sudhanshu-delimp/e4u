...
@section('content')
    ...
    <div class="modal fade upload-modal" id="conversation_modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> {{-- NOTE:: use  modal-dialog-scrollable instead of modal-dialog to make body scrollable only --}}
