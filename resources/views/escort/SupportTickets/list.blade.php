    ...
    <div class="col-md-12 mb-4">
        ...
        <div class="card-body">
            ...
            <ol>
                    ...
                    <li>Use the <a href="{{ route('escort.dashboard.agent-messages') }}" class="custom_links_design">Messaging</a> service for communication with other Users (if available).</li>
