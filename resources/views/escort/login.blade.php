      ...
      <div class="row">
         ...
         <div class="reg_box_form_style col-lg-5 col-md-5">
            <div class="regstractionform">
               <h4>Login now</h4>
               <form id="escort_login" action="{{ route('escort.login')}}" method="post">
                   @csrf
                  <div class="form-group">
                     <label for="mobileno">Mobile Number</label>
                     <input type="txt" required class="form-control" name="phone" id="mobileno" aria-describedby="emailHelp" placeholder="Please Enter Your Mobile Number" data-parsley-required-message="Your mobile number is required">
