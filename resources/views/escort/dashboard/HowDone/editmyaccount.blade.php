                        ...
                        <ol>
                            <div class="d-flex gap-20 justify-content-between">
                                <div class="text-justify">
                                    ...
                                    <li>Some features are already set as default which can be edited. It is important that
                                        you
                        ...
                        <div id="collapseNew" class="collapse" aria-labelledby="headingNew" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="doc-img">
                                            <img src="{{ asset('assets/dashboard/img/how-is-done/my-account-scr.png') }}" alt=""
                                ...
                                <h5><b>How is it done - About Me</b></h5>
                                <p>
                                ...
                                <p>
                                    All the fields are mandatory except for PayID. If you accept PayID from your clients,
                                    then you
                                    should complete the data for PayID. By completing this data, you can, through another
                                    location in the website, ‘Bank Account’, display your PayID data to the client. The
                                    PayID data
                                ...
                                <p>
                                    If, during the Registration process, you were assisted by one of our Support Agents,
                                    their
                                    details have loaded with their Agent ID. The Support Agent’s details will appear
                                    throughout
                                    the Console in different sections. If you did not Register with the assistance of a
                                    Support
                                    Agent and you would prefer to have a Support Agent,
                                    <a href="{{ url('escort-dashboard/escort-agency-request') }}"
                                        class="custom_links_design"> click here</a> and
                                ...
                                <p>
                                    ...
                                    purpose of those accounts is to promote the Website. Part of how we do that is by
                                    promoting
                                    Advertisers and their Profiles. For us to do that we require your consent. If you would
                                    like to
                        ...
                        <div id="collapseProfile" class="collapse " aria-labelledby="headingProfile"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="doc-img">
                                            <img src="{{ asset('assets/dashboard/img/how-is-done/profile-and-tour-scr.png') }}"
                                ...
                                <p>
                                    By default, many of these settings are enabled. You can change the settings or add to
                                    them.
                                    All of these settings relate to the Profile and Tour Creators.
                                </p>
                                <p class="sec-head">Profile Creator Settings</p>
                                <p>
                                    This feature creates your Profiles for you to List (which are then displayed on the
                                    Website).
                                    The Profile Creator settings are by default enabled. If you disable these settings, you
                                    will
                                    have to enter all the data fields in the Profile Creator. We recommend you leave this
                                    setting
                                    enabled. By doing so, when you initiate the Profile Creator, all of your data from My
                                    Information and Media is automatically included in the Profile Creator leaving you only
                                    a small
                                    amount of information to complete.
                                </p>
                                <p class="sec-head">How can Viewers Contact Me</p>
                                <p>
                                    These setting express on your Profile, how the Viewer can contact you and subject to
                                    your
                                ...
                                <p>
                                    ...
                                    creator multiple Listings in multiple Locations. All of the options are by default
                                    enabled to help
                                    you create a Tour with the minimum of fuss. An important option is ‘Post a Tour Leg one
                                    day
                                    before the Arrival Date’.
                                </p>
                                <p>
                                    A Tour is the collective of Profiles, more than one if you want, attached to each of the
                                    Locations. There is a start date and an end date for each Location. The Profiles
                                    attached
                                    to each Location are Listed on the Website at midnight of the arrival date. So if the
                                    arrival
                                    date is the 1st December, the Profile for that Location is Listed at midnight leading
                                    into the
                                    30th November, 24 hours before you arrive at the designated Location.

                                </p>
                                <p>
                                    If you have this option enabled, your Profile/s for each Location will be Listed one day
                                    before
                                    your arrival date.
                                </p>
                            </div>
