    ...
    <tbody>
        ...
        @if ($service == 'Product Purchase')
            <tr>
                ...
                <td style="border: 1px solid #ccc; padding: 8px; text-align:left;">
                    {{ formatCurrency($payment?->delivery_charge ?? 0) }} </td>
            </tr>
        @endif
        <tr>
