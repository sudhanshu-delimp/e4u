                                ...
                                <div id="listingModalContent">
                                    ...
                                    <table style="width:100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px;">
                                        <tbody>
                                            ...
                                            <td style="border: 1px solid #ccc; padding: 8px; text-align:left;">{{ $payment?->user->member_id ?? '---' }}</td>
                                            </tr>
                                            <tr>
                                            <td style="text-align:left; border: 1px solid #ccc; padding: 8px;"><strong>Completed
                                                By</strong></td>
                                            <td style="border: 1px solid #ccc; padding: 8px; text-align:left;">{{ $payment?->completedByUser->member_id ?? '---' }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <td style="text-align:left; border: 1px solid #ccc; padding: 8px;"><strong>Transaction
                                                Value</strong></td>
                                            <td style="border: 1px solid #ccc; padding: 8px; text-align:left;">{{ formatCurrency($payment?->amount) ?? '---' }}</td>
                                            </tr>
                                            <tr>
