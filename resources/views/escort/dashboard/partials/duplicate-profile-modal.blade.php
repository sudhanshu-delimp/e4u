                            ...
                            <div class="col-md-12">
                                <div class="container p-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control form-control-sm removebox_shdow"
                                                name="profile_name" data-parsley-type="" data-parsley-type-message="" data-parsley-group="group_one" data-parsley-required-message="Enter profile name." data-parsley-remote="{{ route('escort.checkProfileName') }}" data-parsley-remote-message="This profile name already exists." data-parsley-trigger="blur"  data-parsley-errors-container="#profile_name-errors">
