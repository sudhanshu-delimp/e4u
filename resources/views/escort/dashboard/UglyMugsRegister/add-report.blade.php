...
<div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
   ...
   <div class="row">
    <div class="col-md-12 custom-heading-wrapper">
      ...
      <div class="col-md-12 collapse mv-4" id="notes">
            <div class="card">
                <div class="card-body">
            ...
            <div class="col-md-12 add-punterbox-report">
                <div class="common-card">
                    <form id="ugly_mug_registration" class="common-form" enctype="multipart/form-data" method="POST" action="route('escort.store-report')">
