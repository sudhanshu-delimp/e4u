               ...
               <div class="card-body pl-1 Dash-table">
                  <div class="table-responsive-xl">
                     <table class="table apoint-sec">
                        ...
                        <tbody>
                           <tr class="row-color">
                              <td class="border-0 pl-0 task-color bg-white"><i class="fas fa-circle text-primary taski mr-2"></i>Perth</td>
                              ...
                              <td class="theme-color text-center pr-0 bg-white">
                                 <div class="dropdown no-arrow">
                                    ...
                                    <div class="dot-dropdown dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" style="">
                                       ...
                                       <div class="dropdown-divider"></div>
                                       <a class="dropdown-item" href="#" data-toggle="modal" data-target="#new-ban-4">Completed</a>
                                    </div>
                                 </div>
                              </td>
                           </tr>
                           <tr class="row-color">
                              <td class="border-0 pl-0 task-color bg-white"><i class="fas fa-circle text-medium taski mr-2"></i>Adelaide</td>
                              <td class="border-0 task-color bg-white">10</td>
                              <td class="border-0 task-color bg-white">01-01-2022</td>
                              <td class="border-0 task-color bg-white">10-01-2022</td>
                              <td class="theme-color text-center bg-white">
                           ...
                           <tr class="row-color">
                              <td class="border-0 pl-0 task-color bg-white"><i class="fas fa-circle text-high taski mr-2"></i>Melbourne</td>
                              <td class="border-0 task-color bg-white">10</td>
                              <td class="border-0 task-color bg-white">01-01-2022</td>
                              <td class="border-0 task-color bg-white">10-01-2022</td>
                              <td class="theme-color text-center bg-white">
                           ...
                           <tr class="row-color">
                              <td class="border-0 pl-0 task-color bg-white"><i class="fas fa-circle text-info taski mr-2"></i>Sydney</td>
                              <td class="border-0 task-color bg-white">10</td>
                              <td class="border-0 task-color bg-white">01-01-2022</td>
                              <td class="border-0 task-color bg-white">10-01-2022</td>
                              <td class="theme-color text-center bg-white">
                                 <span class="badge badge-danger-lighten task-1 bg-danger w-75">Pending</span>
                              </td>
                              <td class="theme-color text-center pr-0 bg-white">
                                 <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         ...
         <div class="row agent-dash">
            <div class="col-lg-12">
               <div class="sec-one pb-4 rounded" style="background: #5D6D7E;">
                  ...
                  <div class="card mb-4">
                     <div class="card-header py-3 pl-3 d-flex flex-row align-items-center justify-content-between border-0">
                                 ...
                                 <tr>
                                    <td class="border-0 leftside-table">
                                       <div class="d-flex followers">
                                          <div>
                                             <div class="d-flex">
                                                <a href="#"><img src="{{ asset('assets/app/img/ellipse-1.png')}}" class="img-fluid rounded-circle" alt=" "></a>
                                                <a href="#"><img src="{{ asset('assets/app/img/ellipse-2.png')}}" class="img-fluid rounded-circle" alt=" "></a>
                                                <a href="#"><img src="{{ asset('assets/app/img/ellipse-3.png')}}" class="img-fluid rounded-circle" alt=" "></a>
                                                <a href="#"><img src="{{ asset('assets/app/img/ellipse-4.png')}}" class="img-fluid rounded-circle" alt=" "></a>
                                                <a href="#"> <img src="{{ asset('assets/app/img/ellipse-5.png')}}" class="img-fluid rounded-circle" alt=" "> </a>
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                    <td class="text-right border-0 pt-4"><a class="theme-text-color" href="#">See All</a></td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
