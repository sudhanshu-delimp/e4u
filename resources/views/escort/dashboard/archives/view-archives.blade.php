...
<div class="container-fluid">
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-12">
                <div class="v-main-heading h3" style="display: inline-block;">Archives </div>
            ...
            <div class="col-md-12 mb-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ol class="pl-4">
                            <li>Use this feature to view all of your Profiles, Media and Tours in the one location.</li>
                            <li>The Guidelines provide useful information about how to store your Profiles and Media, as well as how to have your Media verified.</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="card archive-sec">
                    <a href ="{{route('escort.home-state')}}">
            ...
            <div class="col-md-2">
                <div class="card archive-sec">
                    <a href="{{url('/escort-dashboard/archive-medias')}}">
                        <figure class="figure m-0">
            ...
            <div class="col-md-2">
                <div class="card archive-sec">
                    <a href="{{url('/escort-dashboard/archive-tours')}}">
                        <figure class="figure m-0">
                            <img src="{{ asset('assets/dashboard/img/Vector-blank.png') }}" class="figure-img img-fluid rounded" alt=" ">
                            <figcaption class="figure-caption">
                                <p>Tours</p>
                ...
                <div id="additional_information" class="collapse" data-parent="#accordion">
                    <div class="card-body pl-0 arch-acrd">
                        ...
                        <ul class="mb-0">
                            ...
                            <li>Your Tour by going to the ‘Current Listings’ folder </li>
                            <li> The relevant Media folder to upload or remove photos and video, or to verified your photos</li>
                        </ul>
                        ...
                        <ul class="mb-0">
                            ...
                            <li>Move your folders around into a convenient order. Your Home State folder will always
                                remain at the front of the folders
                            </li>
                        ...
                        <h5 class="pt-2">How to verify your Media (Photos and Videos)</h5>
                        ...
                        <ul>
                            ...
                            <li>Any fake photo uploaded for verification will disqualify the remaining photos for
                                verification. We will notify you and request you replace the fake photo.
                            </li>
                            <li>A Viewer can undertake a reverse image search and may report your Profile to us as a
                                Profile with fake Media. Your Profile may be suspended where this occurs.
                            </li>
                        </ul>
                    </div>
                </div>
