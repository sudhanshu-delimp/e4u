...
"><i class="fas fa-long-arrow-alt-left"></i>&nbsp;&nbsp;Back To</a></li>
                        ...
                        <div class="col-md-12 mb-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ol class="pl-4">
                                        <li>Any Profile you create is stored in the folder for the Location the Profile was created for. When you create a Profile for a new Location, the system will create the Location folder for you.</li>
                                        <li>You can Edit or Delete any inactive Profile by selecting Action.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-md-10">
        {{-- <div class="col-md-2">
            ...
            <a href="{{route('escort.state.profiles')}}">
                <figure class="figure m-0">
                    <img src="{{asset('assets/dashboard/img/Vector.png')}}" class="figure-img img-fluid rounded" alt=" ">
                    <figcaption class="figure-caption"><p>{{ auth()->user()->state->name }}</p></figcaption>
                </figure>
            </a>
            </div>
        </div> --}}
        <div class="row" style="row-gap: 15px;">
           <div class="col-md-2">
                    <div class="card archive-sec">
                        <a href="{{route('escort.state.profiles.list', $user->state_id)}}">
                            <figure class="figure m-0">
                                <img src="{{ asset('assets/dashboard/img/Vector.png') }}" class="figure-img img-fluid rounded" alt=" ">
                                <figcaption class="figure-caption"><p>{{ $user->state->name }}</p></figcaption>
                            </figure>
                        </a>
                    </div>
                </div>
            @foreach($escorts as $state)
                <div class="col-md-2">
                    <div class="card archive-sec">
                        <a href="{{route('escort.state.profiles.list', $state->state_id)}}">
                            <figure class="figure m-0">
                                <img src="{{ asset('assets/dashboard/img/Vector.png') }}" class="figure-img img-fluid rounded" alt=" ">
                                <figcaption class="figure-caption"><p>{{ $state->state->name }}</p></figcaption>
                            </figure>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-2">
                <div class="card archive-sec">
                    <a href="{{route('escort.state.profiles.list',$key)}}">
                        <figure class="figure m-0">
                            <img src="{{ asset('assets/dashboard/img/Vector.png') }}" class="figure-img img-fluid rounded" alt=" ">
                            <figcaption class="figure-caption"><p>{{ $state['stateName'] }}</p></figcaption>
                        </figure>
                    </a>
                </div>
            </div>
