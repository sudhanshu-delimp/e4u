...
<div class="container-fluid">
    <div class="col-md-10">
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bread-sec pl-0">
                        <li class="breadcrumb-item"><a href="{{ url('escort-dashboard/home-state') }}" style="
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive pl-2 pt-3 list-sec" id="myTable111">
...
<script>
    ...
    var table = $('#myDataTable').DataTable({
        ...
        ajax: {
            url: "{{ route('escort.stateId.profile.list.dataTable') }}",
            data: function (d) {
                d.type = 'player';
            }
        },
        columns: [
            ...
            { data: 'key', name: 'key', searchable: false, orderable:false ,defaultContent: 'NA'},
            { data: 'profile_name', name: 'profile_name', searchable: true, orderable:false, defaultContent: 'NA'},
            { data: 'created_by_date', name: 'created_by_date', searchable: true, orderable:false, defaultContent: 'NA'},
            { data: 'membership', name: 'membership', searchable: true, orderable:false, defaultContent: 'NA' },
            { data: 'enabled', name: 'enabled', searchable: true, orderable:false,defaultContent: 'NA' },
    ...
    $(document).on('click','.delete-center22', function(e){
        e.preventDefault();
        var $this = $(this);
