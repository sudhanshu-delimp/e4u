      ...
      <div class='card-body border-0 p-0 mt-4'>
            ...
            <div class='form-group mb-2'>
               <div class='col-12 pl-4'>
                  <div class='service_rate_dolor_symbol form-group'>
                     <input type="text" name="start_date[]" class="akhReset date-picker" id="startDate_1" required data-parsley-required-message=" Please select Start Date" data-min="{{ date('Y-m-d')}}" >
         ...
         <div class='form-inline' style=''>
            ...
            <div class='form-group mb-2'>
               <div class='col-12 pl-4'>
                  <div class='service_rate_dolor_symbol form-group'>
                     <input type="text" name="end_date[]" class="akhReset date-picker" id="endDate_1" required  data-parsley-required-message=" Please select End Date">
