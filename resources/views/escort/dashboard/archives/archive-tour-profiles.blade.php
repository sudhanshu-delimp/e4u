        ...
        <div class="row">
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb p-0 bg-transparent rounderd-0">
                    <li class="breadcrumb-item"><img src="{{ asset('assets/dashboard/img/left-arrow.png') }}" class="img-fluid"> Back To</li>
            ...
            <div class="col-md-12">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Home State </h1>
            ...
            <div class="col-md-10 mt-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-body table table-bordered table-hover table-responsive">
                            <table class="table table-hover" id="myTable">
                                <thead class="table-bg">
                                    <tr>
                                        <th><input type="checkbox" name="che" name=""></th>
                                        <th>Profile Name 
                                            <svg width="17" height="16" viewBox="0 0 17 16"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M13.6139 15.125L10.4473 11.9583H12.8223V4.04167H10.4473L13.6139 0.875L16.7806 4.04167H14.4056V11.9583H16.7806L13.6139 15.125ZM0.947266 13.5417V11.9583H8.86393V13.5417H0.947266ZM0.947266 8.79167V7.20833H6.48893V8.79167H0.947266ZM0.947266 4.04167V2.45833H4.11393V4.04167H0.947266Z"
                                                    fill="white" />
                                            </svg>
                                        </th>
                                        <th>Date Created
                                       ...
                                       <!-- <th>Competitor</th>-->
                                        <th>Joining DateStatus<svg width="17" height="16" viewBox="0 0 17 16" fill="none"
