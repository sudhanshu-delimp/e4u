...
<div class="container-fluid">
  ...
  <ol class="breadcrumb bread-sec pl-0 pb-0 mb-2">
    <li class="breadcrumb-item"><a href="{{ url()->previous() }}" style="
"><i class="fas fa-long-arrow-alt-left"></i>&nbsp;&nbsp;Back To</a></li>
    <li class="breadcrumb-item active" aria-current="page">Profiles & Archives - Profiles</li>
  </ol>
</nav>


                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ config('escorts.profile.states')[$stateId]['stateName']}}</h1>
                    {{-- <h1 class="h3 mb-0 text-gray-800">{{$cityName}} </h1> --}}
                    {{-- <h1 class="h3 mb-0 text-gray-800">{{$cityName}} </h1> --}}
        ...
        {{-- <div class="row">
            <div class="col-md-3 p-0" style="
                ">
                <nav class="date-border navbar navbar-expand navbar-light" style="
                    ">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="navbarDropdown" style="width: 100%;">
                                <a class="dropdown-item border-0" href="#">Action</a>
                                <a class="dropdown-item border-bottom-0" href="#">Another action</a>
                            </div>
                        </li>
                    </ul>
                </nav>
                ...
                <nav class="date-border navbar navbar-expand navbar-light">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="navbarDropdown" style="width: 100%;">
                                <a class="dropdown-item border-0" href="#">Done</a>
                                <a class="dropdown-item border-bottom-0" href="#">Remain</a>
                            </div>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive pl-2 pt-3 list-sec" id="sailorTableArea">
                    <table id="myStateTable" class="table table-striped" width="100%">
                        <thead>
                            <tr>
                                <th>
                                    <div class="ckbox">
                                        ID  {{-- <input type="checkbox" id="checkbox1"> --}}
                                    </div>
                                </th>
                                <th>
                                    Profile Name
                        ...
                        <tbody>
                            ...
                            <tr class="tr-sec">
                                ...
                                <td><img src="{{asset('/avatars/imageuser.png')}}" class="img-profile rounded-circle">&nbsp;&nbsp;{{$escort->name}}</td>
                                <td>   {{$escort->phone}}/td>
                                <td>Platinum</td>
                                <td style="color: #4BDE97;">Active</td>
                                <td>Published</td>
                                <td>...</td>
                            </tr>
                            @endforeach --}}
...
<script>
    ...
    var url ="{{ route('escort.state.profile.list.dataTable',':stateId') }}";
    var sid = $('#stateId').val();
    url = url.replace(':stateId',sid);
    var table = $('#myStateTable').DataTable({
        "language": {
        ...
        columns: [
            ...
            { data: 'profile_name', name: 'profile_name', searchable: true, orderable:false, defaultContent: 'NA'},
            { data: 'created_by_date', name: 'created_by_date', searchable: false, orderable:false, defaultContent: 'NA'},
            { data: 'membership', name: 'membership', searchable: false, orderable:false, defaultContent: 'NA' },
