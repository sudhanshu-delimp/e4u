               ...
               <form id="defaultImage" method="post" enctype="multipart/form-data" action="{{ route('escort.default.images')}}">
                  ...
                  <div class="row pt-3">
                     ...
                     <div class="about_me_drop_down_info pt-2">
                        ...
                        <img class="img-fluid pl-2 pr-2" id="img9" src="{{ asset($path->findByposition(auth()->user()->id,9)['path'])}}" >
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                     <ul class="pagination ml-2 pl-1">
                        ...
                        <li class="page-item ">
                           ...
                           <a class="page-link" data-slide-to="-1" href="#">‹‹</a>
                        </li>
                        ...
                        @for($i = 0; $i <= ceil(count($media_withoutPosition)/10); $i++ )
                     ...
                     <div class="container pt-2" style="padding-left: 0.35rem;padding-right: 0.35rem;">
                        <div class="carousel-inner">
                           <div class="carousel-item" id="cItem_0">
                              <div class="grid-container">
                                 
                                 @foreach($media_withPosition  as $key => $img)
                                 <div class="item4">
                                    <img class="img-thumbnail {{ $img->position == 9 ? 'defult-image-3' : 'defult-image' }}" src="{{  asset($img->path) }}" alt=" ">
                                 </div>
                                 @endforeach
                              </div>
                           </div>
                           
                           @foreach($media_withoutPosition->chunk(10)  as $keyId => $images)
                           <div class="carousel-item" id="cItem_{{$loop->index + 1}}">
                              <div class="grid-container">
                                 @foreach($images as $image)
                                 
                                 <div class="item4">
                                    <img class="img-thumbnail defult-image" src="{{  asset($image->path) }}" alt=" ">
                                 </div>
                                 @endforeach
                              </div>
                           </div>
                           ...
                           {{-- <div class="carousel-item">
                              <div class="grid-container">
                                 <div class="item4"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item5"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item6"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item7"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item8"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item9"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item10"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                           ...
                           <div class="carousel-item">
                              <div class="grid-container">
                                 ...
                                 <div class="item9"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item10"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item11"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item12"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                                 <div class="item13"><img class="img-thumbnail defult-image" src="{{ asset('assets/app/img/Rectangle-1.png') }}" alt=" "></div>
                              </div>
                           </div>
                           </div>
                           @endforeach
...
<script type="text/javascript">
   ...
   $('body').on('click','.deleteimg', function () {
      ...
      $("body").on('click','.page-link', function(e){
         ...
         if(id == "-1"){
            var nid = parseInt(arr[1]) - parseInt(1);
            $('#cItem_'+nid).addClass(' active');
            $('#pageItem_'+nid).addClass(' active');
          
            $('#carouselExampleIndicators').carousel('prev'); 
            
            $('#cItem_'+arr[1]).removeClass(' active');
            
            $('#pageItem_'+arr[1]).removeClass(' active');
            ...
            var inn = parseInt(id) + parseInt(b);
            var dig = parseInt(id) - parseInt(b);
            var classId =  $("#pageItem_"+id).data('id');
            var cId =  $("#cItem_"+id).data('id');
            $('#cItem_'+inn).removeClass(' active');
            $('#cItem_'+dig).removeClass(' active');
            $('#pageItem_'+inn).removeClass(' active');
            $('#pageItem_'+dig).removeClass(' active');
            if(id == classId) {
               $('#cItem_'+id).addClass(' active');
