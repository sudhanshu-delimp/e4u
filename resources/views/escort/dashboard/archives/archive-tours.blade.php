...
<div class="container-fluid">
         ...
         <div class="col-md-12">
            <nav aria-label="breadcrumb">
             ...
             <div class="col-md-12">
                 <div class="row">
                     <div class="col-md-12">
                         <div class="v-main-heading h3" style="display: inline-block; padding-top: 0;">Tours </div>
                     ...
                     <div class="col-md-12 mb-5">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <ol class="pl-4">
                                     <li>Use this feature to view all of your historical Tours sorted according to the year they were created.</li>
                                     <li>You can Activate a completed Tour from the Action feature. By activating a Tour, the Tour will request you update the dates and membership type and then post the Tour according to the Tour instructions. The Tour will then be listed in Listings and Tours - Edit a Tour.</li>
                                 </ol>
                             </div>
                         </div>
                     </div>
   ...
   <div class="col-md-10">
      <div class="row">
         ...
         <div class="col-md-2">
            <div class="card archive-sec">
               {{-- <a href ="{{url('/escort-dashboard/archive-tour-view-profiles')}}"> --}}
               <a href ="#">
                  <figure class="figure m-0">
                     <img src="{{ asset('assets/dashboard/img/Vector.png') }}" class="figure-img img-fluid rounded" alt=" ">
                     <figcaption class="figure-caption">
