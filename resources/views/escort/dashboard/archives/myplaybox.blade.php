    ...
    <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
        ...
        <div class="row">
            ...
            <div class="col-md-10 fill_profile_headings_global text-justify">
                ...
                <p>
                    My Playbox is an exciting new service designed for Escorts and Viewers to interact and to get to know
                    each other better.
                    It is a social platform within the E4U Website that revolutionises how Escorts and Viewers connect.
                    All Escorts who are registered with us can use the service. It allows them to monetize their content
                    while developing a genuine connection with the Viewer.
                </p>

                <h2>How does it work?</h2>
                <p>
                    If an Escort has uploaded content to their Playbox, the My Playbox icon will appear on any Profile they
                    publish.
                ...
                <img src="{{ asset('assets/dashboard/img/boxicon/icon_myplaybox.png') }}" alt="Playbox Icon"
                    class="playbox-icon">
