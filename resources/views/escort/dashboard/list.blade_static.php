                        ...
                        @if ($type != 'past')
                            <div>
                                <div class="add--list listingActionButtons">
                                    <div class="">
                                        <button class="btn brb-btn" data-toggle="modal" data-target="#add_brb"
                                            id="btn_add_brb">Add BRB</button>
                                        ...
                                        <button style="padding: 10px;" class="btn btn-custom-success" data-toggle="modal"
                                            data-target="#extend_profile" id="btn_extend_profile"> Extend Profile </button>
                                        <button style="padding: 10px;" class="btn btn-bump-up" data-toggle="modal"
                                            data-target="#bumpup_profile" id="btn_bumpup_profile"> Bump Up </button>
                                    ...
                                    <div class="pinup-tooltip-wrapper">
                                        <button style="padding: 10px;" class="btn btn-warning" data-toggle="modal"
                                            ...
                                            Up</button>
                                        @if ($activePinup)
                                            <p class="pinup-tooltip">You already have an active Pin Up. You can book after it
                                                expires. </span>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table w-100" id="sailorTable">
                                <thead id="table-sec" class="table-bg">
                                    <tr>
                                        <th>ID</th>
                                        <th class="w-auto" colspan="4">Profile Name</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td colspan="4">
                                            <div class="profile_list"><i class="fa fa-user" aria-hidden="true"></i> <span class="profile_label">Profile Name</span> John Doe 
                                            ...
                                            <div>
                                                <span class="badge badge-primary" style="background-color: #ff4768;">BRB</span>
                                                <span class="badge badge-primary">Suspended</span>                                                
                                                <span class="badge badge-success">Extended</span>
                                                <span class="badge badge-danger">Playmates</span>
                                                <span class="badge badge-warning">Pin Up</span>
                                                <span class="badge badge-info">Bump Up</span>                                               
                                                <span class="badge badge-dark">Tour</span>
                                            </div>
                                            
                                        </td>
                                        
                                        <td>
                                            <div class="profile_list"><i class="fa fa-user" aria-hidden="true"></i> <span class="profile_label">Stage Name</span> Johnny </div>
                                            <div class="profile_list"><i class="fa fa-phone" aria-hidden="true"></i> <span class="profile_label">Mobile</span> 123-456-7890</div>
                                        </td>
                                        <td>Platinum</td>
                                        <td>2022-01-01</td>
                                        <td>Active</td>
                ...
                <div class="modal-content" style="width: 800px;position: absolute;top: 30px;">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <img src="/assets/app/img/profile-30.png" class="custompopicon" alt="extend"
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="">
                                <img src="/assets/app/img/deactivate.png" class="custompopicon" alt="cross"
                                    style="margin-right: 10px;"> Suspend Profile
                            </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
