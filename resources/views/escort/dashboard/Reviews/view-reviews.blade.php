                ...
                <div class="stats-card">
                    <div class="stats-details">
                        ...
                        <div class="stat-text">                                    
                            ...
                            <div class="stats-value">{{ $reports['today'] }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card">
                    <div class="stats-details">
                        ...
                        <div class="stat-text">                                
                            ...
                            <div class="stats-value">{{ $reports['month'] }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card">
                    <div class="stats-details">
                        ...
                        <div class="stat-text">                                
                            ...
                            <div class="stats-value">{{ $reports['year'] }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card">
                    <div class="stats-details">
                        ...
                        <div class="stat-text">                                
                            ...
                            <div class="stats-value">{{ $reports['all_time'] }}</div>
                        </div>
                    </div>
                </div>
            </div>            
