    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <div class="container-fluid">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9">
                        ...
                        <div class="container-fluid" style="padding: 0px 0px;">
                            ...
                            <div class="d-sm-flex align-items-center mb-4">
                                ...
                                <h1 class="h3 mb-0 text-gray-800">Media - Masseurs01</h1>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3 col-lg-3 full-width-for-ipad">
                        <div class="masseurs01-box">
                            <div class="col manage_upload_btn masseurs01-img-height">
                                <div class="banner_reco_font preview">
                                    ...
                                    <p>Add Photo</p>
                                    <img id="banner-image-preview" src="" class="attach-img">
                                </div>
                            </div>
                            <div>
                                <a href="#" class="super-btn-bg btn-primary btn-icon-split btn-lg" style="margin-right: 10px;margin-left:0px">
                                ...
                                <a href="#" class="super-btn-bg btn-primary btn-icon-split btn-lg" style="margin-right: 10px;margin-left:0px">
                                    <span class="text">Verify Media</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8 full-width-for-ipad">
                            
                            <ul class="nav nav-pills mb-3 justify-content-center archive-tab" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false"> Unverified</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="{{ asset('/assets/dashboard/img/news-1.jpg') }}" class="img-fluid padding2">
                                        </div>
                                        <div class="col-md-4">
                                            <img src="{{ asset('/assets/dashboard/img/news-1.jpg') }}" class="img-fluid padding2">
                                        </div>
