    ...
    <script>
        ...
        $(document).on('change','.js_profile_service_tags', function(){
            ...
            if(selectedValue){
                ...
                let string = `<li id='hideenclass${index}_${selectedValue}'><div class="my_service_anal"><span class='dollar-sign'>${selectedText}</span>`;
                string += `<input type='number' class='dollar-before input_border ${changeClass}' name='price[]' value='0' placeholder='0' min='0' oninput='this.value = Math.abs(this.value)' step='10' max=200 service_id="${selectedValue}"><input type='hidden' name='service_id[]' value="${selectedValue}" placeholder=''><span><i class='fas fa-times-circle akh1' data-sname='${selectedText}' data-val="${selectedValue}"  id='id_${selectedValue}' value="${selectedValue}" >`;
        ...
        // $('#service_id_one55').on('change', function() {
        ...
        //         appendTag += `<input type='number' class='dollar-before input_border ${changeClass}' name='price[]' value='0' placeholder='0' min='0' oninput='this.value = Math.abs(this.value)' step='10' max=200 service_id="${selectedIdOne}"><input type='hidden' name='service_id[]' value="${selectedIdOne}" placeholder=''><span><i class='fas fa-times-circle akh1' data-sname='${getNameOne}' data-val="${selectedIdOne}"  id='id_${selectedIdOne}' value="${selectedIdOne}" >`;
        //         appendTag += `</i></span></div></li>`;
        //         $("#selected_service_one").append(` ${appendTag} `);
        //         if (changeClass === 'change_default2') {
        //             $("#hideenclassOne_" + selectedIdOne + " .change_default2").trigger('change');
        //         }
        ...
        //         if (changeClass === 'change_default2') {
        //             $("#hideenclassThree_" + selectedIdThree + " .change_default2").trigger('change');
        //         }
