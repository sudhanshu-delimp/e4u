                ...
                <div class="col-lg-6">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-7 col-lg-7 col-md-7 col-10">
                            <input type="text" class="form-control form-control-sm removebox_shdow" placeholder="Facebook" name="social_links[facebook]" data-parsley-type="url" data-parsley-type-message="Please provide a valid url" value="{{ $user->social_links ? $user->social_links['facebook'] : null }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-7 col-lg-7 col-md-7 col-10">
                            <input type="text" class="form-control form-control-sm removebox_shdow" placeholder="Instagram" name="social_links[insta]" data-parsley-type="url" data-parsley-type-message="Please provide a valid url" value="{{ $user->social_links ? $user->social_links['insta'] : null }}">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="custom-x-link"> <img src="{{asset('assets/app/img/twitter-x.png')}}" class="twitter-x-logo" alt="logo"> </div>
                        </span></label>
                        <div class="col-sm-7 col-lg-7 col-md-7 col-10">
