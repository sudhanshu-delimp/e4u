...
<div>
    <span>
        ...
        <sup class="tour_icon listing-tag-tooltip ml-1">Tour
        ...
        <sup class="pinup_icon listing-tag-tooltip ml-1">Pin Up
        ...
        <sup class="upgrade_icon listing-tag-tooltip ml-1">Upgraded
        ...
        @if($isExtended->count)
        <sup class="extend_icon listing-tag-tooltip ml-1">Extended
        ...
        @if($item->is_bumpup)
        <sup class="bumpup_icon listing-tag-tooltip ml-1">Bumped Up
        ...
        <sup class="suspend_icon listing-tag-tooltip ml-1">Suspended
        ...
        @if($itemArray['brb'])
        <sup class='brb_icon listing-tag-tooltip ml-1'>BRB <small class='listing-tag-tooltip-desc'>Brb {{date('d-m-Y h:i A', strtotime($itemArray['brb'][0]['selected_time']))}}</small></sup>
        @endif
    </span>
