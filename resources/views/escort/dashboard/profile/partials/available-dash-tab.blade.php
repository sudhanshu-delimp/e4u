<div class="tab-pane fade pt-2" id="available" role="tabpanel" aria-labelledby="contact-tab">
    <div class="about_me_drop_down_info profile-sec">
        ...
        <div class="padding_20_all_side my-availability-mon container custom-availabletab">
            ...
            @foreach ($days as $day => $cDay)
                <div class="">
                    <div class="row parent-row col-sm-12 mb-4 mb-xl-2 custom-parent-row-all-tab">
                        <div class="col-xl-1 col-lg-12 custom-day-tab">
                            <label class="col-0" for="exampleFormControlSelect1">{{ $cDay }}:
                            </label>
                            <input type="hidden" value="{{ $day }}">
                        </div>
                        <div class="row col-xl-4 col-lg-5 col-md-12 ml-xl-4 custom-time-tab">
                        ...
                        <div class="row col-xl-6 col-lg-5 custom-radiotab">
                        ...
                        <div class="col-lg-1 custom-rest-tab">
