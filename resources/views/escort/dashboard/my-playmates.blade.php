...
@section('content')
                ...
                <div class="card collapse" id="notes" style="">
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li>To display your Playmates avatar in any Profile, select 'Add Playmates' from Action. You can
                                add multiple Playmates. Only your Playmates in the Location the Profile is listed at the
                                time can be added to the Profile. If your Playmate leaves the Location while your Profile is
                                active, or they suspend their Profile, they will be automatically removed from the Profile
                                for the suspended period, and permanently if they have left the Location. If your Playmate
                                returns to your Location, they will automatically be added back into the Listed Profile.
                            </li>
                ...
                <div class="modal-content" style="width: 800px;position: absolute;top: 30px;">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <img src="{{ asset('assets/app/img/playmate-30.png') }}" class="custompopicon" alt="extend"
    ...
    <div class="modal fade upload-modal" id="playmates_operations" tabindex="-1" role="dialog"
        aria-labelledby="extendProfileTitle" aria-hidden="true" data-keyboard="false" data-backdrop="static"
        aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileSearch"
                                    placeholder="Search Member ID to locate your Playmate (eg E10111)...">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            Swal.fire('Network Error', 'Check your internet connection',
                                'error');
                        }
                    }
                });
