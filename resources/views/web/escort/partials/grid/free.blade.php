...
<a class="ec_card_link"
        href="{{ getEscortMassageDetailUrl($escort) }}">
            ...
            <div class="ec_profile_img">
                <img class="card-img-top"
                    src="{{ $escort->first_image ? asset('assets/app/img/service-provider/Frame-408.png') : asset('assets/app/img/service-provider/Frame-408.png') }}"
                    alt="Card image cap">
            </div>
            <div class="ec_card_content">
                ...
                <div class="items custom-available-time-icon">
                    ...
                    <span class="decs image_height_width_for_col_six position-relative">
    ...
    @if (Request::path() == 'showList')
        <button type="button" class="short-list btn btn-primary removeshortlist" id="escort_{{ $escort->id }}"
            data-name="{{ $escortName }}" data-escortId="{{ $escort->id }}">Remove from Shortlist</button>
    @else
