                        ...
                        <div class="tab-content" id="profileTabsContent-{{ $listing->id }}">
                                        ...
                                        <div class="social_media_wrapper">
                                            ...
                                            <div class="d-flex justify-content-between gap-10">
                                                ...
                                                @if (isset($social_links['twitter']) && $social_links['twitter'] != '')
                                                    <div class="s_icon">
                                                        <a href="{{ $social_links['twitter'] }}" target="_blank"><img
                                            ...
                                            <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#ff3c5f" stroke-width="2" stroke-linejoin="round">
                                                    </path>
                            ...
                            <div class="tab-pane fade" id="services-{{ $listing->id }}" role="tabpanel"
                                ...
                                <div class="mc_list_meta">
                                        ...
                                        <span class="details">
                                            ...
                                            <span>
                                                @foreach ($listing->massage_services()->where('category_id', 1)->get() as $value)
                                                    @php
                                                        $massage_services .=
                                                            config('escorts.profile.massage-services')[
                                                                $value->service_id
                                                            ] . ', ';
                                                    @endphp
                                                @endforeach
                                    ...
                                    <div class="services_card">
                                        <spna class="icon">
                                            <svg fill="#ff3c5f" version="1.1" id="Layer_1"
                                                ...
                                                height="64px" viewBox="0 0 24 24" enable-background="new 0 0 24 24"
                                                xml:space="preserve">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                        ...
                                        <span class="details">
                                            ...
                                            <span>
                                                @foreach ($listing->massage_services()->where('category_id', 2)->get() as $value)
                                                    @php
                                                        $other_services .=
                                                            config('escorts.profile.other-services')[
                                                                $value->service_id
                                                            ] . ', ';
                                                    @endphp
                                                @endforeach
