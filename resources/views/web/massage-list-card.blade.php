            ...
            <div class="mc_card_container">
                <div class="mc_card">
                    ...
                    <div class="mc_card_header">
                        ...
                        <span class="mc_title">Massage Centres</span>
                     ...
                     <a href="{{ route('web.massage-description') }}" class="mc_card_link">
                        <div class="mc_profile_img">
                            <img src="{{ asset('assets/app/img/massage/mc1.jpg') }}" alt="Massage Centre 1" class="mc_card_image">
                        </div>
                ...
                <div class="mc_card">
                    ...
                    <div class="mc_card_header">
                     ...
                     <a href="{{ route('web.massage-description') }}" class="mc_card_link">
                        <div class="mc_profile_img">
                            <img src="{{ asset('assets/app/img/massage/mc2.jpg') }}" alt="Massage Centre 1" class="mc_card_image">
                        </div>
                ...
                <div class="mc_card">
                    ...
                    <div class="mc_card_header">
                     ...
                     <a href="{{ route('web.massage-description') }}" class="mc_card_link">
                        <div class="mc_profile_img">
                            <img src="{{ asset('assets/app/img/massage/mc3.jpg') }}" alt="Massage Centre 1" class="mc_card_image">
                        </div>
                ...
                <div class="mc_card">
                    ...
                    <div class="mc_card_header">
                     ...
                     <a href="{{ route('web.massage-description') }}" class="mc_card_link">
                        <div class="mc_profile_img">
                            <img src="{{ asset('assets/app/img/massage/mc4.jpg') }}" alt="Massage Centre 1" class="mc_card_image">
                        </div>
                ...
                <div class="mc_card">
                    ...
                    <div class="mc_card_header">
                     ...
                     <a href="{{ route('web.massage-description') }}" class="mc_card_link">
                        <div class="mc_profile_img">
                            <img src="{{ asset('assets/app/img/massage/mc5.jpg') }}" alt="Massage Centre 1" class="mc_card_image">
                        </div>
        ...
        <div class="mc_list_card">
            ...
            <div class="mc_list_content_inner">
                ...
                <div class="mc_list_footer">
                    <a href="#" class="mc_btn_shortlist" data-target="#add_wishlist" data-toggle="modal">Add to Shortlist</a>
                </div>
