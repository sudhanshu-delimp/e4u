     ...
     <div class="accordion custom_accordian" id="accordionExample">
         <div class="card">
             <div class="card-header public_filter_accordian" id="headingOne">
                 <div class="pub_heading btn-search" data-toggle="collapse" data-target="#collapseSearch" aria-expanded="true" aria-controls="collapseSearch" bis_skin_checked="1">
                     <h2>
                                             ...
                                             <div class="col-lg-5 display_items mb-1">
                                                 ...
                                                 <div>
                                                     <a type="submit" href="javascript:void(0);"
                                                         class="btn reset_filter clear_short_list"
                             ...
                             <div class="row grid_list_part p-0 m-0">
                                 <div
                                     ...
                                     <div class="mc_type_btn">
                                         <div class="grid_list_icon_box display_inline_block grid--btn" id="view_grid">
