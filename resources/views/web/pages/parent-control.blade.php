...
<section class="padding_top_eight_px padding_bottom_eight_px footer-links-si text-justify">
   <div class="container">
      ...
      <p>
         Users must be fully capable, legally competent to agree to and fulfill the <a href="{{ route('page.terms-conditions')}}" style="color:#FF3C5F">Terms and Conditions</a>,
