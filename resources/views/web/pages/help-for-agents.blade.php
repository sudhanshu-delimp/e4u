                ...
                <div class="accodien_manage_padding_content">
                 ...
                 <div class="col-sm-12">
                     ...
                     <p>
                         ...
                         Advertiser to their Dashboard and ask them to log a Support Ticket, unless you undertake to log the Support Ticket for them.
                     </p>
                  ...
                  <div class="content">
                     <div class="accodien_manage_padding_content">
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                               <p class="pt-2"><b>Q: Do I have to enter into an Agreement to become an Agent?</b></p>
                                <p class="pbot">Yes. We require you to enter into an “Agent Agreement” which sets out all of our
                                    respective obligations. The agreement also contains:
                                </p>
                                <ul>
                                    <li> The services that you will provide to Advertisers</li>
                           ...
                           <div class="col-sm-12">
                            <p class="pt-2"><b>Q: What communication tools will be available to me? </b></p>
                             <p class="pbot">You will have an email account allocated you for all communications to Escorts4U,
                                Advertisers and prospective Members. Your email account will be styled:
                            </p>
                            <p><a href="#">agent.[teritory]@e4u.com.au</a></p>
                            <p>We will also provide you with business cards</p>
                        ...
                        <div class="col-sm-12">
                             <p class="pt-2"><b>Q: Will I have access to all my clients Accounts?</b></p>
                             <p class="pbot">Yes you absolutely will. You will have access to Profile Information, Profile and Tour
                                creator and the Archive Folder, as well as to the Concierge Services.
                                </p>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <p class="pt-2"><b>Q: Can I use my own marketing material? </b></p>
                             <p class="pbot">No. You must use the Escorts4U marketing material unless your material is approved
                                by us.</p>
                                
                        </div>

                        <div class="col-sm-12">
                            <p class="pt-2"><b>Q: Is there any training?</h6>
                             <p class="pbot">
                                Yes there is. Training is provided for free. Usually over three sessions totaling ten to
                                twelve hours.
                             </p>
               ...
               <div class="set">
                ...
                <div class="content" style="display: none;">
                   <div class="accodien_manage_padding_content">
                      ...
                      <div class="col-sm-12">
                          <p class="pt-2"><b>Q: Do I have to be a registered business to be an Agent?</h6>
                        <p class="pbot">
                            Yes. It is up to you as to which form of entity you wish to be, sole trader or an
                            incorporated company. You will need to be registered for GST as well.                           
                        </p>
                   ...
                   <div class="accodien_manage_padding_content">
                      ...
                      <div class="row">
                         <div class="col-sm-12">
                             ...
                             <p>
                                co-ordinate sales effort with Escorts4U where appropriate
                             </p>
                             <p>
                                Generally, you are expected to:
                             </p>
