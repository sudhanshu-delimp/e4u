            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="pin-up-content pl-5">
                        <h1 class="home_heading_first mb-0 pin-head-custom">Jane Doe <span>
                        ...
                        <div class="row v-path">
                            ...
                            <div class="col-md-8 align-self-center">
                                <ul
                                    ...
                                    <li>Meet with:</li>
                                    <li><a href="#"><img src="{{ asset('assets/app/img/woman-avatar-big.png') }}"
                                                class="" alt="logo">
                                            <span class="custom-icon-hover-tooltip">Female</span>
                                        </a></li>
                                    <li><a href="#"><img src="{{ asset('assets/app/img/male-user.png') }}"
                                                class="" alt="logo">
                                            <span class="custom-icon-hover-tooltip">Male</span>
                                        </a></li>
                                    <li><a href="#"><img src="{{ asset('assets/app/img/transgender-big.png') }}"
                                                class="" alt="logo">
                                            <span class="custom-icon-hover-tooltip">Transgender</span>
                                        </a></li>
                                    <li><a href="#"><img src="{{ asset('assets/app/img/couple.png') }}" class=""
                                                alt="logo">
                        ...
                        <p class="pin-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pulvinar sit
                            mauris arcu diam velit viverra. Amet, massa pellentesque condimentum egestas proin pellentesque.
                            In maecenas ultrices eu lacus. Aliquam nisl eu fames libero in rutrum vitae. Cras nisi, sit ac
                            consectetur facilisi ultricies. <a href="#">Read More</a></p>
                        <div class="row">
