...
value or used inconsistently with the <a href="{{ route('pages.terms-conditions')}}" class="termsandconditions_text_color">Terms & Conditions</a> pursuant to which the
