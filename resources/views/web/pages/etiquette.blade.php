                   ...
                   <div class="content">
                       <div class="accodien_manage_padding_content">
                           ...
                           <ul>
                               ...
                               <li>Make sure you know and understand the <a class="c-red"
                                                                            href="{{ url('faqs')}}">Local
                                       Laws</a> and do not get arrested
                               </li>
                   ...
                   <div class="content">
                       <div class="accodien_manage_padding_content">
                           ...
                           <p>If you have to cancel an appointment, do so as far in advance as possible, usually by text
                               ...
                               or
                               added to the <a class="c-red" href="{{ url('http://www.nationaluglymugs.com.au')}}" Target="_blank">NUM</a>.</p>
                   ...
                   <div class="content">
                       <div class="accodien_manage_padding_content">
                           ...
                           <p>But it is also important that where an Escort has lied about themselves, it is completely
                               ...
                               read. Remember, if you are a <a class="c-red" href="{{ url('register')}}">registered</a> Viewer, you can complete ‘Notes’ about the Escort or
                               Massage Centre from with your Dashboard. This may help you in the future to remind you
                   ...
                   <div class="content">
                       <div class="accodien_manage_padding_content">
                           <p>Make sure you are aware of the <a class="c-red" href="{{ url('faqs')}}">Local Laws</a> regarding escort services wherever you are.
                               ...
                               this
                               does not mean you can not get in trouble for kerb-crawling, for example, in some
                               places.</p>
                           <p>Keep an eye on your wallet, phone and other valuables. Thefts do happen, especially in
                               ...
                               It is
                               wise to not bring any valuables with you including your wallet. Carry your donation in
                               your
                               pocket.</p>
