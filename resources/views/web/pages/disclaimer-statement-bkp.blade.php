...
age of consent in the jurisdiction from which the Website is being accessed).</p>
      ...
      <p class="text_decoration_for_a">Subject to the <a href="{{ route('page.terms-conditions')}}" class="termsandconditions_text_color">Terms and Conditions</a>, by using the Services, you accept the following
conditions:</p>
...
Australia. These <a href="{{ route('page.terms-conditions')}}" class="termsandconditions_text_color">Terms and Conditions</a> are governed by the laws in force in the State
