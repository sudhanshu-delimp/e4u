...
<section class="padding_top_eight_px padding_bottom_eight_px">
   <div class="container text-justify">
        ...
        <p>
            Escorts4U have partnered with a leading provider of online travel booking services
            (<strong>Booking Service</strong>). The Booking Service is only available to registered Advertisers.
        </p>
        <h2 class="primery_color normal_heading">Access to the Booking Services </h2>
        <p>
            To access the Booking Services, Advertisers need to <a href="{{ route('advertiser.login') }}" class="e4ulinks" style="color:#FF3C5F;font-size: 16px;">logon</a> and at their Dashboard:
        </p>
        <ul>
            <li><p class="mb-0">Select Administration > Concierge from the menu and then click "Travel"</p></li>
