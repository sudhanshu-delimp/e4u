...
<section class="padding_top_eight_px padding_bottom_eight_px">
   <div class="container text-justify">
        <h1 class="home_heading_first margin_btm_twenty_px page-title">Mobile SIM Service</h1>

        <h2 class="primery_color normal_heading">Partnership</h2>
        <p>
        Escorts4U have partnered with a leading provider of mobile SIM services (<strong>Services</strong>). The
        Services are only available to registered Advertisers.
        </p>
        ...
        <ul>
        <li><p class="mb-0">Select Administration > Concierge from the menu and click "Mobile SIM"</p></li>
