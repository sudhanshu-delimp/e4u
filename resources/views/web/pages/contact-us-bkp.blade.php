     ...
     <h1 class="home_heading_first margin_btm_twenty_px">Contact Us</h1>      
      ...
      <h3>Some general information</h3>
                     ...
                     <ul>
                        ...
                        <li>An Advertiser with a question, first look at our help for <a class="c-red" href="{{ url('help-for-advertisers')}}">Advertisers</a>, or <a class="c-red" href="{{ url('faqs')}}">FAQs</a> and if you
                        don't find the answer, then contact us by logging a "Support Ticket" (the preferred
                        method of contact, but you need to <a class="c-red" href="{{ url('advertiser-login')}}">log on</a> ) otherwise contact us <a class="c-red" href="#" onClick = "openSolution();">here</a>.
                        </li>
                        ...
                        <p>For anything else, contact us <a class="c-red" href="#" onClick = "openSolution();">here</a>, or by any of the alternative means below. Whichever
             ...
             <div class="content">
                <div class="accodien_manage_padding_content">
                   <p>For the best method of communication, Users should log a "Support Ticket" with us. A
                     ...
                     <p>You will need to <a class="c-red" href="#">log on</a> as a User to log a Support Ticket. If you haven't registered as a
                        Viewer, and would like to log a Support Ticket, register <a class="c-red" href="#">here</a></p>
                </div>
             </div>
          </div>
       </div>
