...
<section class="padding_top_eight_px padding_bottom_eight_px footer-links-si">
   <div class="container">
      <h1 class="home_heading_first margin_btm_twenty_px page-title">Cookie Policy</h1>
            ...
            <p>
                Subject to the <a href="{{ route('page.terms-conditions')}}" style="color:#FF3C5F;font-size: 16px;">Terms and Conditions</a>, by using the Services, you accept the following conditions in relation to the use of cookies.
            </p>
            ...
            <p>
                ...
                revision will take effect upon its posting. It is your responsibility to check the <a href="{{ route('page.terms-conditions')}}" style="color:#FF3C5F">Terms and Conditions</a> and this Policy from time to time to
