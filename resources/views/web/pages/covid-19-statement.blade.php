...
<section class="padding_top_eight_px padding_bottom_eight_px footer-links-si">
        <div class="container">
           <h1 class="home_heading_first">Covid-19 Statement - Australian Users</h1>
           ...
           <p>Escorts4U uses its resources to the best of its ability to keep informed Users about their
               ...
               legislation, regulations and rules (in Australia) concerning the virus known as Covid-19
               (collectively <b>Covid-19 Regulations</b>). Escorts4U will not take any steps to inform Users
               about the Covid-19 rules and regulations outside Australia.</p>
            <p>
                It is not the responsibility of Escorts4U to ensure Users are compliant with the Covid-19
                Regulations.
            </p>

     <p class="">Subject to the <a href="{{ route('page.terms-conditions')}}" class="termsandconditions_text_color">Terms and Conditions</a>, by using the Services, Users accept the following
     ...
     <ul>
        ...
        <p>Escorts4U accepts no responsibility for the completeness or accuracy of any
         ...
         <p>To the extent permitted by law, all Users of the Website unconditionally and irrevocably release and discharge Escorts4U from any and all liability whether or
             not caused by any negligence for any loss or damage arising out of, and from the
             use of, or reliance on, the information contained on or accessed through any of the
             Websites.</p>
