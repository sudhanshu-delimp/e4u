...
<p class="text_decoration_for_a">Subject to the <a href="{{ route('page.terms-conditions')}}" class="termsandconditions_text_color">Terms and Conditions</a>, by using the Services, Users accept the following
