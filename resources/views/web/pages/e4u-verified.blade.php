...
@section('content')
    <section class="padding_top_eight_px padding_bottom_eight_px">
        <div class="container reg_info text-justify">
            ...
            <p>
                Escorts4U, on behalf of all the Users who may frequent the Website, takes its role as a provider of an
                advertising platform very seriously.
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <img src="{{ asset('assets/app/img/e4u_verified_v3.png') }}" alt="e4u verified" class="w-100">
                </div>
            </div>
