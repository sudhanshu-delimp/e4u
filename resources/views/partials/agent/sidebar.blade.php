...
<ul class="sticky-top navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
   ...
   <li class="nav-item active">
      <a class="nav-link" href="{{ route('agent.dashboard')}}" id="dashboard">
         ...
         <span id="dash" style="{{  $_SERVER['REQUEST_URI'] == '/agent-dashboard' ? 'color: #e5365a;' : ''}}">Dashboard </span>
      </a>
   </li>
   <!-- Divider -->
   <!-- Heading -->
   ...
   <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse @if(request()->segment(2) == 'update-account' || request()->segment(2) == 'change-password' || request()->segment(2) == 'upload-avatar' || request()->segment(2) == 'bank_account') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="py-2 collapse-inner rounded pb-0 mb-0 pt-0">
            ...
            <span style="{{ request()->segment(2) == 'update-account' || request()->segment(2) == 'profile' ? 'color: #e5365a;' : ''}}"> Edit my account</span>
            </a>
            ...
            <span style="{{ request()->segment(2) == 'change-password' || request()->segment(2) == 'profile' ? 'color: #e5365a;' : ''}}">Change password</span>
            </a>
            ...
            <span style="{{ request()->segment(2) == 'upload-avatar' || request()->segment(2) == 'profile' ? 'color: #e5365a;' : ''}}">Upload my avatar</span>
            </a>
            <a class="collapse-item" href="{{ route('bank_account')}}">
            <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{asset('assets/app/img/sales-performance.png') }}">
            <span style="{{ request()->segment(2) == 'bank_account' || request()->segment(2) == 'profile' ? 'color: #e5365a;' : ''}}">Bank Account</span>
            </a>
         </div>
      </div>
   </li>
      ...
      <div id="Escorts" class="collapse @if(request()->segment(3) == 'new-requests' || request()->segment(3) == 'history-requests' || request()->segment(2) == 'user-escorts-list' || request()->segment(2) == 'pricingsummaries') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('agent.manage.escorts.list') }}">
               ...
               <span class="pl-3" style="{{request()->segment(2) == 'user-escorts-list' ? 'color: #e5365a;' : ''}}">List Advertisers</span>
            </a>
            <a class="collapse-item" href="{{ route('pricingsummaries') }}">
               ...
               <span class="pl-3" style="{{request()->segment(2) == 'pricingsummaries' ? 'color: #e5365a;' : ''}}">Pricing Summary</span>
            </a>
         </div>
      </div>
   </li>
   ...
   <li class="nav-item">
        ...
        <div id="Analytics" class="collapse @if(request()->segment(2) == 'advertiser-profiles' || request()->segment(2) == 'advertiser-social-media' || request()->segment(2) == 'prospets-memberships') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
   ...
   <li class="nav-item">
      ...
      <div id="Community" class="collapse @if(request()->segment(2) == 'abbreviations' || request()->segment(2) == 'classification-laws' || request()->segment(2) == 'help' || request()->segment(2) == 'laws') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="py-0 collapse-inner rounded mb-2">
            ...
            <img src="{{ asset('assets/app/img/Abrieviations.png')}}">
            <span style="{{request()->segment(2) == 'classification-laws' ? 'color: #e5365a;' : ''}}">Classification laws</span>
            </a>
