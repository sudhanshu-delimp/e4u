        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col footer_text_color_white" align="justify">
                    ...
                    <p>The primary purpose of this Website is to permit adults to advertise their companionship to other
                        adults.</p>
                    <p>Escorts4U helps Advertisers and Users find each other, what happens after that connection is made
                        is up to them. We are not a party to any agreement, or involved in any interaction, between
                        Advertisers and Users.</p>
                    <p>Any price indicated in an Advertiser's Profile relates to their time only and nothing else. Any
                        service offered or whatever else that may occur is a mutual decision between consenting adults
                        and is Private between them. It is your responsibility to be cognisant of and to comply with the
                        Local Laws.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 manage_alments_in_ds text-right p-0">
                    ...
                    <ul class="footer_social_icons">
                        <li><a href="https://x.com/Escorts46919U" target="_blank"><img
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <img src="{{ asset('assets/app/img/logo.png') }}" class="modal-logo">
                </div>
                <div class="modal-body">
                    <h5 class="modal-title"><img src="{{ asset('assets/app/img/block-user.png') }}" class="user_ag_icon"> User Agreement</h5>
