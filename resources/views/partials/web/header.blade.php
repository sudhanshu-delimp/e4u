...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/style.css?v3.09') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/responsive-style.css?v3.06') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/footer.css?v2.02') }}">
