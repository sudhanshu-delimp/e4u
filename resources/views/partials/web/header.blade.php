...
<head>
    ...
    <link href="{{ asset('assets/dashboard/css/dk-style.css?v2.06') }}" rel="stylesheet">
    <!-- jquery ui cdn -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/style.css?v2.06') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/responsive-style.css?v2.06') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/footer.css?v1.4') }}">
