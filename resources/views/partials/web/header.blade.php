...
<html lang="en">
    <head>
       ...
       <link
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/style.css?v2.1') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/responsive-style.css?v1.3') }}">
