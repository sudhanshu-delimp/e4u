...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/style.css?v2.03') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/responsive-style.css?v2.07') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/footer.css?v1.21') }}">
