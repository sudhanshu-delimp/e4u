...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('assets/dashboard/css/dk-style.css?v2.04') }}" rel="stylesheet">
        <!-- jquery ui cdn -->
       ...
       <link
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/style.css?v1.12') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/responsive-style.css?v1.12') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/footer.css?v1.12') }}">
