...
<html lang="en">
    <head>
       ...
       <link
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/style.css?v1.17') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/responsive-style.css?v2.03') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/app/css/footer.css?v1.15') }}">
