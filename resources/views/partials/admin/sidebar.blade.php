...
<ul class="sticky-top navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('admin.index')}}">
            ...
            <span id="dash" style="{{  $_SERVER['REQUEST_URI'] == '/admin-dashboard' ? 'color: #e5365a;' : ''}}">Dashboard </span>
        </a>
    </li>
    <li class="nav-item">
...
{{--         <div id="global-monitoring" class="collapse @if(request()->segment(3) == 'advertisers') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#Billing" aria-expanded="false" aria-controls="collapseTwo">
        <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/chart.png')}}">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#logs" aria-expanded="false" aria-controls="Website">
        ...
        <div id="logs" class=" collapse  @if( request()->segment(3) == ' ') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="py-0 collapse-inner rounded mb-2">
            </div>
        </div>
    </li>
...
{{--        <a class="nav-link" href="{{ route('admin.support-tickets')}}">--}}
    ...
    <li class="nav-item">
        ...
        <div id="Website" class=" collapse  @if( request()->segment(3) == 'maintenance' || request()->segment(3) == 'global-notifications') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="py-0 collapse-inner rounded mb-2">
   ...
   <!-- <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#Management" aria-expanded="false" aria-controls="collapseTwo">
            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 0.720703C9.06087 0.720703 10.0783 1.14213 10.8284 1.89228C11.5786 2.64242 12 3.65984 12 4.7207C12 5.78157 11.5786 6.79899 10.8284 7.54913C10.0783 8.29928 9.06087 8.7207 8 8.7207C6.93913 8.7207 5.92172 8.29928 5.17157 7.54913C4.42143 6.79899 4 5.78157 4 4.7207C4 3.65984 4.42143 2.64242 5.17157 1.89228C5.92172 1.14213 6.93913 0.720703 8 0.720703ZM8 10.7207C12.42 10.7207 16 12.5107 16 14.7207V16.7207H0V14.7207C0 12.5107 3.58 10.7207 8 10.7207Z" fill="#C2CFE0"></path>
            </svg>
        ...
        <div id="Management" class="collapse @if(request()->segment(3) == 'email-management' || request()->segment(3) == 'logs-staff' || request()->segment(3) == 'marketing-templates-e4u' || request()->segment(3) == 'marketing-templates-agents' || request()->segment(3) == 'post-office' || request()->segment(2) == 'All-user' || request()->segment(3) == 'set-fees' || request()->segment(3) == 'manage-user' || request()->segment(3) == 'legbox-report' || request()->segment(3) == 'punterbox-reports' || request()->segment(3) == 'competitor-database') show @endif;" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="py-0 collapse-inner rounded mb-2">
                {{-- <a class="collapse-item" href="#">
                <img width="16" height="17" viewBox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                ...
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'logs-staff' ? 'color: #e5365a;' : ''}}">Logs - Staff</span></a>
                <a class="collapse-item" href="{{route('admin.marketing-templates-e4u')}}">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'marketing-templates-e4u' ? 'color: #e5365a;' : ''}}">Marketing Templates - E4U</span></a>
                <a class="collapse-item" href="{{route('admin.marketing-templates-agents')}}">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'marketing-templates-agents' ? 'color: #e5365a;' : ''}}">Marketing Templates - Agents</span></a>
                <a class="collapse-item" href="{{route('admin.post-office')}}">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'post-office' ? 'color: #e5365a;' : ''}}">Post Office</span></a>
                ...
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'manage-user' ? 'color: #e5365a;' : ''}}">User Management</span></a>
                <a class="collapse-item" href="#">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span>Agent Registrations</span></a>
                <a class="collapse-item" href="{{route('admin.legbox-report')}}">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'legbox-report' ? 'color: #e5365a;' : ''}}">Legbox Report</span></a>
                <a class="collapse-item" href="#">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span>Notes Report</span></a>
                <a class="collapse-item" href="{{route('admin.punterbox-reports')}}">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'punterbox-reports' ? 'color: #e5365a;' : ''}}">Punterbox Report</span></a>
                <a class="collapse-item" href="{{route('admin.competitor-database')}}">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
                <span style="{{request()->segment(3) == 'competitor-database' ? 'color: #e5365a;' : ''}}">Competitor Database</span></a>
                <a class="collapse-item" href="#">
                <img width="16" height="17" viewbox="0 0 16 17" fill="none" src="{{ asset('assets/dashboard/img/menu-icon/Upload-my-avatar.png')}}">
