...
<ul class="sticky-top navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
   ...
   <span style="color:#FF3C5F;" class="font-weight-normal">Viewer  Console</span>
   </a>
   <!-- Divider -->
   <!-- Nav Item - Dashboard -->
   ...
   <li class="nav-item">
      ...
      <div id="collapseTwo" class="; collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="py-0 collapse-inner rounded mb-2">
            <a class="collapse-item" href="{{url('admin-dashboard/my-legbox-list')}}">
            ...
            <a class="collapse-item" href="{{url('admin-dashboard/my-legbox-notes')}}">
