    ...
    <div class="topbar-logged-in-user-data">
        ...
        <div class="d-user-info">
            <div class="escort_header_top_menu">
                ...
                <span>
                    ...
                    @else
                        <span class="user-values" title="">
                            <a href="{{ url('/escort-dashboard/escort-agency-request') }}" class="request-active">
                                Request one</a>
                        </span>
                    @endif
                ...
                <span>
                    <span class="separator">|</span> <b>Current Location : </b><span
        ...
        <!-- //////// Notification ///////////// -->
         <li class="nav-item dropdown no-arrow mx-1 esc-tooltip-wrap">     
                            ...
                            @endif
                             ...
                             <span class="esc-tooltip esc-tooltip-support">Switch to Agent Account</span>   
