    ...
    {{-- <li class="nav-item">
        ...
        <div id="Administration" class="collapse @if (in_array(request()->segment(3), [
            ...
            <div class="py-0 collapse-inner rounded mb-2">
                ...
                <div id="listingMenu"
                    class="collapse  
                        @if (request()->segment(3) == 'add-listing' ||
                                (request()->segment(3) == 'listings' && in_array(request()->segment(3), ['current', 'past']))) show @endif">
        ...
        <div id="Management" class="collapse
            ...
            <div class="collapse-inner">
                ...
                <div id="ManagementAnalytics"
                    ...
                    <a class="collapse-item {{ request()->segment(2)=='profiles-tours' ? 'menu-active' : '' }}" href="{{ url('escort-dashboard/profiles-tours') }}">
                        <img src="{{ asset('assets/dashboard/img/menu-icon/bed.png') }}">
                         <span>Profiles & Tours</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='social-media' ? 'menu-active' : '' }}" href="{{ url('escort-dashboard/social-media') }}">
                        <img src="{{ asset('assets/dashboard/img/menu-icon/at.png') }}">
                        <span>Social Media</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='feedback' ? 'menu-active' : '' }}" href="{{ url('escort-dashboard/feedback') }}">
                        <img src="{{ asset('assets/dashboard/img/menu-icon/feedback-22.png') }}">
                        <span>Feedback</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='criticalinformation' ? 'menu-active' : '' }}" href="{{ url('escort-dashboard/criticalinformation') }}">
                ...
                <div id="ManagementBookkeeping"
                    ...
                    <a class="collapse-item {{ request()->segment(2)=='bank_account' ? 'menu-active' : '' }}" href="{{ route('escort.bank_account') }}">
                         <img src="{{ asset('assets/app/img/sales-performance.png') }}">
                         <span>Bank Account</span>
                        </a>
                    <a class="collapse-item {{ request()->segment(2)=='credit-my-account' ? 'menu-active' : '' }}" href="{{ url('escort-dashboard/credit-my-account') }}"> 
                        <img src="{{ asset('assets/dashboard/img/menu-icon/credit-card-plus.png') }}">
                        <span>Add Credit</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='transaction-summary' ? 'menu-active' : '' }}" href="{{ url('escort-dashboard/transaction-summary') }}">
                ...
                <div id="ManagementCommunity"
                    ...
                    <a class="collapse-item {{ request()->segment(2)=='help' ? 'menu-active' : '' }}" href="{{ route('escort.dashboard.Community.help') }}">
                        <img src="{{ asset('assets/app/img/helptips.png') }}">
                       <span> Help</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='laws' ? 'menu-active' : '' }}" href="{{ route('escort.dashboard.Community.laws') }}">
                        <img src="{{ asset('assets/app/img/gavel.png') }}">
                        <span>Local Laws</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='pricing' ? 'menu-active' : '' }}" href="{{ route('escort.dashboard.Community.pricing') }}">
                ...
                <div id="ManagementNUM"
                    ...
                    <a class="collapse-item {{ request()->segment(2)=='num-dashboard' ? 'menu-active' : '' }}" href="{{ route('escort.numdashboard') }}">
                        <img src="{{ asset('assets/img/dashboard-24.png') }}" />
                        <span>Dashboard</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='add-report' ? 'menu-active' : '' }}" href="{{ route('escort.add-report') }}">
                        <img src="{{ asset('assets/img/report-24.png') }}" />
                        <span>Add Report</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='my-reports' ? 'menu-active' : '' }}" href="{{ route('escort.my-reports') }}">
                        <img src="{{ asset('assets/img/8report-24.png') }}" />
                        <span>My Reports</span>
                    </a>
                    <a class="collapse-item {{ request()->segment(2)=='num-tips' ? 'menu-active' : '' }}" href="{{ route('escort.num-tips') }}">
                ...
                <div id="ManagementTickets"
                    ...
                    <a class="collapse-item {{ request()->segment(2)=='ticket-list' ? 'menu-active' : '' }}" href="{{ route('support-ticket.list') }}">
