    ...
    <div class="row">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('staff.escort-listings') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('staff.massage-centre-listings') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('staff.pin-up-listings') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('admin.agent-requests') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a  href="javascript:void(0){{-- route('admin.registrations-reports') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('admin.logged-in-users') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('admin.support-ticket.list') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('admin.global') --}}">
                    <div class="box-icon">
        ...
        <div class="col-lg-4 box-wrapper">
            <div class="my-custom-box shadow-sm">
                <a href="javascript:void(0){{-- route('admin.transaction-summary') --}}">
                    <div class="box-icon">
