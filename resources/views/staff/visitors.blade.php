            ...
            <div class="visitor_table_class">
                <table class="table" id="visitorTable" style="width:100%;">
                    ...
                    <tfoot class="bg-first">
                        <tr>
                            <th colspan="2" class="text-left ">Server time: <span class="serverTime"></span></th>
                            <th colspan="3" class="text-center">Refresh time:<span class="refreshSeconds"></span></th>
...
<script>
    ...
    function ajaxReload() {
        var visitorTable = $('#visitorTable').DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: "{{ route('staff.visitors-by-ajax') }}",
                type: "GET",
