...
<script type="text/javascript" charset="utf8" src="{{ asset('assets/plugins/datatables/jquery.dataTables.min.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function ajaxReload()
        {
            ...
            paging: true,
            ajax: {
                url: "{{ route('staff.current.list.escort-dataTableListing', 'current') }}", 
                type: "GET",
        ...
        $(document).on('click', '.view-listing', function(e) {
            ...
            $.ajax({
                url: '{{route("staff.current.single-list.escort-dataTableListing")}}/' + escortId, // replace with your actual route
                method: 'GET',
