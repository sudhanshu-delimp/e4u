                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 mt-4">
                                            ...
                                            <form id="my_avatar" action="{{ route('staff.save.avatar', auth()->user()->id)}}" method="POST" enctype="multipart/form-data">
                ...
                success: function(data) {
                    try {
                        if (data.type == 0) {
                           ...
                           // var imgurl = "{{asset('assets/app/img/service-provider/Frame-408.png')}}";
                           // $(".avatarName").attr('src', imgurl);
