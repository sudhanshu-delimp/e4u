            ...
            <div class="padding_20_all_side pb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-group row tab-about-me-row-padding">
                            <label class="col-sm-3 font-weight-500" for="exampleFormControlSelect1">SWA License:</label>
                            <div class="col-sm-7">
                ...
                <div class="row">
                    <div class="col-lg-12 stage">
                        <div class="form-group row tab-about-me-row-padding">
                            <label class="col-sm-1 font-weight-500" for="exampleFormControlSelect1">Stage Names</label>
                            <div class="col-sm-8">
