               ...
               <div id="additional_information" class="collapse" data-parent="#accordion">
                  <div class="card-body pb-0">
                     <ol class="pl-0 mb-0">
                        ...
                        <li>You can over ride these settings when creating a Profile, provided you have enabled the feature (see My Account - Profile & Tour options).</li>
                     </ol>
                  ...
                  <div class="card-body pb-0">
                     <ol class="pl-0 mb-0">
                        ...
                        <li>You can over ride these settings when creating a Profile, provided you have enabled
                           the feature (see My Account - Profile & Tour options).
                        </li>
                     </ol>
...
//        var getNameOne = $(this).children(":selected").attr("id");
//        if(selectedIdOne){
//            $("#selected_service_one").append(" <li id='hideenclassOne_"+ selectedIdOne+"'><div class='my_service_anal' ><span class='dollar-sign'>"+getNameOne+"</span><input type='number' class='dollar-before input_border' name='price[]' placeholder='' min='0' oninput='this.value = Math.abs(this.value)' step=10 max=200><input type='hidden' name='service_id[]' value="+ selectedIdOne +" placeholder=''><span><i class='fas fa-times-circle akh1' data-sname='"+getNameOne+"' data-val="+ selectedIdOne+"  id='id_"+ selectedIdOne+"' value="+selectedIdOne+"></i></span></div></li> ");
//            $("#service_id_one option[value="+ selectedIdOne +"]").attr('disabled','disabled');
//            $("#service_id_one option[value="+ selectedIdOne +"]").remove();
//            console.log('change='+selectedIdOne);
//        }
//    });
   ...
   $('#st_name').on('select2:select', function (e) {
      ...
      // $("#st_name").val([]).trigger();
       ...
       $(".results").append($("<li style='font-size: 14px;'><a href='#'>"+data.text +"</a><button type='button' class=' close ml-2 text-white stage-close' aria-label='Close'><span class='delete_stname' id='"+data.id+"' aria-hidden='true'>×</span></button></li><input type='hidden' name='name[]' value='"+data.id+"'>"))
   });
