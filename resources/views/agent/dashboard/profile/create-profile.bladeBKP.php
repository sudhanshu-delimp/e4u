        ...
        <div class="col-sm-9 col-md-9 col-lg-9 ">
            <div class="about_me_drop_down_info box_shadow_fill_profile">
                ...
                <div class="padding_20_all_side">
                    <form id="create-profile" action="{{ route('agent.create.profile')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group row">
                                    <label class="col-sm-5" for="exampleFormControlSelect1"><span style="color:red">* </span>User</label>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="form-group row">
                                    <select class="form-control select2 form-control-sm select_tag_remove_box_sadow width_hundred_present_imp" id="searchUser" name="user_id" data-parsley-errors-container="#userName"  data-parsley-required-message="Select user">
                                    </select>
                                </div>
                            </div>
                        <input type="hidden" name="id" value="@if(!empty($profile->id)){{ $profile->id }} @endif">
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-5" for="exampleFormControlSelect1"><span style="color:red">* </span>Display Name:</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5" for="exampleFormControlSelect1"><span style="color:red">* </span> State:</label>
                                    <div class="col-sm-7">
                                        <select class="form-control select2 form-control-sm select_tag_remove_box_sadow width_hundred_present_imp" id="state" name="state_id" data-parsley-errors-container="#state-errors" required{{ $profile->state ? null : ' disabled' }} data-parsley-required-message="Select country">
                                            @if($profile->state)<option value="{{ old('state_id', $profile->state_id) }}" selected>{{ $profile->state->name }}</option>@endif
                                        </select>
                                        <span id="state-errors"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-5" for="exampleFormControlSelect1"><span style="color:red">* </span> Pin</label>
                                    <div class="col-sm-7">
                                        <input type="txt" class="form-control form-control-sm removebox_shdow" placeholder="Pin Code" required name="pincode" value="{{ old('pincode', $profile->pincode) }}" data-parsley-required-message="Please enter pin code">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5" for="exampleFormControlSelect1"><span style="color:red">* </span> Country:</label>
                                    <div class="col-sm-7">
                                        <select class="form-control select2 form-control-sm select_tag_remove_box_sadow width_hundred_present_imp" id="country" name="country_id" data-parsley-errors-container="#country-errors" required data-parsley-required-message="Please select country">
                                            @if($profile->country)<option value="{{ old('state_id', $profile->country_id) }}" selected>{{ $profile->country->name }}</option>@endif
                                        </select>
                                        <span id="country-errors"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-5" for="exampleFormControlSelect1"><span style="color:red">* </span> City:</label>
                                    <div class="col-sm-7">
                                        <select class="form-control select2 form-control-sm select_tag_remove_box_sadow width_hundred_present_imp" id="city" name="city_id" data-parsley-errors-container="#city-errors" required{{ $profile->city ? null : ' disabled' }} data-parsley-required-message="Please select city">
                                            @if($profile->city)<option value="{{ old('state_id', $profile->city_id) }}" selected>{{ $profile->city->name }}</option>@endif
                                        </select>
            ...
            <div class="about_me_drop_down_info box_shadow_fill_profile{{ $profile->id ? null : ' d-none' }}" id="media-upload-block">
                <div class="about_me_heading_in_first_tab fill_profile_headings_global">
                ...
                <div class="padding_20_all_side">
                    <form id="fileupload" action="" method="POST" enctype="multipart/form-data">
                        ...
                        @include('agent.dashboard.profile.partials.escort-media-table')
                    </form>
                </div>
                    <div class="row">
                        <div class="col-md-12 text-right"><a href="{{ $profile->id ? route('agent.next.step', [$profile->id]) : '#' }}" class="save_profile_btn btn-primary" id="profile-next-step">Next</a></div>
                    </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('assets/app/vendor/file-upload/js/agentDemo.js') }}"></script>
