                              ...
                              <div class="tab-pane fade in active show" id="tab1warning">
                                 <div class="card shadow-sm pb-4 rounded-0">
                                    <div class="card-body mb-1">
                                       <p class="mb-2 text-muted">Cover Page</p>
                                       ...
                                       <div class="table-responsive-xl">
                                          <table class="table table-bordered">
                                             <thead class="bg-first">
                                               ...
                                               <tr>
                                                   <th>Massage Centre</th>
                                                   <th>Email Address</th>
                                               </tr>
                                             </thead>
                                             <tbody class="table-content">
                                                <tr class="row-color mt-0">
                                                   <td class="text-muted">Candy Massage</td>
                                                   <td class="text-muted">paul@candymassage.com.au</td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </div>
                              ...
                              <div class="tab-pane fade in active show" id="tab1warning">
                                 <div class="card shadow-sm rounded-0">
                                    <div class="card-body pb-0">
                                       <p class="mb-2 text-muted">Page 1</p>
                                       <div class="table-responsive-xl">
                                          <table class="table table-bordered">
                                             <thead class="bg-first">
                                                <th>Date</th>
