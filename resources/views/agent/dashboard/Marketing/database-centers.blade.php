   ...
   <div class="row">
      <div class="col-md-12 d-flex align-items-center justify-content-between flex-wrap gap-10">
         ...
         <div class="text-center  d-flex justify-content-end align-items-center gap-10 flex-wrap">
             ...
             <span class="d-flex justify-content-start gap-5 align-items-center">Appointed <i class="fas fa-circle status-appointed mr-2"></i></span>
             <span class="d-flex justify-content-start gap-5 align-items-center">Active  <i class="fas fa-circle status-active mr-2"></i></span>
            
             <span class="d-flex justify-content-start gap-5 align-items-center">Open <i class="fas fa-circle status-open mr-2"></i></span>
             <span class="d-flex justify-content-start gap-5 align-items-center">Unavailable <i class="fas fa-circle status-unavailable "></i></span>
                     ...
                     <div class="dropdown no-arrow">
                        ...
                        <div class="dot-dropdown dropdown-menu dropdown-menu-right shadow animated--fade-in"
                           ...
                           <a class="dropdown-item d-flex justify-content-start gap-10 align-items-center"
                                 href="#" data-target="#view_data_center" data-toggle="modal"> <i class="fa fa-eye" ></i>
                                 View</a>
                           <div class="dropdown-divider"></div>
                           <a class="dropdown-item d-flex justify-content-start gap-10 align-items-center"
                                 href="#" data-target="#edit_data_center" data-toggle="modal"> <i class="fa fa-pen"></i>
                                 Edit</a>
...
<div class="modal fade upload-modal" id="view_data_center" tabindex="-1" aria-labelledby="view_data_centerLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">
