...
@section('content')
        ...
        <div class="row">
            ...
            <div class="d-flex align-items-center justify-content-between col-md-12">
                <div class="custom-heading-wrapper">
                    <h1 class="h1">Advertisers (summary)</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 my-2 card-wrapper">
                <div class="my-spend-box-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="font-weight-bold" style="color: var(--blue--text);">Top Advertisers (Escort)
                            </h4>
                        </div>
                        <div class="col-lg-12 card-list-wrapper">
                            ...
                            <div class="card shadow-sm border-1 mb-2 py-3 px-2 my-spend-box">
                                <div class="card-body">
                                    <!-- Text Section -->
                                    <h4 class="mb-0 user-type-text font-weight-bold">Lin's Massage</h4>
                    ...
                    <div class="row my-3">
                        <div class="col-lg-12">
                            <h4 class="font-weight-bold" style="color: var(--blue--text);">Top Advertisers (Massage Center)
                            </h4>
                        </div>
                        <div class="col-lg-12 card-list-wrapper">
                            <div class="card shadow-sm border-1 mb-2 py-3 px-2 my-spend-box">
            ...
            <div class="col-lg-12 my-4 card-wrapper">
                <div class="my-spend-box-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="font-weight-bold" style="color: var(--blue--text);">Registrations (Escort)
                            </h4>
                        </div>
                        <div class="col-lg-12 card-list-wrapper">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="password_expiry"
                                        id="expiry_never" value="never">
    ...
    <div class="modal fade upload-modal" id="resetPasswordSaved" tabindex="-1" role="dialog"
        aria-labelledby="resetPasswordSavedlabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
