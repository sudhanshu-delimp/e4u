                ...
                <div class="card collapse" id="notes" style="">
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li>Any queries regarding payments to your Bank Account can be raised by logging a <a
                                    href="{{ route('support-ticket.form_create') }}"
                                    class="termsandconditions_text_color custom_links_design">Support Ticket</a> with E4U.
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="bothsearch-form">
                            <button type="button" class="create-tour-sec dctour" data-toggle="modal" id="commission-modal"
                                data-target="#commission-report2">Add New</button>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <img src="{{ asset('assets/dashboard/img/add-new-account.png') }}"
                            class="custompopicon"> Add Bank Account</h5>
                    ...
                    <form id="agent_bank" method="post" action="{{ route('agent.save.bank.details') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>BSB</label>
                                    <input type="text " class="form-control" placeholder="BSB" name="bsb"
                                        id="bsb" maxlength="12"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="12"
                                        oninput="this.value = this.value.replace(/[^0-9 ]/g, '').replace(/\s+/g, ' ')"
                                        placeholder="Account Number" id="account_number" name="account_number">
        ...
        $(function() {
            ...
            $(document).on('submit', '#agent_bank', async function(e) {
                ...
                if (!bankId) {
                    ...
                    else if ((previous_state != state) && is_primary_bank_acc == '0' &&
                        previous_state == '2' && state == '1') {
                        Swal.fire({
                            title: "",
                            text: "Do you want to save this bank account as Primary bank account?",
                            iconHtml: '<i class="fa-solid fa-circle-exclamation"></i>',
                    ...
                    } else if ((previous_state != state) && is_primary_bank_acc == '1' &&
                        previous_state == '2' && state == '1') {
                        Swal.fire({
                            title: "",
                            text: "Do you want to save this bank account as Primary bank account?",
