                ...
                <div class="modal-body pb-0 agent-tour">
                    <form method="post" id="task_form" action="#">
                        ...
                        <div class="row" id="task_form_html">
                            <h4 id="task_desc" class="custom_modal_text">Are you sure you want to mark this Appointment as
                                completed?</h4>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-0 agent-tour">
                    <div class="py-4 " id="success_form_html">
                        <h4 id="success_msg" class="text-center">Are you sure you want to mark this Appointment as
                            completed?</h4>
                        <div class="d-flex justify-content-center mt-3">

                            <button type="button" class="btn-success-modal" data-dismiss="modal" aria-label="Close"
                                id="cancel_button">OK</button>
        ...
        function fetchAllTaskData() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    showAlert('Success', 'Task marked as completed successfully.', 'success');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.task_name == 'add_task') {
                        ...
                        showAlert('Task', 'Task Added sucessfully.', 'success');
                    ...
                    if (response.task_name == 'update_task') {
                        ...
                        showAlert('Task', 'Task Updated sucessfully.', 'success');
                        // $('#successModal').modal('show');
                        return true;
                    }
                    ...
                    if (response.task_name == 'complete_task') {
                        ...
                        showAlert('Task', 'Task has been mark as completed.', 'success');
                        // $('#successModal').modal('show');
                        return true;
                    }
