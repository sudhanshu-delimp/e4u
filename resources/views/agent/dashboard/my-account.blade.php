    ...
    <div class="container-fluid pl-3 pl-lg-5 pr-3 pr-lg-5">
            ...
            <div class="col-md-12 mb-4">
                <div class="card collapse" id="notes" style="">
                    <div class="card-body">
                        ...
                        <ol>
                            <li>Use this feature to view all of your personal details - who you are, your Agent Agreement,
                                and Fees.</li>
                            <li>You can download your Agent Agreement which incorporates your KPIs and other critical
                                information in relation to your expected performance outcomes.</li>
        ...
        <div class="row">
            ...
            <div id="accordion" class="myacording-design mb-5">
                    ...
                    <div id="about_me" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                            <form id="userProfile" class="common-form"
                                action="{{ route('agent.account.update', [$user->id]) }}" method="POST">
                                        ...
                                        <div class="inner-field-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="txt" class="form-control" id="mobileno"
                                                    ...
                                                    value="{{ $user->getRawOriginal('abn') }}" maxlength="11"
                                                    pattern="\d{11}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="txt" class="form-control" id="mobileno"
                                                    aria-describedby="emailHelp" name="business_number" maxlength="12"
                                                    required placeholder="Business Number"
                                                    data-parsley-required-message="Your business number is required"
                                                    value="{{ $user->getRawOriginal('business_number') }}"
                                                    pattern="\d{8,12}" data-parsley-type-message="Enter only numbers"
                ...
                <div class="card common-card">
                    <div class="card-header">
                        <a class="collapsed card-link" data-toggle="collapse" href="#agreement_opt">
                            Agreement
                        </a>
                    </div>
                    <div id="agreement_opt" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                                ...
                                <div class="row inner-row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="inner-field-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="input_not_edit">
                                                    {{ $user->agent_detail ? $user->agent_detail->option_exercised : '' }}
                                                </p>
                                            </div>
                                            <div class="form-group">
                                                <label for="mobile">Territory</label>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        <div class="form-group">
                                            ...
                                            @else
                                                <a href="javascript:void(0)" class="custom_links_design"
                                                    title="The agreement file has not been uploaded.">
                ...
                <div class="card common-card">
                    <div class="card-header">
                        <a class="collapsed card-link" data-toggle="collapse" href="#fee_opt">
                            Fees
                        </a>
                    </div>


                    <div id="fee_opt" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card common-card">
                    ...
                    <div id="signature_opt"
                        class="collapse {{ request()->has('show') && request()->query('show') == 1 ? 'show' : '' }}"
                        data-parent="#accordion">
                        <div class="card-body">
                            <form id="frmSignature" name="frmSignature" class="common-form" novalidate=""
                                ...
                                <div class="row inner-row">
                                                ...
                                                <svg fill="#ff3c5f" height="64px" width="64px" version="1.1"
                                                    ...
                                                    <g>
                                                        <path d="M8 47
                                                                        ...
                                                                        C34 47, 33 43, 34 38
                                                                        C30 44, 24 49, 18 48
                                                                        C12 47, 11 43, 13 37" fill="rgb(255, 60, 95)"
                                                            stroke="#ff3c5f" stroke-width="2.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />

                                                        <path d="M10 52
                                                                        C22 50, 37 52, 55 50" fill="rgb(255, 60, 95)"
                                                            stroke="#ff3c5f" stroke-width="2" stroke-linecap="round" />
                                                    </g>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group" >
                                            ...
                                            <label for="signature_file" class="file-upload-box">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row" id="deleteSignature">
                                            @if ($user->agent_detail && $user->agent_detail->signature_file != '')
                                                <div class="col-lg-12 mt-4">
                                                    <div class="mt-2 signature-image-box">
                                                        <img src="{{ asset('storage/' . $user->agent_detail->signature_file) }}"
                                                            alt="Signature"
                                                            id="signatureImage">
                                                    </div>
                                                </div>
