                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="txt" class="form-control" id="mobileno"
                                                            aria-describedby="emailHelp" name="abn" required
                                                            placeholder="ABN"
                                                            data-parsley-required-message="Your ABN is required"
                                                            value="{{ $user->abn }}" maxlength="14"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="txt" class="form-control" id="mobileno"
                                                            aria-describedby="emailHelp" name="business_number"
                                                            maxlength="12" required placeholder="Business Number"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="txt" class="form-control" id="mobileno"
                                                            ...
                                                            data-parsley-maxlength="12" required
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="form-control form-back" placeholder=" "
                                                            aria-describedby="emailHelp">{{ $user->email2 }} </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span
                                                            class="form-control form-back">{{ $user->agent_detail ? date('d-m-Y', strtotime($user->agent_detail)) : '' }}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span
                                                            class="form-control form-back">{{ $user->agent_detail ? $user->agent_detail->term : '' }}</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span
                                                            class="form-control form-back">{{ $user->agent_detail ? $user->agent_detail->option_peroid : '' }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span
                                                            class="form-control form-back">{{ $user->agent_detail ? $user->agent_detail->option_exercised : '' }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($user->agent_detail->commission_advertising_type == 'percent')
                                                            <span
                                                                class="form-control form-back">{{ $user->agent_detail ? $user->agent_detail->commission_advertising_percent . '%' : '' }}</span>
                                                        @else
                                                            <span
                                                                class="form-control form-back">{{ $user->agent_detail ? "$" . $user->agent_detail->commission_advertising_percent : '' }}</span>
                                                        @endif
