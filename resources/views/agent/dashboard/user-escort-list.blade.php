                    ...
                    <div class="col-md-9">
                        ...
                        <div class="container-fluid" style="padding: 0px 0px;">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Manage Escorts </h1>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body table table-bordered table-hover">
                                    <table class="table table-hover" id="myTable">
                                        <thead class="table-bg">
                                            <tr>
                                                <th>Profile Name <svg width="17" height="16" viewBox="0 0 17 16"
