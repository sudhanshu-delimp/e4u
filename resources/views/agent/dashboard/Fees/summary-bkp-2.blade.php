                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <table class="table table-bordered total-summary summery-border">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="border-left-0 border-bottom-0 border-top-0">
                                                                        <b>Advertisers</b>
                                                                    </td>
                                            ...
                                            <table class="table table-bordered total-summary">
                                                <tbody>
                                                    <tr class="text-center">
                                                        ...
                                                        <td colspan="6"><b>Advertisers Gross Spend (Year to Date)
                                                                Earnings
                                                            </b>
                                                        </td>
                                ...
                                <div class="card border-0">
                                    <div class="table-responsive-xl">
                                        <table class="table table-bordered total-summary mb-0">
                                            <tbody>
                                                <tr>
                                                    <td colspan="18" style="text-align: center;"><b>Statistics</b> <span
                                                            style=" float: right;"><b>P = Postings D = Total
                                                                Days</b></span></td>
                                                </tr>
                                                <tr>
