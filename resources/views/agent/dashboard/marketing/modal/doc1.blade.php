...
<head>
    ...
    <title>E4U Proposal | Document (1)</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="page_container">
        <div class="header">
            ...
            <div class="subtitle">
                Information Package for the Provision of Advertising Solutions for a Massage Centre
            </div>
            <div class="info">
        ...
        <div class="page_1">
            ...
            <p>
                Your advantages are not only financial, but strategic as well. Unlike other platforms, E4U offers you a purpose designed Profile (see sample screen shot), which caters for your business information and up to eight detailed Masseurs profiles.
            </p>
            ...
            <p>The Profile also displays a location map for the Centre, and when viewed through the mobile app, a simple click on the location map and Google maps will activate directions for the client to find your Centre.
            </p>
            ...
            <p>
                The Listing page rotates Profiles every 30 minutes ensuring your Profile will have time on the front page of the Listings. You can also Bump Up your listing as many times as you like. The website has a separate listing group just for Centres.
            </p>
            ...
            <p>
                ...
                <br> <span style="border-bottom: 1px solid #333;">for free</span> , you can:
            </p>
            <ul>
            ...
            <p>
                You can manage all of your data and Profiles, together with access to many other services, through your Dashboard. If you engage E4U or an agent to create and manage your Profile there is a fee.
            </p>
