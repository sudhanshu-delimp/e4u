<div class="tab-pane fade" id="available" role="tabpanel" aria-labelledby="contact-tab">
    ...
    <div class="about_me_drop_down_info ">
        ...
        <div class="padding_20_all_side my-availability-mon">
            <form class="my-availability-mon-sun" id="myability" action="{{ route('agent.store.availability', [$escort->id])}}" method="Post">
                @csrf
                <div class="row">
                    <div class="col-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="monday" id="resetMonday">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="tuesday" id="resetTuesday">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="wednesday" id="resetWednesday">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="thursday" id="resetThursday">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="friday" id="resetFriday">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="saturday" id="resetSaturday">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="resetdays-icon">
                                            <input type="reset" value="Reset" class="resetdays" data-day="sunday" id="resetSunday">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="tab_btm_btns_preview_and_next">
        <div class="row pt-3 pb-3">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12 previous_bt_center_in_sm a_text_white_hover">
                <a class="nex_sterp_btn nav-item" id="profile-tab" data-toggle="tab" href="#services" role="tab" aria-controls="profile" aria-selected="false">
