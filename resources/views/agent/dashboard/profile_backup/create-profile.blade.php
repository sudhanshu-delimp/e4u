                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    <label class="col-sm-3" for="exampleFormControlSelect1"><span style="color:red">* </span>Display Name:</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3" for="exampleFormControlSelect1"><span style="color:red">* </span> State:</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3" for="exampleFormControlSelect1"><span style="color:red">* </span> Phone No:</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control select2 form-control-sm select_tag_remove_box_sadow width_hundred_present_imp" id="city" name="city_id" data-parsley-errors-container="#city-errors" required data-parsley-required-message="Please select city" {{$profile->city_id ? '': 'disabled'}}>
                                            @if($profile->city)
                                            <option value="{{ old('state_id', $profile->city_id) }}" selected>{{ $profile->city->name }}</option>
                                            @endif
                                        </select>
                        ...
                        <div class="padding_20_all_side">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-2" for="exampleFormControlSelect1"></label>
                                        <div class="col-sm-7 col-lg-7 col-md-7 col-10">
                                            <select class="form-control select2 form-control-sm select_tag_remove_box_sadow width_hundred_present_imp" name="user_id" data-parsley-errors-container="#user-errors" required data-parsley-required-message="Please select Escort Type">
                                                <option value=" " selected>Select Escort Type</option>   
                                                @if($usr_type->agentEscorts)
                                                    @foreach($usr_type->agentEscorts as $escort)
