...
@section('content')
                            ...
                            <div class="card collapse" id="notes" style="">
                                <div class="card-body">
                                    ...
                                    <ol>
                                        ...
                                        <li>It is a summary of the Tour and revenue (Commission) you have derived from the Tour.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown no-arrow">
                                                    ...
                                                    <div class="dot-dropdown dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                        ...
                                                        <a class="dropdown-item d-flex align-items-center justify-content-start gap-10"
                                                            href="#" data-toggle="modal" data-target="#tour_summary"> <i
                                                                class="fa fa-file-alt"></i> Tour Summary</a>
            ...
            <div class="modal-content custome_modal_max_width">
                <div class="modal-header main_bg_color border-0">
                    <h5 class="modal-title text-white">
                        <img src="{{ asset('assets/dashboard/img/profile-report.png') }}" class="custompopicon" alt="cross">
                        Tour Report
                    </h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group mb-4">
                                   <div class="d-flex align-items-center gap-20">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="reportType" id="reportAll" value="all">
                                        <label class="form-check-label" for="reportAll">All</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="reportType" id="reportEscort" value="escort">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex align-items-center gap-20">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="period" id="periodEntire" value="entire">
                                ...
                                <div class="modal-footer justify-content-center">
                                    <button type="button" class="btn-success-modal" data-dismiss="modal" id="close_change">View</button>
    ...
    {{-- end --}}
        ...
        {{-- tour_summary--}}
        <div class="modal fade upload-modal bd-example-modal-lg" id="tour_summary" tabindex="-1" role="dialog" aria-labelledby="tour_summaryLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-custom" role="document">
            <div class="modal-content basic-modal modal-lg">
                <div class="modal-header">
                    <h5 class="modal-title" id="tour_summary"><img src="{{ asset('assets/dashboard/img/tour-summary.png') }}" class="custompopicon">Tour Summary - Member ID</h5>
                ...
                <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr style="font-weight:bold;">
                                ...
                                <td style="text-align:right;">$ 1,443.00</td>
                            </tr>
                        </tbody>
