...
class ReportMassageProfile extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       ...
       Schema::create('report_massage_profiles', function (Blueprint $table) {
    ...
    {
        Schema::table('ReportMassageProfile', function (Blueprint $table) {
            //
        });
    }
}
