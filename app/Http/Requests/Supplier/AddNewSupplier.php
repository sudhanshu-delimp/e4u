...
class AddNewSupplier extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'country_id.required' => 'please select your location.',
            'country_id.exists' => 'please select your location.',
            'state_id.required' => 'please select your location.',
            'state_id.exists' => 'please select your location.',
