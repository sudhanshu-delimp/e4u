...
class UpdateController extends AppController
{
    ...
    public function updateProfile($id)
    {
        ...
        if ($escort->user_id != auth()->user()->id) {
            ...
            return view('escort.dashboard.profile.update', compact('defaultServiceIds','defaultImages', 'mediaCategory', 'media', 'users_for_available_playmate', 'path', 'escort', 'service', 'availability', 'service_one', 'service_two', 'service_three', 'durations', 'user'));
        }
    }
