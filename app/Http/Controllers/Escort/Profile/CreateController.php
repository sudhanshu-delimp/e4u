...
class CreateController extends Controller
{
     ...
     */
    public function __construct(UserInterface $user, EscortInterface $escort, EscortMediaInterface $media, ThumbnailInterface $thumbnail,  ServiceInterface $service, DurationInterface $duration)
    {
        $this->user = $user;
        $this->escort = $escort;
        $this->media = $media;
    ...
    public function index($id = null)
    {
        ...
        return view('escort.dashboard.profile.update',compact('defaultServiceIds','mediaCategory','media', 'path','escort','service','availability','service_one','service_two','service_three','durations','user'));
    }
