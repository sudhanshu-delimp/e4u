...
class LegboxNotificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = LegboxNotification::query();
        ...
        return view('center.dashboard.Communication.legbox_notification.index');
    ...
    public function store(StoreCenterNotification $request)
    {
        ...
        if ($notificationId) {
            ...
            $update = LegboxNotification::find($notificationId);
        ...
        try {
            LegboxNotification::create($data);
    ...
    public function pdfDownload($id)
    {
        try {
            ...
            $data = LegboxNotification::find($decodedId);
            if (is_null($data)) {
            ...
            if ($data['type'] == 'Template') {
             ...
             return view('center.dashboard.Communication.legbox_notification.legbox-notification-pdf-download', compact('pdfDetail'));
        } catch (\Throwable $e) {
            abort(404);
        }
    }
