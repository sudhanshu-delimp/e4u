...
class ReportingController extends BaseController
{
    ...
    {
        return view('staff.reporting.registrations');
    }
        ...
        foreach($agents as $key => $item) {
            ...
            $dropdown = '<div class="dropdown no-arrow">
                      ...
                      if ($this->editAccessEnabled) {   
                         $dropdown .= '<a class="dropdown-item d-flex align-items-center gap-10" data-toggle="modal"
                    ...
                    $dropdown .= '<a class="view_member_report dropdown-item d-flex align-items-center gap-10 toggle-report"href="#" data-id="1435"><i class="fa fa-eye mr-2"></i> View</a>';
