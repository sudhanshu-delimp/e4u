    ...
    public function agent_data_pagination($start, $limit, $order_key, $dir)
    {
        ...
        foreach ($agents as $key => $item) {
            ...
            if ($this->editAccessEnabled) {
                ...
                $dropdown .= '<a class="dropdown-item d-flex justify-content-start gap-10 align-items-center edit-agent-btn" href="javascript:void(0)" data-id=' . $item->id . '  data-toggle="modal"> <i class="fa fa-pen"></i> Edit </a>';
            }
            $dropdown .= '</div></div>';
