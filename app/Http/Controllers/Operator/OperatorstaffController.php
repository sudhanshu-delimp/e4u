...
class OperatorstaffController extends BaseController
{
     ...
     * Add operator staff
     * 
     * @param \App\Http\Requests\OperatorStaff\AddNewStaff $request
     */
     ...
     * @param \App\Http\Requests\OperatorStaff\AddNewStaff $request
     */
    public function update_staff(AddNewStaff $request)
    {
        $data = $request->all();
        $operatorId = $this->operatorId;
        $resposne = $this->staffRepo->addUpdateStaff($data);
    ...
    public function viewStaff($id)
    {
        ...
        if ($staff) {
            return view('operator.management.operator_staff.staff-view', compact('staff'));
        } else {
            return "";
        }
    }
