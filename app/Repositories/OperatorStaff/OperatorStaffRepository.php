...
class OperatorStaffRepository extends BaseRepository implements OperatorStaffInterface
{
    protected $staff;
    ...
    public function __construct(OperatorStaff $staff, User $user_model,  AccountSetting $setting, StaffSetting $staff_setting)
    {
