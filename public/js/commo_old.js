...
async function isConfirm(data = {}) {
    ...
    const result = await Swal.fire({
        ...
        denyButtonText: data.is_third_button ?
            (data.third_button_text ? data.third_button_text : "Save it & add another ") : undefined,

        denyButtonColor: data.is_third_button ?
            (data.third_button_color ? data.third_button_color : "#0c223d") : undefined,
