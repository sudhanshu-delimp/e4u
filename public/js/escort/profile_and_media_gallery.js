    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            image.onload = function () {
                ...
                if (input.id == 'upload_pinup' && (height < 500 || width < 800)) {
                    Swal.fire("Pin Up Media", "The image you have selected is too small.<br>Please upload an image with a minimum size of 800×500 pixels", "warning");
                    input.value = '';
                    return false;
                }
