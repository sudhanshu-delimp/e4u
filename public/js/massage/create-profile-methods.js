...
function initDragDrop() {
        ...
        function validateThirdTab()
        {
           ...
           let is_true = true;
            ...
            $(document).on('change','#service_id_one', function(){
                ...
                if(selectedIdOne){
                    $("#selected_service_one").append(" <li id='hideenclassOne_"+ selectedIdOne+"'><div class='my_service_anal' ><span class='dollar-sign'>"+getNameOne+"</span><input type='number' class='dollar-before input_border price-input' name='price[]' placeholder='0' value=0 ><span class='error-msg' style='color:red; display:none;'></span><input type='hidden' name='category_id[]' value='1'><input type='hidden' name='service_id[]' value="+ selectedIdOne +" placeholder=''><span><i class='fas fa-times-circle akh1' data-sname='"+getNameOne+"' data-val="+ selectedIdOne+"  id='id_"+ selectedIdOne+"' value="+selectedIdOne+"></i></span></div></li> ");
        ...
        $('body').on('change','#service_id_two', function(){
                ...
                if(selectedIdTwo){
                    $("#selected_service_two").append(" <li id='hideenclassTwo_"+selectedIdTwo+"'><div class='my_service_anal hideenclassTwo"+selectedIdTwo+"'><span class='dollar-sign'>"+getNameTwo+"</span><input type='number' class='dollar-before input_border price-input' name='price[]' placeholder='0'  value=0><span class='error-msg' style='color:red; display:none;'></span><input type='hidden' name='category_id[]' value='2'><input type='hidden' name='service_id[]' value="+ selectedIdTwo +"><span><i class='fas fa-times-circle akh2'  data-sname='"+getNameTwo+"' data-val="+ selectedIdTwo+"  id='id_"+ selectedIdTwo+"' value="+selectedIdTwo+"></i></span></div></li> ");
        ...
        $(document).on('input', '.price-input', function () {
            ...
            if (isNaN(val) || val < 0 || val > 200 || val % 10 !== 0) {
                error.text('enter value multiple of 10').show();
