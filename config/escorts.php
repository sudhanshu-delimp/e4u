...
return [
  'profile' => [
    ...
    'breast-size' => [
      ...
      26 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      28 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      30 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      32 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      34 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      36 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      38 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      40 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      42 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      44 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H'],
      46 => ['A', 'B', 'C', 'D', 'DD', 'E', 'F', 'G', 'H']
    ],
    'body-type' => [
      1 => 'Athletic',
      2 => 'Average',
    ...
    'available-to-images' => [
      1 => app()->runningInConsole() ? '' : asset('assets/dashboard/img/woman-avatar.png'),
      2 => app()->runningInConsole() ? '' : asset('assets/dashboard/img/male-user.png'),
      3 => app()->runningInConsole() ? '' : asset('assets/dashboard/img/trans.png'),
      4 => app()->runningInConsole() ? '' : asset('assets/dashboard/img/couple.png'),
      5 => app()->runningInConsole() ? '' : asset('assets/dashboard/img/disabilities.png'),
      6 => app()->runningInConsole() ? '' : asset('assets/dashboard/img/group.png'),
      //arrange, sort and add proper svgs
    ],
    'ethnicities' => [
      2  => 'Arab',
      1  => 'Asian',
    ...
    // 	'3905'=>'Queensland'=>["4411" => "Brisbane"],
    // 	'3907'=>'Australian Capital Territory'=>["4566" => "Canberra"],
    // 	'3910'=>'Northern Territory'=>["4947" => "Darwin"],
    // 	'3908'=>'Tasmania'=>["5621" => "Hobart"],
    // 	'3903'=>'Victoria'=>["6235" => "Melbourne"],
    // 	'3908'=>'Tasmania'=>["6839" => "Perth"],
    // 	'3909'=>'New South Wales'=>["7408" => "Sydney"],
    ...
    'subjects' => [
      ...
      "4" => "What about our features?",
      "5" => "Was our website easy to navigate",
      "6" => "How often do you visit us?",
      "7" => "Send me more information about",
      "8" => "I want to report an Advertiser",
      "9" => "I want to report a Scammer",
      "10" => "I have a general complaint about",
    ...
    'masseur-types' => [
      "0" => "All Masseur types",
      "1" =>  " Female to male - 2 hands",
      "2" =>  "Female to male - 4 hands",
      "3" =>  "Male to female",
      "4" =>  "Male to male",
      "5" =>  "Trans to male",
    ],
    ...
    'agentBankDetails' => [
      ...
      4 => "ANZ - AU",
      5 => "Commonwealth Bank",
      6 => "Commonwealth Bank - AU",
      7 => "Australian Military Bank",
      8 => "Auswide Bank",
      9 => "Bank Australia",
      10 => "Bank of China",
      11 => "Bank of Melbourne",
